...
Public Class T___ArtisanLogTable
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.ArtisanLogTable"
       Public Const ArtisanLogTable__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Comments] FROM ArtisanLogTable"
       Public Const ArtisanLogTable__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Comments] FROM ArtisanLogTable"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ArtisanLogTable                  
            If Me.hasRows() Then Return New T___ArtisanLogTable(Me.AllRows(0))                  
            Return New T___ArtisanLogTable()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ArtisanLogTable                  
            Return New T___ArtisanLogTable(Me.RawTable, T___ArtisanLogTable.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ArtisanLogTable,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ArtisanLogTable,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ArtisanLogTable                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ArtisanLogTable(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ArtisanLogTable(drst.CopyToDataTable(),                  
                    T___ArtisanLogTable.TABLE_NAME)                  
                Return New T___ArtisanLogTable()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ArtisanLogTable                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ArtisanLogTable(dr), pParams)                  
                Select dr                  
...
Public Shared Function addWithID(Optional ByVal pComments As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Public Shared Function addWithParseID(Byval pParseID As Int32,Optional ByVal pComments As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Public Shared Function add(Optional ByVal pComments As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
