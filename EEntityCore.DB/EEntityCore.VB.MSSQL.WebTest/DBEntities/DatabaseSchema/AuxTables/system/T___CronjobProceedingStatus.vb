...
Public Class T___CronjobProceedingStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.CronjobProceedingStatus"
       Public Const CronjobProceedingStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM CronjobProceedingStatus"
       Public Const CronjobProceedingStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM CronjobProceedingStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CronjobProceedingStatus                  
            If Me.hasRows() Then Return New T___CronjobProceedingStatus(Me.AllRows(0))                  
            Return New T___CronjobProceedingStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CronjobProceedingStatus                  
            Return New T___CronjobProceedingStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CronjobProceedingStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CronjobProceedingStatus                  
            Return New T___CronjobProceedingStatus(Me.RawTable, T___CronjobProceedingStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CronjobProceedingStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CronjobProceedingStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CronjobProceedingStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CronjobProceedingStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CronjobProceedingStatus(drst.CopyToDataTable(),                  
                    T___CronjobProceedingStatus.TABLE_NAME)                  
                Return New T___CronjobProceedingStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CronjobProceedingStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CronjobProceedingStatus(dr), pParams)                  
                Select dr                  
