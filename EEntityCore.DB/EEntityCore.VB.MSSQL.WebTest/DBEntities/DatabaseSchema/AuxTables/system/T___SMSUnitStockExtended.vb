...
Public Class T___SMSUnitStockExtended
        Inherits  T___SMSUnitStock
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___SMSUnitStock) As T___SMSUnitStockExtended                  
            If pVal Is Nothing Then Return New T___SMSUnitStockExtended                  
            Return New T___SMSUnitStockExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
