...
Public Class T___PaystackLogExtended
        Inherits  T___PaystackLog
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaystackLog) As T___PaystackLogExtended                  
            If pVal Is Nothing Then Return New T___PaystackLogExtended                  
            Return New T___PaystackLogExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
