...
Public Class T___SMSUsageExtended
        Inherits  T___SMSUsage
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___SMSUsage) As T___SMSUsageExtended                  
            If pVal Is Nothing Then Return New T___SMSUsageExtended                  
            Return New T___SMSUsageExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
