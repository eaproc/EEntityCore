...
Public Class T___ServerExceptionLoggerExtended
        Inherits  T___ServerExceptionLogger
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ServerExceptionLogger) As T___ServerExceptionLoggerExtended                  
            If pVal Is Nothing Then Return New T___ServerExceptionLoggerExtended                  
            Return New T___ServerExceptionLoggerExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
