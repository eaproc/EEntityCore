...
Public Class T___CronjobExtended
        Inherits  T___Cronjob
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Cronjob) As T___CronjobExtended                  
            If pVal Is Nothing Then Return New T___CronjobExtended                  
            Return New T___CronjobExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
