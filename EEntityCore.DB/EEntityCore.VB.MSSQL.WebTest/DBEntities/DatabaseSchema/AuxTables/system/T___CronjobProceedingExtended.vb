...
Public Class T___CronjobProceedingExtended
        Inherits  T___CronjobProceeding
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CronjobProceeding) As T___CronjobProceedingExtended                  
            If pVal Is Nothing Then Return New T___CronjobProceedingExtended                  
            Return New T___CronjobProceedingExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
