...
Public Class T___EmailUsageExtended
        Inherits  T___EmailUsage
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___EmailUsage) As T___EmailUsageExtended                  
            If pVal Is Nothing Then Return New T___EmailUsageExtended                  
            Return New T___EmailUsageExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
