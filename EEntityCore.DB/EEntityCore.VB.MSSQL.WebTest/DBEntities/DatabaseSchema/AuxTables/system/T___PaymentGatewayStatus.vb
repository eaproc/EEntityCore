...
Public Class T___PaymentGatewayStatus
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defDescription = New DataColumnDefinition(TableColumnNames.Description.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.PaymentGatewayStatus"
       Public Const PaymentGatewayStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PaymentGatewayStatus"
       Public Const PaymentGatewayStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PaymentGatewayStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PaymentGatewayStatus                  
            If Me.hasRows() Then Return New T___PaymentGatewayStatus(Me.AllRows(0))                  
            Return New T___PaymentGatewayStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PaymentGatewayStatus                  
            Return New T___PaymentGatewayStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PaymentGatewayStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PaymentGatewayStatus                  
            Return New T___PaymentGatewayStatus(Me.RawTable, T___PaymentGatewayStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PaymentGatewayStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PaymentGatewayStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PaymentGatewayStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PaymentGatewayStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PaymentGatewayStatus(drst.CopyToDataTable(),                  
                    T___PaymentGatewayStatus.TABLE_NAME)                  
                Return New T___PaymentGatewayStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PaymentGatewayStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PaymentGatewayStatus(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pDescription As String) As Int32
...
Public Shared Function addWithID(ByVal pDescription As String,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pDescription As String,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pDescription As String,
