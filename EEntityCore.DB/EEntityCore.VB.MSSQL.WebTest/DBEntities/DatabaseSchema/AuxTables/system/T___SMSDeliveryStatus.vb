...
Public Class T___SMSDeliveryStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.SMSDeliveryStatus"
       Public Const SMSDeliveryStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM SMSDeliveryStatus"
       Public Const SMSDeliveryStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM SMSDeliveryStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___SMSDeliveryStatus                  
            If Me.hasRows() Then Return New T___SMSDeliveryStatus(Me.AllRows(0))                  
            Return New T___SMSDeliveryStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___SMSDeliveryStatus                  
            Return New T___SMSDeliveryStatus(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___SMSDeliveryStatus                  
            Return New T___SMSDeliveryStatus(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___SMSDeliveryStatus                  
            Return New T___SMSDeliveryStatus(Me.RawTable, T___SMSDeliveryStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___SMSDeliveryStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___SMSDeliveryStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___SMSDeliveryStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___SMSDeliveryStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___SMSDeliveryStatus(drst.CopyToDataTable(),                  
                    T___SMSDeliveryStatus.TABLE_NAME)                  
                Return New T___SMSDeliveryStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___SMSDeliveryStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___SMSDeliveryStatus(dr), pParams)                  
                Select dr                  
