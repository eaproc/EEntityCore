...
Public Class T___CronjobInterval
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.CronjobInterval"
       Public Const CronjobInterval__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM CronjobInterval"
       Public Const CronjobInterval__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM CronjobInterval"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CronjobInterval                  
            If Me.hasRows() Then Return New T___CronjobInterval(Me.AllRows(0))                  
            Return New T___CronjobInterval()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CronjobInterval                  
            Return New T___CronjobInterval(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CronjobInterval                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CronjobInterval                  
            Return New T___CronjobInterval(Me.RawTable, T___CronjobInterval.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CronjobInterval,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CronjobInterval,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CronjobInterval                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CronjobInterval(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CronjobInterval(drst.CopyToDataTable(),                  
                    T___CronjobInterval.TABLE_NAME)                  
                Return New T___CronjobInterval()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CronjobInterval                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CronjobInterval(dr), pParams)                  
                Select dr                  
