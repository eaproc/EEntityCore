...
Public Class T___RequestMonitor
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defRequestBody = New DataColumnDefinition(TableColumnNames.RequestBody.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defRequestHeaders = New DataColumnDefinition(TableColumnNames.RequestHeaders.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.RequestMonitor"
       Public Const RequestMonitor__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [AbsoluteURL], [RequestParametersJSON], [IPAddress], [SessionVariables], [Browser], [UserID], [CreatedAt], [RequestBody], [RequestHeaders] FROM RequestMonitor"
       Public Const RequestMonitor__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [AbsoluteURL], [RequestParametersJSON], [IPAddress], [SessionVariables], [Browser], [UserID], [CreatedAt], [RequestBody], [RequestHeaders] FROM RequestMonitor"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defRequestBody As DataColumnDefinition
       Public Shared ReadOnly defRequestHeaders As DataColumnDefinition
       ...
       Public ReadOnly Property [RequestBody] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.RequestBody.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [RequestHeaders] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.RequestHeaders.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___RequestMonitor                  
            If Me.hasRows() Then Return New T___RequestMonitor(Me.AllRows(0))                  
            Return New T___RequestMonitor()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___RequestMonitor                  
            Return New T___RequestMonitor(Me.RawTable, T___RequestMonitor.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___RequestMonitor,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___RequestMonitor,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___RequestMonitor                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___RequestMonitor(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___RequestMonitor(drst.CopyToDataTable(),                  
                    T___RequestMonitor.TABLE_NAME)                  
                Return New T___RequestMonitor()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___RequestMonitor                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___RequestMonitor(dr), pParams)                  
                Select dr                  
...
Try
 ...
 Dim paramRequestBody As DataColumnParameter = New DataColumnParameter(defRequestBody, defRequestBody.DefaultValue)
...
Public Shared Function addWithID(ByVal pAbsoluteURL As String,
...
Optional ByVal pRequestBody As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pRequestHeaders As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Try
 ...
 Dim paramRequestBody As DataColumnParameter = New DataColumnParameter(defRequestBody, pRequestBody)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pAbsoluteURL As String,
ByVal pIPAddress As String,
ByVal pCreatedAt As DateTime,
Optional ByVal pRequestParametersJSON As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pSessionVariables As Object = DataColumnNullParamValue.NULL_VALUE,
...
Public Shared Function add(ByVal pAbsoluteURL As String,
ByVal pIPAddress As String,
ByVal pCreatedAt As DateTime,
Optional ByVal pRequestParametersJSON As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pSessionVariables As Object = DataColumnNullParamValue.NULL_VALUE,
...
Optional ByVal pUserID As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pRequestBody As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pRequestHeaders As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
...
Optional ByVal pRequestBody As Object=Nothing,
Optional ByVal pRequestHeaders As Object=Nothing) As Boolean
