...
Public Class T___PaymentGatewayStatusExtended
        Inherits  T___PaymentGatewayStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentGatewayStatus) As T___PaymentGatewayStatusExtended                  
            If pVal Is Nothing Then Return New T___PaymentGatewayStatusExtended                  
            Return New T___PaymentGatewayStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
