...
Public Class T___SMSDeliveryStatusExtended
        Inherits  T___SMSDeliveryStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___SMSDeliveryStatus) As T___SMSDeliveryStatusExtended                  
            If pVal Is Nothing Then Return New T___SMSDeliveryStatusExtended                  
            Return New T___SMSDeliveryStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
