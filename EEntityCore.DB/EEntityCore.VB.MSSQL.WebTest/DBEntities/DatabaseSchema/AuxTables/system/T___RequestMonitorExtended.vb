...
Public Class T___RequestMonitorExtended
        Inherits  T___RequestMonitor
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___RequestMonitor) As T___RequestMonitorExtended                  
            If pVal Is Nothing Then Return New T___RequestMonitorExtended                  
            Return New T___RequestMonitorExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
