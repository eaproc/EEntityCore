...
Public Class T___CronjobProceedingStatusExtended
        Inherits  T___CronjobProceedingStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CronjobProceedingStatus) As T___CronjobProceedingStatusExtended                  
            If pVal Is Nothing Then Return New T___CronjobProceedingStatusExtended                  
            Return New T___CronjobProceedingStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
