...
Public Class T___ArtisanLogTableExtended
        Inherits  T___ArtisanLogTable
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ArtisanLogTable) As T___ArtisanLogTableExtended                  
            If pVal Is Nothing Then Return New T___ArtisanLogTableExtended                  
            Return New T___ArtisanLogTableExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
