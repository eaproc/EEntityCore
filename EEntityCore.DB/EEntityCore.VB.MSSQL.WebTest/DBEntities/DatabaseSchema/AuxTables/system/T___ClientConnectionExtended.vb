...
Public Class T___ClientConnectionExtended
        Inherits  T___ClientConnection
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ClientConnection) As T___ClientConnectionExtended                  
            If pVal Is Nothing Then Return New T___ClientConnectionExtended                  
            Return New T___ClientConnectionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
