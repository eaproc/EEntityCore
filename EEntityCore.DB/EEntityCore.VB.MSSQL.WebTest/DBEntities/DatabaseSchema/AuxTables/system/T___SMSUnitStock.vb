...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defStockAmountNaira = New DataColumnDefinition(TableColumnNames.StockAmountNaira.ToString(), GetType(Decimal), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defQuantity = New DataColumnDefinition(TableColumnNames.Quantity.ToString(), GetType(Decimal), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.SMSUnitStock"
       Public Const SMSUnitStock__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [StockAmountNaira], [Quantity], [Comments], [CreatedAt] FROM SMSUnitStock"
       Public Const SMSUnitStock__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [StockAmountNaira], [Quantity], [Comments], [CreatedAt] FROM SMSUnitStock"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defStockAmountNaira As DataColumnDefinition
       ...
       Public ReadOnly Property [StockAmountNaira] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.StockAmountNaira.ToString())) )
           End Get
       End Property
       ...
       Public ReadOnly Property [Quantity] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.Quantity.ToString())) )
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___SMSUnitStock                  
            If Me.hasRows() Then Return New T___SMSUnitStock(Me.AllRows(0))                  
            Return New T___SMSUnitStock()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___SMSUnitStock                  
            Return New T___SMSUnitStock(Me.RawTable, T___SMSUnitStock.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___SMSUnitStock,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___SMSUnitStock,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___SMSUnitStock                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___SMSUnitStock(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___SMSUnitStock(drst.CopyToDataTable(),                  
                    T___SMSUnitStock.TABLE_NAME)                  
                Return New T___SMSUnitStock()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___SMSUnitStock                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___SMSUnitStock(dr), pParams)                  
                Select dr                  
...
Public Shared Function addWithID(ByVal pStockAmountNaira As Decimal,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pStockAmountNaira As Decimal,
ByVal pQuantity As Decimal,
ByVal pCreatedAt As DateTime,
Optional ByVal pComments As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Public Shared Function add(ByVal pStockAmountNaira As Decimal,
ByVal pQuantity As Decimal,
ByVal pCreatedAt As DateTime,
...
Optional ByVal pStockAmountNaira As Object=Nothing,
