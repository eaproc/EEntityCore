...
Public Class T___CronjobIntervalExtended
        Inherits  T___CronjobInterval
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CronjobInterval) As T___CronjobIntervalExtended                  
            If pVal Is Nothing Then Return New T___CronjobIntervalExtended                  
            Return New T___CronjobIntervalExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
