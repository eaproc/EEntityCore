...
Public Class T___AcademicSessionExtended
        Inherits  T___AcademicSession
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___AcademicSession) As T___AcademicSessionExtended                  
            If pVal Is Nothing Then Return New T___AcademicSessionExtended                  
            Return New T___AcademicSessionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
