...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "academic.TermOrder"
       Public Const TermOrder__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM TermOrder"
       Public Const TermOrder__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM TermOrder"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___TermOrder                  
            If Me.hasRows() Then Return New T___TermOrder(Me.AllRows(0))                  
            Return New T___TermOrder()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___TermOrder                  
            Return New T___TermOrder(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___TermOrder                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___TermOrder                  
            Return New T___TermOrder(Me.RawTable, T___TermOrder.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___TermOrder,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___TermOrder,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___TermOrder                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___TermOrder(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___TermOrder(drst.CopyToDataTable(),                  
                    T___TermOrder.TABLE_NAME)                  
                Return New T___TermOrder()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___TermOrder                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___TermOrder(dr), pParams)                  
                Select dr                  
