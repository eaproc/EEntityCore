...
Public Class T___AcademicSession
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "academic.AcademicSession"
       Public Const AcademicSession__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Name], [Description], [StartDate], [EndDate], [CreatedAt], [UpdatedAt] FROM AcademicSession"
       Public Const AcademicSession__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Name], [Description], [StartDate], [EndDate], [CreatedAt], [UpdatedAt] FROM AcademicSession"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___AcademicSession                  
            If Me.hasRows() Then Return New T___AcademicSession(Me.AllRows(0))                  
            Return New T___AcademicSession()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___AcademicSession                  
            Return New T___AcademicSession(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___AcademicSession                  
            Return New T___AcademicSession(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___AcademicSession                  
            Return New T___AcademicSession(Me.RawTable, T___AcademicSession.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___AcademicSession,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___AcademicSession,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___AcademicSession                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___AcademicSession(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___AcademicSession(drst.CopyToDataTable(),                  
                    T___AcademicSession.TABLE_NAME)                  
                Return New T___AcademicSession()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___AcademicSession                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___AcademicSession(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pName As String) As Int32
