...
Public Class T___TermOrderExtended
        Inherits  T___TermOrder
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___TermOrder) As T___TermOrderExtended                  
            If pVal Is Nothing Then Return New T___TermOrderExtended                  
            Return New T___TermOrderExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
