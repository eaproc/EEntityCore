...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Term) As T___TermExtended                  
            If pVal Is Nothing Then Return New T___TermExtended                  
            Return New T___TermExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
