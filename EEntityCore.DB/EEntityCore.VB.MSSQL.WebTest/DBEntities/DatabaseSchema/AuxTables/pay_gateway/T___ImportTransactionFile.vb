...
Public Class T___ImportTransactionFile
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defFilePath = New DataColumnDefinition(TableColumnNames.FilePath.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "pay_gateway.ImportTransactionFile"
       Public Const ImportTransactionFile__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [FilePath], [CreatedAt], [CreatedByID] FROM ImportTransactionFile"
       Public Const ImportTransactionFile__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [FilePath], [CreatedAt], [CreatedByID] FROM ImportTransactionFile"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defFilePath As DataColumnDefinition
       ...
       Public ReadOnly Property [FilePath] As String
           Get
               ...
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.FilePath.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ImportTransactionFile                  
            If Me.hasRows() Then Return New T___ImportTransactionFile(Me.AllRows(0))                  
            Return New T___ImportTransactionFile()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ImportTransactionFile                  
            Return New T___ImportTransactionFile(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ImportTransactionFile                  
            Return New T___ImportTransactionFile(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___ImportTransactionFile                  
            Return New T___ImportTransactionFile(Me.RawTable, T___ImportTransactionFile.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ImportTransactionFile,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ImportTransactionFile,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ImportTransactionFile                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ImportTransactionFile(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ImportTransactionFile(drst.CopyToDataTable(),                  
                    T___ImportTransactionFile.TABLE_NAME)                  
                Return New T___ImportTransactionFile()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ImportTransactionFile                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ImportTransactionFile(dr), pParams)                  
                Select dr                  
...
Try
 ...
 Dim paramFilePath As DataColumnParameter = New DataColumnParameter(defFilePath, defFilePath.DefaultValue)
...
Public Shared Function addWithID(ByVal pFilePath As String,
...
Try
 ...
 Dim paramID As DataColumnParameter = New DataColumnParameter(defID, DatabaseInit.DBConnectInterface.GetDBConn().GETNewID(TABLE_NAME))
 Dim paramFilePath As DataColumnParameter = New DataColumnParameter(defFilePath, pFilePath)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pFilePath As String,
ByVal pCreatedAt As DateTime,
ByVal pCreatedByID As Int32) As Int32
...
Public Shared Function add(ByVal pFilePath As String,
ByVal pCreatedAt As DateTime,
...
Optional ByVal pFilePath As Object=Nothing,
