...
Public Class T___PayoutTransactionExtended
        Inherits  T___PayoutTransaction
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PayoutTransaction) As T___PayoutTransactionExtended                  
            If pVal Is Nothing Then Return New T___PayoutTransactionExtended                  
            Return New T___PayoutTransactionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
