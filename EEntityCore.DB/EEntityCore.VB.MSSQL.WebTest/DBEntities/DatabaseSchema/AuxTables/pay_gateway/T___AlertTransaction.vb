...
Public Class T___AlertTransaction
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defTransactionReference = New DataColumnDefinition(TableColumnNames.TransactionReference.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  ...
  defProcessed = New DataColumnDefinition(TableColumnNames.Processed.ToString(), GetType(Boolean), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "pay_gateway.AlertTransaction"
       Public Const AlertTransaction__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [TransactionDate], [TransactionReference], [Description], [Channel], [Total], [Confirmed], [Processed], [CreatedAt], [UpdatedAt] FROM AlertTransaction"
       Public Const AlertTransaction__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [TransactionDate], [TransactionReference], [Description], [Channel], [Total], [Confirmed], [Processed], [CreatedAt], [UpdatedAt] FROM AlertTransaction"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defProcessed As DataColumnDefinition
       ...
       Public ReadOnly Property [Processed] As Boolean
           Get
               If Not Me.isValidRow then Return FALSE                          
               Return EBoolean.valueOf(Me.TargettedRow(TableColumnNames.Processed.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___AlertTransaction                  
            If Me.hasRows() Then Return New T___AlertTransaction(Me.AllRows(0))                  
            Return New T___AlertTransaction()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___AlertTransaction                  
            Return New T___AlertTransaction(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___AlertTransaction                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___AlertTransaction                  
            Return New T___AlertTransaction(Me.RawTable, T___AlertTransaction.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___AlertTransaction,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___AlertTransaction,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___AlertTransaction                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___AlertTransaction(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___AlertTransaction(drst.CopyToDataTable(),                  
                    T___AlertTransaction.TABLE_NAME)                  
                Return New T___AlertTransaction()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___AlertTransaction                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___AlertTransaction(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return AlertTransaction__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pTransactionReference As String) As Int32
...
Try
 ...
 Dim paramProcessed As DataColumnParameter = New DataColumnParameter(defProcessed, defProcessed.DefaultValue)
...
Public Shared Function addWithID(ByVal pTransactionDate As DateTime,
...
Try
 ...
 Dim paramProcessed As DataColumnParameter = New DataColumnParameter(defProcessed, pProcessed)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pTransactionDate As DateTime,
ByVal pTransactionReference As String,
ByVal pDescription As String,
ByVal pChannel As String,
ByVal pTotal As Decimal,
...
Public Shared Function add(ByVal pTransactionDate As DateTime,
ByVal pTransactionReference As String,
ByVal pDescription As String,
ByVal pChannel As String,
ByVal pTotal As Decimal,
...
Optional ByVal pProcessed As Object=Nothing,
