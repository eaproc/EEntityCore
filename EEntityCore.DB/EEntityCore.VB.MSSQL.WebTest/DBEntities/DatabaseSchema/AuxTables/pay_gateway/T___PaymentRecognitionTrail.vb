...
Public Class T___PaymentRecognitionTrail
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defTrail = New DataColumnDefinition(TableColumnNames.Trail.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defAlertTransactionID = New DataColumnDefinition(TableColumnNames.AlertTransactionID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "pay_gateway.PaymentRecognitionTrail"
       Public Const PaymentRecognitionTrail__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Trail], [CreatedAt], [AlertTransactionID] FROM PaymentRecognitionTrail"
       Public Const PaymentRecognitionTrail__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Trail], [CreatedAt], [AlertTransactionID] FROM PaymentRecognitionTrail"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defTrail As DataColumnDefinition
       Public Shared ReadOnly defCreatedAt As DataColumnDefinition
       Public Shared ReadOnly defAlertTransactionID As DataColumnDefinition

       Public ReadOnly Property [Trail] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.Trail.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [AlertTransactionID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.AlertTransactionID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PaymentRecognitionTrail                  
            If Me.hasRows() Then Return New T___PaymentRecognitionTrail(Me.AllRows(0))                  
            Return New T___PaymentRecognitionTrail()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PaymentRecognitionTrail                  
            Return New T___PaymentRecognitionTrail(Me.RawTable, T___PaymentRecognitionTrail.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PaymentRecognitionTrail,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PaymentRecognitionTrail,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PaymentRecognitionTrail                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PaymentRecognitionTrail(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PaymentRecognitionTrail(drst.CopyToDataTable(),                  
                    T___PaymentRecognitionTrail.TABLE_NAME)                  
                Return New T___PaymentRecognitionTrail()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PaymentRecognitionTrail                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PaymentRecognitionTrail(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pAlertTransactionID As Int32) As Int32
...
Public Shared Function addWithID(ByVal pTrail As String,
ByVal pCreatedAt As DateTime,
ByVal pAlertTransactionID As Int32) As Int32
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pTrail As String,
ByVal pCreatedAt As DateTime,
ByVal pAlertTransactionID As Int32) As Int32
...
Public Shared Function add(ByVal pTrail As String,
ByVal pCreatedAt As DateTime,
ByVal pAlertTransactionID As Int32) As Boolean
...
Optional ByVal pTrail As Object=Nothing,
Optional ByVal pCreatedAt As Object=Nothing,
Optional ByVal pAlertTransactionID As Object=Nothing) As Boolean
