...
Public Class T___PaymentTransactionExtended
        Inherits  T___PaymentTransaction
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentTransaction) As T___PaymentTransactionExtended                  
            If pVal Is Nothing Then Return New T___PaymentTransactionExtended                  
            Return New T___PaymentTransactionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
