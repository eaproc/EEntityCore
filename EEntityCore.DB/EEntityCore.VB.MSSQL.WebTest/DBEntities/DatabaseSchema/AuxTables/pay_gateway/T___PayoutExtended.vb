...
Public Class T___PayoutExtended
        Inherits  T___Payout
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Payout) As T___PayoutExtended                  
            If pVal Is Nothing Then Return New T___PayoutExtended                  
            Return New T___PayoutExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
