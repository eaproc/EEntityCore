...
Public Class T___PaymentTransactionAuditExtended
        Inherits  T___PaymentTransactionAudit
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentTransactionAudit) As T___PaymentTransactionAuditExtended                  
            If pVal Is Nothing Then Return New T___PaymentTransactionAuditExtended                  
            Return New T___PaymentTransactionAuditExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
