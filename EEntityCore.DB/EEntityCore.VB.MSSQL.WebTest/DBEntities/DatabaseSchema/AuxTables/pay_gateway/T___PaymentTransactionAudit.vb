...
Public Class T___PaymentTransactionAudit
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "pay_gateway.PaymentTransactionAudit"
       Public Const PaymentTransactionAudit__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [TransactionStatusID], [PaymentTransactionID], [AccountName], [Bank], [IPAddress], [PaymentRequired], [Charges], [PaymentRequiredWithoutCharges], [RefundAmount], [Balance], [CreatedAt], [CreatedByID] FROM PaymentTransactionAudit"
       Public Const PaymentTransactionAudit__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [TransactionStatusID], [PaymentTransactionID], [AccountName], [Bank], [IPAddress], [PaymentRequired], [Charges], [PaymentRequiredWithoutCharges], [RefundAmount], [Balance], [CreatedAt], [CreatedByID] FROM PaymentTransactionAudit"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PaymentTransactionAudit                  
            If Me.hasRows() Then Return New T___PaymentTransactionAudit(Me.AllRows(0))                  
            Return New T___PaymentTransactionAudit()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PaymentTransactionAudit                  
            Return New T___PaymentTransactionAudit(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PaymentTransactionAudit                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PaymentTransactionAudit                  
            Return New T___PaymentTransactionAudit(Me.RawTable, T___PaymentTransactionAudit.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PaymentTransactionAudit,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PaymentTransactionAudit,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PaymentTransactionAudit                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PaymentTransactionAudit(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PaymentTransactionAudit(drst.CopyToDataTable(),                  
                    T___PaymentTransactionAudit.TABLE_NAME)                  
                Return New T___PaymentTransactionAudit()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PaymentTransactionAudit                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PaymentTransactionAudit(dr), pParams)                  
                Select dr                  
...
ByVal pPaymentTransactionID As Int32,
