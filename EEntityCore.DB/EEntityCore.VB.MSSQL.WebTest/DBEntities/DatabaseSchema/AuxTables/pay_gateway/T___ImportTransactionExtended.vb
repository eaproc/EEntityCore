...
Public Class T___ImportTransactionExtended
        Inherits  T___ImportTransaction
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ImportTransaction) As T___ImportTransactionExtended                  
            If pVal Is Nothing Then Return New T___ImportTransactionExtended                  
            Return New T___ImportTransactionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
