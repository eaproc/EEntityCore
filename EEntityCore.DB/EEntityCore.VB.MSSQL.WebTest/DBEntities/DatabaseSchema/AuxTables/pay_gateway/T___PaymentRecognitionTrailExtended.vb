...
Public Class T___PaymentRecognitionTrailExtended
        Inherits  T___PaymentRecognitionTrail
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentRecognitionTrail) As T___PaymentRecognitionTrailExtended                  
            If pVal Is Nothing Then Return New T___PaymentRecognitionTrailExtended                  
            Return New T___PaymentRecognitionTrailExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
