...
Public Class T___AlertTransactionExtended
        Inherits  T___AlertTransaction
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___AlertTransaction) As T___AlertTransactionExtended                  
            If pVal Is Nothing Then Return New T___AlertTransactionExtended                  
            Return New T___AlertTransactionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
