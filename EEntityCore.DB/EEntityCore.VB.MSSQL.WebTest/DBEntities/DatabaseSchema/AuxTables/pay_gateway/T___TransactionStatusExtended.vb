...
Public Class T___TransactionStatusExtended
        Inherits  T___TransactionStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___TransactionStatus) As T___TransactionStatusExtended                  
            If pVal Is Nothing Then Return New T___TransactionStatusExtended                  
            Return New T___TransactionStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
