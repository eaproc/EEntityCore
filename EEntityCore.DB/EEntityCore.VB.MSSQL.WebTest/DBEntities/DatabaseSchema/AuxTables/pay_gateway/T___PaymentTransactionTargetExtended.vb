...
Public Class T___PaymentTransactionTargetExtended
        Inherits  T___PaymentTransactionTarget
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentTransactionTarget) As T___PaymentTransactionTargetExtended                  
            If pVal Is Nothing Then Return New T___PaymentTransactionTargetExtended                  
            Return New T___PaymentTransactionTargetExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
