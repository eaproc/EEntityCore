...
Public Class T___ImportTransactionFileExtended
        Inherits  T___ImportTransactionFile
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ImportTransactionFile) As T___ImportTransactionFileExtended                  
            If pVal Is Nothing Then Return New T___ImportTransactionFileExtended                  
            Return New T___ImportTransactionFileExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
