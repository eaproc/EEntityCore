...
Public Class T___TransactionStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "pay_gateway.TransactionStatus"
       Public Const TransactionStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM TransactionStatus"
       Public Const TransactionStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM TransactionStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___TransactionStatus                  
            If Me.hasRows() Then Return New T___TransactionStatus(Me.AllRows(0))                  
            Return New T___TransactionStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___TransactionStatus                  
            Return New T___TransactionStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___TransactionStatus                  
            Return New T___TransactionStatus(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___TransactionStatus                  
            Return New T___TransactionStatus(Me.RawTable, T___TransactionStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___TransactionStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___TransactionStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___TransactionStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___TransactionStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___TransactionStatus(drst.CopyToDataTable(),                  
                    T___TransactionStatus.TABLE_NAME)                  
                Return New T___TransactionStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___TransactionStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___TransactionStatus(dr), pParams)                  
                Select dr                  
