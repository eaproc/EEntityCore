...
Public Class T___UserPasswordResetModeExtended
        Inherits  T___UserPasswordResetMode
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___UserPasswordResetMode) As T___UserPasswordResetModeExtended                  
            If pVal Is Nothing Then Return New T___UserPasswordResetModeExtended                  
            Return New T___UserPasswordResetModeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
