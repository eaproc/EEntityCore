...
Public Class T___PasswordResetHistory
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defOldPassword = New DataColumnDefinition(TableColumnNames.OldPassword.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defNewPassword = New DataColumnDefinition(TableColumnNames.NewPassword.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defChangedByUserID = New DataColumnDefinition(TableColumnNames.ChangedByUserID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.PasswordResetHistory"
       Public Const PasswordResetHistory__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [UserID], [OldPassword], [NewPassword], [PasswordResetTypeID], [CreatedAt], [ChangedByUserID], [IpAddress] FROM PasswordResetHistory"
       Public Const PasswordResetHistory__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [UserID], [OldPassword], [NewPassword], [PasswordResetTypeID], [CreatedAt], [ChangedByUserID], [IpAddress] FROM PasswordResetHistory"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defOldPassword As DataColumnDefinition
       Public Shared ReadOnly defNewPassword As DataColumnDefinition
       ...
       Public Shared ReadOnly defChangedByUserID As DataColumnDefinition
       ...
       Public ReadOnly Property [OldPassword] As String
           Get
               ...
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.OldPassword.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [NewPassword] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.NewPassword.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [ChangedByUserID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.ChangedByUserID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PasswordResetHistory                  
            If Me.hasRows() Then Return New T___PasswordResetHistory(Me.AllRows(0))                  
            Return New T___PasswordResetHistory()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PasswordResetHistory                  
            Return New T___PasswordResetHistory(Me.RawTable, T___PasswordResetHistory.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PasswordResetHistory,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PasswordResetHistory,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PasswordResetHistory                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PasswordResetHistory(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PasswordResetHistory(drst.CopyToDataTable(),                  
                    T___PasswordResetHistory.TABLE_NAME)                  
                Return New T___PasswordResetHistory()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PasswordResetHistory                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PasswordResetHistory(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return PasswordResetHistory__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
ByVal pPasswordResetTypeID As Int32) As Int32
...
Try
 ...
 Dim paramNewPassword As DataColumnParameter = New DataColumnParameter(defNewPassword, defNewPassword.DefaultValue)
 Dim paramCreatedAt As DataColumnParameter = New DataColumnParameter(defCreatedAt, defCreatedAt.DefaultValue)
 Dim paramChangedByUserID As DataColumnParameter = New DataColumnParameter(defChangedByUserID, defChangedByUserID.DefaultValue)
...
ByVal pOldPassword As String,
ByVal pNewPassword As String,
ByVal pPasswordResetTypeID As Int32,
ByVal pCreatedAt As DateTime,
ByVal pChangedByUserID As Int32,
ByVal pIpAddress As String) As Int32
...
Try
 ...
 Dim paramChangedByUserID As DataColumnParameter = New DataColumnParameter(defChangedByUserID, pChangedByUserID)
...
ByVal pCreatedAt As DateTime,
ByVal pChangedByUserID As Int32,
ByVal pIpAddress As String) As Boolean
...
Optional ByVal pOldPassword As Object=Nothing,
Optional ByVal pNewPassword As Object=Nothing,
Optional ByVal pPasswordResetTypeID As Object=Nothing,
Optional ByVal pCreatedAt As Object=Nothing,
Optional ByVal pChangedByUserID As Object=Nothing,
Optional ByVal pIpAddress As Object=Nothing) As Boolean
