...
Public Class T___LinkPermissionMemberExtended
        Inherits  T___LinkPermissionMember
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___LinkPermissionMember) As T___LinkPermissionMemberExtended                  
            If pVal Is Nothing Then Return New T___LinkPermissionMemberExtended                  
            Return New T___LinkPermissionMemberExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
