...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Link) As T___LinkExtended                  
            If pVal Is Nothing Then Return New T___LinkExtended                  
            Return New T___LinkExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
