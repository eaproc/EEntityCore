...
Public Class T___UserLoginHistoryExtended
        Inherits  T___UserLoginHistory
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___UserLoginHistory) As T___UserLoginHistoryExtended                  
            If pVal Is Nothing Then Return New T___UserLoginHistoryExtended                  
            Return New T___UserLoginHistoryExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
