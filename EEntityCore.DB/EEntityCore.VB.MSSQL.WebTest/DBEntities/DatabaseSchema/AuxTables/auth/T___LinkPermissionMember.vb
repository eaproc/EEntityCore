...
Public Class T___LinkPermissionMember
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defHasPermissionID = New DataColumnDefinition(TableColumnNames.HasPermissionID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.LinkPermissionMember"
       Public Const LinkPermissionMember__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [LinkPermissionID], [HasPermissionID], [CreatedAt] FROM LinkPermissionMember"
       Public Const LinkPermissionMember__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [LinkPermissionID], [HasPermissionID], [CreatedAt] FROM LinkPermissionMember"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defHasPermissionID As DataColumnDefinition
       ...
       Public ReadOnly Property [HasPermissionID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.HasPermissionID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___LinkPermissionMember                  
            If Me.hasRows() Then Return New T___LinkPermissionMember(Me.AllRows(0))                  
            Return New T___LinkPermissionMember()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___LinkPermissionMember                  
            Return New T___LinkPermissionMember(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___LinkPermissionMember                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___LinkPermissionMember                  
            Return New T___LinkPermissionMember(Me.RawTable, T___LinkPermissionMember.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___LinkPermissionMember,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___LinkPermissionMember,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___LinkPermissionMember                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___LinkPermissionMember(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___LinkPermissionMember(drst.CopyToDataTable(),                  
                    T___LinkPermissionMember.TABLE_NAME)                  
                Return New T___LinkPermissionMember()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___LinkPermissionMember                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___LinkPermissionMember(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return LinkPermissionMember__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pLinkPermissionID As Int32,
ByVal pHasPermissionID As Int32) As Int32
...
Try
 ...
 Dim paramHasPermissionID As DataColumnParameter = New DataColumnParameter(defHasPermissionID, pHasPermissionID)
...
Public Shared Function addWithID(ByVal pLinkPermissionID As Int32,
ByVal pHasPermissionID As Int32,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pLinkPermissionID As Int32,
ByVal pHasPermissionID As Int32,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pLinkPermissionID As Int32,
ByVal pHasPermissionID As Int32,
...
Optional ByVal pHasPermissionID As Object=Nothing,
