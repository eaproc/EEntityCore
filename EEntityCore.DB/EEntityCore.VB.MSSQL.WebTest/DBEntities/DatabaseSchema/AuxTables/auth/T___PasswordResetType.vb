...
Public Class T___PasswordResetType
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.PasswordResetType"
       Public Const PasswordResetType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PasswordResetType"
       Public Const PasswordResetType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PasswordResetType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PasswordResetType                  
            If Me.hasRows() Then Return New T___PasswordResetType(Me.AllRows(0))                  
            Return New T___PasswordResetType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PasswordResetType                  
            Return New T___PasswordResetType(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PasswordResetType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PasswordResetType                  
            Return New T___PasswordResetType(Me.RawTable, T___PasswordResetType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PasswordResetType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PasswordResetType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PasswordResetType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PasswordResetType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PasswordResetType(drst.CopyToDataTable(),                  
                    T___PasswordResetType.TABLE_NAME)                  
                Return New T___PasswordResetType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PasswordResetType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PasswordResetType(dr), pParams)                  
                Select dr                  
