...
Public Class T___UserPasswordResetMode
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defPasswordResetTypeID = New DataColumnDefinition(TableColumnNames.PasswordResetTypeID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  defUserID = New DataColumnDefinition(TableColumnNames.UserID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  defModeCarrier = New DataColumnDefinition(TableColumnNames.ModeCarrier.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.UserPasswordResetMode"
       Public Const UserPasswordResetMode__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [PasswordResetTypeID], [UserID], [ModeCarrier], [CreatedAt] FROM UserPasswordResetMode"
       Public Const UserPasswordResetMode__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [PasswordResetTypeID], [UserID], [ModeCarrier], [CreatedAt] FROM UserPasswordResetMode"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defModeCarrier As DataColumnDefinition
       ...
       Public ReadOnly Property [ModeCarrier] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.ModeCarrier.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___UserPasswordResetMode                  
            If Me.hasRows() Then Return New T___UserPasswordResetMode(Me.AllRows(0))                  
            Return New T___UserPasswordResetMode()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___UserPasswordResetMode                  
            Return New T___UserPasswordResetMode(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___UserPasswordResetMode                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___UserPasswordResetMode                  
            Return New T___UserPasswordResetMode(Me.RawTable, T___UserPasswordResetMode.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___UserPasswordResetMode,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___UserPasswordResetMode,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___UserPasswordResetMode                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___UserPasswordResetMode(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___UserPasswordResetMode(drst.CopyToDataTable(),                  
                    T___UserPasswordResetMode.TABLE_NAME)                  
                Return New T___UserPasswordResetMode()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___UserPasswordResetMode                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___UserPasswordResetMode(dr), pParams)                  
                Select dr                  
...
ByVal pModeCarrier As String) As Int32
...
Try
 ...
 Dim paramModeCarrier As DataColumnParameter = New DataColumnParameter(defModeCarrier, pModeCarrier)
...
Public Shared Function addWithID(ByVal pPasswordResetTypeID As Int32,
ByVal pUserID As Int32,
ByVal pModeCarrier As String,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pPasswordResetTypeID As Int32,
ByVal pUserID As Int32,
ByVal pModeCarrier As String,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pPasswordResetTypeID As Int32,
ByVal pUserID As Int32,
ByVal pModeCarrier As String,
...
Optional ByVal pModeCarrier As Object=Nothing,
