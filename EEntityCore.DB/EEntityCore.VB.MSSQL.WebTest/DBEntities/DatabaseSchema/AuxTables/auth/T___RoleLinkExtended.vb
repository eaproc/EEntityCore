...
Public Class T___RoleLinkExtended
        Inherits  T___RoleLink
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___RoleLink) As T___RoleLinkExtended                  
            If pVal Is Nothing Then Return New T___RoleLinkExtended                  
            Return New T___RoleLinkExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
