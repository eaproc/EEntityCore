...
Public Class T___LinkPermission
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.LinkPermission"
       Public Const LinkPermission__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM LinkPermission"
       Public Const LinkPermission__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM LinkPermission"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___LinkPermission                  
            If Me.hasRows() Then Return New T___LinkPermission(Me.AllRows(0))                  
            Return New T___LinkPermission()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___LinkPermission                  
            Return New T___LinkPermission(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___LinkPermission                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___LinkPermission                  
            Return New T___LinkPermission(Me.RawTable, T___LinkPermission.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___LinkPermission,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___LinkPermission,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___LinkPermission                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___LinkPermission(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___LinkPermission(drst.CopyToDataTable(),                  
                    T___LinkPermission.TABLE_NAME)                  
                Return New T___LinkPermission()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___LinkPermission                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___LinkPermission(dr), pParams)                  
                Select dr                  
