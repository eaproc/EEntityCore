...
Public Class T___UsersExtended
        Inherits  T___Users
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Users) As T___UsersExtended                  
            If pVal Is Nothing Then Return New T___UsersExtended                  
            Return New T___UsersExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
