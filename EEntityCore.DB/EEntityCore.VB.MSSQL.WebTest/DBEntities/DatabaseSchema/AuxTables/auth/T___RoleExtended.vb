...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Role) As T___RoleExtended                  
            If pVal Is Nothing Then Return New T___RoleExtended                  
            Return New T___RoleExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
