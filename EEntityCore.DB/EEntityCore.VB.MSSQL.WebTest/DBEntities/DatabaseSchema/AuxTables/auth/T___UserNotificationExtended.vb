...
Public Class T___UserNotificationExtended
        Inherits  T___UserNotification
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___UserNotification) As T___UserNotificationExtended                  
            If pVal Is Nothing Then Return New T___UserNotificationExtended                  
            Return New T___UserNotificationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
