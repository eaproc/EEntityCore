...
Public Class T___SessionExtended
        Inherits  T___Session
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Session) As T___SessionExtended                  
            If pVal Is Nothing Then Return New T___SessionExtended                  
            Return New T___SessionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
