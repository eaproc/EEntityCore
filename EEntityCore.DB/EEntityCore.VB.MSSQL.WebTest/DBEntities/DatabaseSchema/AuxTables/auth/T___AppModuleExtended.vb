...
Public Class T___AppModuleExtended
        Inherits  T___AppModule
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___AppModule) As T___AppModuleExtended                  
            If pVal Is Nothing Then Return New T___AppModuleExtended                  
            Return New T___AppModuleExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
