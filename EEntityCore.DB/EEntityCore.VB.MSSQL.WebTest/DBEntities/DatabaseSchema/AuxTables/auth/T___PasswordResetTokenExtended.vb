...
Public Class T___PasswordResetTokenExtended
        Inherits  T___PasswordResetToken
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PasswordResetToken) As T___PasswordResetTokenExtended                  
            If pVal Is Nothing Then Return New T___PasswordResetTokenExtended                  
            Return New T___PasswordResetTokenExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
