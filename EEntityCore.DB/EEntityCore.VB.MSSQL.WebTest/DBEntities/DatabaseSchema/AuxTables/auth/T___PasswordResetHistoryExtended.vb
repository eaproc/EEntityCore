...
Public Class T___PasswordResetHistoryExtended
        Inherits  T___PasswordResetHistory
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PasswordResetHistory) As T___PasswordResetHistoryExtended                  
            If pVal Is Nothing Then Return New T___PasswordResetHistoryExtended                  
            Return New T___PasswordResetHistoryExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
