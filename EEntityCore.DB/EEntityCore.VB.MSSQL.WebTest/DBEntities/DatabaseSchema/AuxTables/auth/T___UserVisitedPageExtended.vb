...
Public Class T___UserVisitedPageExtended
        Inherits  T___UserVisitedPage
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___UserVisitedPage) As T___UserVisitedPageExtended                  
            If pVal Is Nothing Then Return New T___UserVisitedPageExtended                  
            Return New T___UserVisitedPageExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
