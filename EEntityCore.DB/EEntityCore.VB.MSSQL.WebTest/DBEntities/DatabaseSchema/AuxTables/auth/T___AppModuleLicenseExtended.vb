...
Public Class T___AppModuleLicenseExtended
        Inherits  T___AppModuleLicense
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___AppModuleLicense) As T___AppModuleLicenseExtended                  
            If pVal Is Nothing Then Return New T___AppModuleLicenseExtended                  
            Return New T___AppModuleLicenseExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
