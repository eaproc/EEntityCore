...
Public Class T___PasswordResetToken
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defToken = New DataColumnDefinition(TableColumnNames.Token.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defPasswordResetTypeID = New DataColumnDefinition(TableColumnNames.PasswordResetTypeID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  ...
  defExpiryDateTime = New DataColumnDefinition(TableColumnNames.ExpiryDateTime.ToString(), GetType(DateTime), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defIsUsed = New DataColumnDefinition(TableColumnNames.IsUsed.ToString(), GetType(Boolean), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.PasswordResetToken"
       Public Const PasswordResetToken__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Token], [PasswordResetTypeID], [UserID], [ExpiryDateTime], [IsUsed], [CreatedAt], [UpdatedAt] FROM PasswordResetToken"
       Public Const PasswordResetToken__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Token], [PasswordResetTypeID], [UserID], [ExpiryDateTime], [IsUsed], [CreatedAt], [UpdatedAt] FROM PasswordResetToken"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defToken As DataColumnDefinition
       Public Shared ReadOnly defPasswordResetTypeID As DataColumnDefinition
       Public Shared ReadOnly defUserID As DataColumnDefinition
       Public Shared ReadOnly defExpiryDateTime As DataColumnDefinition
       Public Shared ReadOnly defIsUsed As DataColumnDefinition
       ...
       Public ReadOnly Property [Token] As String
           Get
               ...
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.Token.ToString()))
           End Get
       End Property


       Public ReadOnly Property [PasswordResetTypeID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.PasswordResetTypeID.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [ExpiryDateTime] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.ExpiryDateTime.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [IsUsed] As Boolean
           Get
               ...
               Return EBoolean.valueOf(Me.TargettedRow(TableColumnNames.IsUsed.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PasswordResetToken                  
            If Me.hasRows() Then Return New T___PasswordResetToken(Me.AllRows(0))                  
            Return New T___PasswordResetToken()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PasswordResetToken                  
            Return New T___PasswordResetToken(Me.RawTable, T___PasswordResetToken.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PasswordResetToken,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PasswordResetToken,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PasswordResetToken                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PasswordResetToken(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PasswordResetToken(drst.CopyToDataTable(),                  
                    T___PasswordResetToken.TABLE_NAME)                  
                Return New T___PasswordResetToken()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PasswordResetToken                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PasswordResetToken(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return PasswordResetToken__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pPasswordResetTypeID As Int32,
...
Try
 ...
 Dim paramExpiryDateTime As DataColumnParameter = New DataColumnParameter(defExpiryDateTime, defExpiryDateTime.DefaultValue)
 Dim paramIsUsed As DataColumnParameter = New DataColumnParameter(defIsUsed, defIsUsed.DefaultValue)
...
Public Shared Function addWithID(ByVal pToken As String,
ByVal pPasswordResetTypeID As Int32,
ByVal pUserID As Int32,
ByVal pExpiryDateTime As DateTime,
ByVal pIsUsed As Boolean,
...
Try
 ...
 Dim paramPasswordResetTypeID As DataColumnParameter = New DataColumnParameter(defPasswordResetTypeID, pPasswordResetTypeID)
 Dim paramUserID As DataColumnParameter = New DataColumnParameter(defUserID, pUserID)
 Dim paramExpiryDateTime As DataColumnParameter = New DataColumnParameter(defExpiryDateTime, pExpiryDateTime)
 Dim paramIsUsed As DataColumnParameter = New DataColumnParameter(defIsUsed, pIsUsed)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pToken As String,
ByVal pPasswordResetTypeID As Int32,
ByVal pUserID As Int32,
ByVal pExpiryDateTime As DateTime,
ByVal pIsUsed As Boolean,
...
Public Shared Function add(ByVal pToken As String,
ByVal pPasswordResetTypeID As Int32,
ByVal pUserID As Int32,
ByVal pExpiryDateTime As DateTime,
ByVal pIsUsed As Boolean,
...
Optional ByVal pToken As Object=Nothing,
Optional ByVal pPasswordResetTypeID As Object=Nothing,
Optional ByVal pUserID As Object=Nothing,
Optional ByVal pExpiryDateTime As Object=Nothing,
Optional ByVal pIsUsed As Object=Nothing,
