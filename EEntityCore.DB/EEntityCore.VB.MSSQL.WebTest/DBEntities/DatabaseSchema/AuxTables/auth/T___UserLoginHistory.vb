...
Public Class T___UserLoginHistory
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defUserAgent = New DataColumnDefinition(TableColumnNames.UserAgent.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.UserLoginHistory"
       Public Const UserLoginHistory__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [UserID], [IPAddress], [UserAgent], [CreatedAt], [SessionID], [LoggedOutTime] FROM UserLoginHistory"
       Public Const UserLoginHistory__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [UserID], [IPAddress], [UserAgent], [CreatedAt], [SessionID], [LoggedOutTime] FROM UserLoginHistory"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defUserAgent As DataColumnDefinition
       ...
       Public ReadOnly Property [UserAgent] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.UserAgent.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___UserLoginHistory                  
            If Me.hasRows() Then Return New T___UserLoginHistory(Me.AllRows(0))                  
            Return New T___UserLoginHistory()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___UserLoginHistory                  
            Return New T___UserLoginHistory(Me.RawTable, T___UserLoginHistory.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___UserLoginHistory,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___UserLoginHistory,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___UserLoginHistory                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___UserLoginHistory(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___UserLoginHistory(drst.CopyToDataTable(),                  
                    T___UserLoginHistory.TABLE_NAME)                  
                Return New T___UserLoginHistory()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___UserLoginHistory                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___UserLoginHistory(dr), pParams)                  
                Select dr                  
...
Optional ByVal pUserAgent As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pSessionID As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pLoggedOutTime As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Optional ByVal pUserAgent As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pSessionID As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pLoggedOutTime As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
...
Optional ByVal pUserAgent As Object=Nothing,
Optional ByVal pSessionID As Object=Nothing,
Optional ByVal pLoggedOutTime As Object=Nothing) As Boolean
