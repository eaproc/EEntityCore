...
Public Class T___PasswordResetTypeExtended
        Inherits  T___PasswordResetType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PasswordResetType) As T___PasswordResetTypeExtended                  
            If pVal Is Nothing Then Return New T___PasswordResetTypeExtended                  
            Return New T___PasswordResetTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
