...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.AppModule"
       Public Const AppModule__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [IsActive], [Definition], [CreatedAt] FROM AppModule"
       Public Const AppModule__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [IsActive], [Definition], [CreatedAt] FROM AppModule"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___AppModule                  
            If Me.hasRows() Then Return New T___AppModule(Me.AllRows(0))                  
            Return New T___AppModule()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___AppModule                  
            Return New T___AppModule(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___AppModule                  
            Return New T___AppModule(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___AppModule                  
            Return New T___AppModule(Me.RawTable, T___AppModule.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___AppModule,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___AppModule,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___AppModule                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___AppModule(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___AppModule(drst.CopyToDataTable(),                  
                    T___AppModule.TABLE_NAME)                  
                Return New T___AppModule()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___AppModule                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___AppModule(dr), pParams)                  
                Select dr                  
...
Public Shared Function addWithID(ByVal pIsActive As Boolean,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pIsActive As Boolean,
ByVal pDefinition As String,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pIsActive As Boolean,
ByVal pDefinition As String,
