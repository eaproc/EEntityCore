...
Public Class T___UserRoleExtended
        Inherits  T___UserRole
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___UserRole) As T___UserRoleExtended                  
            If pVal Is Nothing Then Return New T___UserRoleExtended                  
            Return New T___UserRoleExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
