...
Public Class T___LinkPermissionExtended
        Inherits  T___LinkPermission
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___LinkPermission) As T___LinkPermissionExtended                  
            If pVal Is Nothing Then Return New T___LinkPermissionExtended                  
            Return New T___LinkPermissionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
