...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.PhoneType"
       Public Const PhoneType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM PhoneType"
       Public Const PhoneType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM PhoneType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PhoneType                  
            If Me.hasRows() Then Return New T___PhoneType(Me.AllRows(0))                  
            Return New T___PhoneType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PhoneType                  
            Return New T___PhoneType(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PhoneType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PhoneType                  
            Return New T___PhoneType(Me.RawTable, T___PhoneType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PhoneType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PhoneType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PhoneType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PhoneType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PhoneType(drst.CopyToDataTable(),                  
                    T___PhoneType.TABLE_NAME)                  
                Return New T___PhoneType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PhoneType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PhoneType(dr), pParams)                  
                Select dr                  
