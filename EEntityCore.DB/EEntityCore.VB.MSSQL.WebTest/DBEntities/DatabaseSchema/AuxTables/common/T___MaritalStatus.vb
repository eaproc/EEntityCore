...
Public Class T___MaritalStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.MaritalStatus"
       Public Const MaritalStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM MaritalStatus"
       Public Const MaritalStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM MaritalStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___MaritalStatus                  
            If Me.hasRows() Then Return New T___MaritalStatus(Me.AllRows(0))                  
            Return New T___MaritalStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___MaritalStatus                  
            Return New T___MaritalStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___MaritalStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___MaritalStatus                  
            Return New T___MaritalStatus(Me.RawTable, T___MaritalStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___MaritalStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___MaritalStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___MaritalStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___MaritalStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___MaritalStatus(drst.CopyToDataTable(),                  
                    T___MaritalStatus.TABLE_NAME)                  
                Return New T___MaritalStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___MaritalStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___MaritalStatus(dr), pParams)                  
                Select dr                  
