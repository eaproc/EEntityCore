...
Public Class T___MaritalStatusExtended
        Inherits  T___MaritalStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___MaritalStatus) As T___MaritalStatusExtended                  
            If pVal Is Nothing Then Return New T___MaritalStatusExtended                  
            Return New T___MaritalStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
