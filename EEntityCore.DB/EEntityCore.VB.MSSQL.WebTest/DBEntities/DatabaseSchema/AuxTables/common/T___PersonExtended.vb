...
Public Class T___PersonExtended
        Inherits  T___Person
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Person) As T___PersonExtended                  
            If pVal Is Nothing Then Return New T___PersonExtended                  
            Return New T___PersonExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
