...
Public Class T___IdentificationViabilityExtended
        Inherits  T___IdentificationViability
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___IdentificationViability) As T___IdentificationViabilityExtended                  
            If pVal Is Nothing Then Return New T___IdentificationViabilityExtended                  
            Return New T___IdentificationViabilityExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
