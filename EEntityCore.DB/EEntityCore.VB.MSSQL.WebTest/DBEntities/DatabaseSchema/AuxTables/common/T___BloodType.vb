...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.BloodType"
       Public Const BloodType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM BloodType"
       Public Const BloodType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM BloodType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___BloodType                  
            If Me.hasRows() Then Return New T___BloodType(Me.AllRows(0))                  
            Return New T___BloodType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___BloodType                  
            Return New T___BloodType(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___BloodType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___BloodType                  
            Return New T___BloodType(Me.RawTable, T___BloodType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___BloodType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___BloodType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___BloodType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___BloodType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___BloodType(drst.CopyToDataTable(),                  
                    T___BloodType.TABLE_NAME)                  
                Return New T___BloodType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___BloodType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___BloodType(dr), pParams)                  
                Select dr                  
