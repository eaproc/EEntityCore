...
Public Class T___CalendarEventExtended
        Inherits  T___CalendarEvent
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CalendarEvent) As T___CalendarEventExtended                  
            If pVal Is Nothing Then Return New T___CalendarEventExtended                  
            Return New T___CalendarEventExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
