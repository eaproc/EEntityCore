...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.Country"
       Public Const Country__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM Country"
       Public Const Country__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM Country"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Country                  
            If Me.hasRows() Then Return New T___Country(Me.AllRows(0))                  
            Return New T___Country()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Country                  
            Return New T___Country(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Country                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___Country                  
            Return New T___Country(Me.RawTable, T___Country.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Country,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Country,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Country                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Country(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Country(drst.CopyToDataTable(),                  
                    T___Country.TABLE_NAME)                  
                Return New T___Country()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Country                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Country(dr), pParams)                  
                Select dr                  
