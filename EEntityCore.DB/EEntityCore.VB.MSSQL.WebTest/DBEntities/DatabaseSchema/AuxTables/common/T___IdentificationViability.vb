...
Public Class T___IdentificationViability
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.IdentificationViability"
       Public Const IdentificationViability__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM IdentificationViability"
       Public Const IdentificationViability__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM IdentificationViability"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___IdentificationViability                  
            If Me.hasRows() Then Return New T___IdentificationViability(Me.AllRows(0))                  
            Return New T___IdentificationViability()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___IdentificationViability                  
            Return New T___IdentificationViability(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___IdentificationViability                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___IdentificationViability                  
            Return New T___IdentificationViability(Me.RawTable, T___IdentificationViability.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___IdentificationViability,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___IdentificationViability,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___IdentificationViability                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___IdentificationViability(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___IdentificationViability(drst.CopyToDataTable(),                  
                    T___IdentificationViability.TABLE_NAME)                  
                Return New T___IdentificationViability()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___IdentificationViability                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___IdentificationViability(dr), pParams)                  
                Select dr                  
