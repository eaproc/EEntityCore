...
Public Class T___IdentificationType
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.IdentificationType"
       Public Const IdentificationType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM IdentificationType"
       Public Const IdentificationType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM IdentificationType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___IdentificationType                  
            If Me.hasRows() Then Return New T___IdentificationType(Me.AllRows(0))                  
            Return New T___IdentificationType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___IdentificationType                  
            Return New T___IdentificationType(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___IdentificationType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___IdentificationType                  
            Return New T___IdentificationType(Me.RawTable, T___IdentificationType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___IdentificationType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___IdentificationType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___IdentificationType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___IdentificationType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___IdentificationType(drst.CopyToDataTable(),                  
                    T___IdentificationType.TABLE_NAME)                  
                Return New T___IdentificationType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___IdentificationType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___IdentificationType(dr), pParams)                  
                Select dr                  
