...
Public Class T___PersonIdentificationDetailExtended
        Inherits  T___PersonIdentificationDetail
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PersonIdentificationDetail) As T___PersonIdentificationDetailExtended                  
            If pVal Is Nothing Then Return New T___PersonIdentificationDetailExtended                  
            Return New T___PersonIdentificationDetailExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
