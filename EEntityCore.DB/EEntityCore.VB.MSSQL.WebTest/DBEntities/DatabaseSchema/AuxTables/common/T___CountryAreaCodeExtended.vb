...
Public Class T___CountryAreaCodeExtended
        Inherits  T___CountryAreaCode
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CountryAreaCode) As T___CountryAreaCodeExtended                  
            If pVal Is Nothing Then Return New T___CountryAreaCodeExtended                  
            Return New T___CountryAreaCodeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
