...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.Gender"
       Public Const Gender__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM Gender"
       Public Const Gender__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM Gender"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Gender                  
            If Me.hasRows() Then Return New T___Gender(Me.AllRows(0))                  
            Return New T___Gender()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Gender                  
            Return New T___Gender(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Gender                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___Gender                  
            Return New T___Gender(Me.RawTable, T___Gender.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Gender,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Gender,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Gender                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Gender(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Gender(drst.CopyToDataTable(),                  
                    T___Gender.TABLE_NAME)                  
                Return New T___Gender()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Gender                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Gender(dr), pParams)                  
                Select dr                  
