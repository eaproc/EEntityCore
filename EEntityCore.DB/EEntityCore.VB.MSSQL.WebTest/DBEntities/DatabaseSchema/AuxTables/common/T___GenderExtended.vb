...
Public Class T___GenderExtended
        Inherits  T___Gender
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Gender) As T___GenderExtended                  
            If pVal Is Nothing Then Return New T___GenderExtended                  
            Return New T___GenderExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
