...
Public Class T___PersonDocument
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defPersonDocumentTypeID = New DataColumnDefinition(TableColumnNames.PersonDocumentTypeID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  defDocumentFileName = New DataColumnDefinition(TableColumnNames.DocumentFileName.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.PersonDocument"
       Public Const PersonDocument__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [PersonID], [PersonDocumentTypeID], [DocumentFileName], [CreatedAt] FROM PersonDocument"
       Public Const PersonDocument__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [PersonID], [PersonDocumentTypeID], [DocumentFileName], [CreatedAt] FROM PersonDocument"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defPersonDocumentTypeID As DataColumnDefinition
       ...
       Public ReadOnly Property [PersonDocumentTypeID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.PersonDocumentTypeID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PersonDocument                  
            If Me.hasRows() Then Return New T___PersonDocument(Me.AllRows(0))                  
            Return New T___PersonDocument()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PersonDocument                  
            Return New T___PersonDocument(Me.RawTable, T___PersonDocument.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PersonDocument,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PersonDocument,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PersonDocument                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PersonDocument(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PersonDocument(drst.CopyToDataTable(),                  
                    T___PersonDocument.TABLE_NAME)                  
                Return New T___PersonDocument()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PersonDocument                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PersonDocument(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return PersonDocument__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
ByVal pPersonDocumentTypeID As Int32,
ByVal pDocumentFileName As String) As Int32
...
ByVal pPersonDocumentTypeID As Int32,
ByVal pDocumentFileName As String,
...
Optional ByVal pPersonDocumentTypeID As Object=Nothing,
