...
Public Class T___DayOfWeekExtended
        Inherits  T___DayOfWeek
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___DayOfWeek) As T___DayOfWeekExtended                  
            If pVal Is Nothing Then Return New T___DayOfWeekExtended                  
            Return New T___DayOfWeekExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
