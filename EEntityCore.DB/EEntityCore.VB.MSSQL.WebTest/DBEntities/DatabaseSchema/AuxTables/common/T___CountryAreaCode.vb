...
Public Class T___CountryAreaCode
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defCountryID = New DataColumnDefinition(TableColumnNames.CountryID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.CountryAreaCode"
       Public Const CountryAreaCode__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [CountryID], [Definition], [CreatedAt] FROM CountryAreaCode"
       Public Const CountryAreaCode__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [CountryID], [Definition], [CreatedAt] FROM CountryAreaCode"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CountryAreaCode                  
            If Me.hasRows() Then Return New T___CountryAreaCode(Me.AllRows(0))                  
            Return New T___CountryAreaCode()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CountryAreaCode                  
            Return New T___CountryAreaCode(Me.RawTable, T___CountryAreaCode.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CountryAreaCode,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CountryAreaCode,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CountryAreaCode                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CountryAreaCode(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CountryAreaCode(drst.CopyToDataTable(),                  
                    T___CountryAreaCode.TABLE_NAME)                  
                Return New T___CountryAreaCode()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CountryAreaCode                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CountryAreaCode(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pCountryID As Int32,
ByVal pDefinition As String) As Int32
...
Public Shared Function addWithID(ByVal pCountryID As Int32,
ByVal pDefinition As String,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pCountryID As Int32,
ByVal pDefinition As String,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pCountryID As Int32,
ByVal pDefinition As String,
