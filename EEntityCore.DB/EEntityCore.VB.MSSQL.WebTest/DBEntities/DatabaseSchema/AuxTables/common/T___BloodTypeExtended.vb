...
Public Class T___BloodTypeExtended
        Inherits  T___BloodType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___BloodType) As T___BloodTypeExtended                  
            If pVal Is Nothing Then Return New T___BloodTypeExtended                  
            Return New T___BloodTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
