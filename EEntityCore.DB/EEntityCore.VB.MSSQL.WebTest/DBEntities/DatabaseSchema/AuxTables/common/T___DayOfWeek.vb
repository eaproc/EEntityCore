...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.DayOfWeek"
       Public Const DayOfWeek__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM DayOfWeek"
       Public Const DayOfWeek__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM DayOfWeek"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___DayOfWeek                  
            If Me.hasRows() Then Return New T___DayOfWeek(Me.AllRows(0))                  
            Return New T___DayOfWeek()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___DayOfWeek                  
            Return New T___DayOfWeek(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___DayOfWeek                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___DayOfWeek                  
            Return New T___DayOfWeek(Me.RawTable, T___DayOfWeek.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___DayOfWeek,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___DayOfWeek,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___DayOfWeek                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___DayOfWeek(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___DayOfWeek(drst.CopyToDataTable(),                  
                    T___DayOfWeek.TABLE_NAME)                  
                Return New T___DayOfWeek()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___DayOfWeek                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___DayOfWeek(dr), pParams)                  
                Select dr                  
