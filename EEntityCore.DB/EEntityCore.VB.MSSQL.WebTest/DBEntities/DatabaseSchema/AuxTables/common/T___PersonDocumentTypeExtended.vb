...
Public Class T___PersonDocumentTypeExtended
        Inherits  T___PersonDocumentType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PersonDocumentType) As T___PersonDocumentTypeExtended                  
            If pVal Is Nothing Then Return New T___PersonDocumentTypeExtended                  
            Return New T___PersonDocumentTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
