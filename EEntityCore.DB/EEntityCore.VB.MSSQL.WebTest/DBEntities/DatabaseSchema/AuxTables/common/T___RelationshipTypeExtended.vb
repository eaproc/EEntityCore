...
Public Class T___RelationshipTypeExtended
        Inherits  T___RelationshipType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___RelationshipType) As T___RelationshipTypeExtended                  
            If pVal Is Nothing Then Return New T___RelationshipTypeExtended                  
            Return New T___RelationshipTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
