...
Public Class T___IdentificationTypeExtended
        Inherits  T___IdentificationType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___IdentificationType) As T___IdentificationTypeExtended                  
            If pVal Is Nothing Then Return New T___IdentificationTypeExtended                  
            Return New T___IdentificationTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
