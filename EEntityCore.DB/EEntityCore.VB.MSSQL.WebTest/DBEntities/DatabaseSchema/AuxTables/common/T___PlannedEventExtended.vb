...
Public Class T___PlannedEventExtended
        Inherits  T___PlannedEvent
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PlannedEvent) As T___PlannedEventExtended                  
            If pVal Is Nothing Then Return New T___PlannedEventExtended                  
            Return New T___PlannedEventExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
