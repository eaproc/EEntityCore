...
Public Class T___PersonPhoneExtended
        Inherits  T___PersonPhone
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PersonPhone) As T___PersonPhoneExtended                  
            If pVal Is Nothing Then Return New T___PersonPhoneExtended                  
            Return New T___PersonPhoneExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
