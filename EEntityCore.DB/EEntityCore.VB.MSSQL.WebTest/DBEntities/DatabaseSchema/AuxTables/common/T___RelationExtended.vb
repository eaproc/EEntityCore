...
Public Class T___RelationExtended
        Inherits  T___Relation
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Relation) As T___RelationExtended                  
            If pVal Is Nothing Then Return New T___RelationExtended                  
            Return New T___RelationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
