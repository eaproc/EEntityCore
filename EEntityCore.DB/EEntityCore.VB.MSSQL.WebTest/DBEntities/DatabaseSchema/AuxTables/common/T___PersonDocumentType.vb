...
Public Class T___PersonDocumentType
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.PersonDocumentType"
       Public Const PersonDocumentType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM PersonDocumentType"
       Public Const PersonDocumentType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM PersonDocumentType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PersonDocumentType                  
            If Me.hasRows() Then Return New T___PersonDocumentType(Me.AllRows(0))                  
            Return New T___PersonDocumentType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PersonDocumentType                  
            Return New T___PersonDocumentType(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PersonDocumentType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PersonDocumentType                  
            Return New T___PersonDocumentType(Me.RawTable, T___PersonDocumentType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PersonDocumentType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PersonDocumentType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PersonDocumentType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PersonDocumentType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PersonDocumentType(drst.CopyToDataTable(),                  
                    T___PersonDocumentType.TABLE_NAME)                  
                Return New T___PersonDocumentType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PersonDocumentType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PersonDocumentType(dr), pParams)                  
                Select dr                  
