...
Public Class T___PersonTitleExtended
        Inherits  T___PersonTitle
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PersonTitle) As T___PersonTitleExtended                  
            If pVal Is Nothing Then Return New T___PersonTitleExtended                  
            Return New T___PersonTitleExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
