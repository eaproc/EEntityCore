...
Public Class T___PhoneTypeExtended
        Inherits  T___PhoneType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PhoneType) As T___PhoneTypeExtended                  
            If pVal Is Nothing Then Return New T___PhoneTypeExtended                  
            Return New T___PhoneTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
