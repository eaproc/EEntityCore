...
Public Class T___PlannedEventIntervalExtended
        Inherits  T___PlannedEventInterval
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PlannedEventInterval) As T___PlannedEventIntervalExtended                  
            If pVal Is Nothing Then Return New T___PlannedEventIntervalExtended                  
            Return New T___PlannedEventIntervalExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
