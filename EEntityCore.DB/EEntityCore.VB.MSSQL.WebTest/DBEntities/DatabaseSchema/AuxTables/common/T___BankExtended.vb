...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Bank) As T___BankExtended                  
            If pVal Is Nothing Then Return New T___BankExtended                  
            Return New T___BankExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
