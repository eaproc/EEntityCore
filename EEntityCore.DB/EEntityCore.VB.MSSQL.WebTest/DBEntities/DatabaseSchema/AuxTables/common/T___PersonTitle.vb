...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.PersonTitle"
       Public Const PersonTitle__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM PersonTitle"
       Public Const PersonTitle__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM PersonTitle"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PersonTitle                  
            If Me.hasRows() Then Return New T___PersonTitle(Me.AllRows(0))                  
            Return New T___PersonTitle()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PersonTitle                  
            Return New T___PersonTitle(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PersonTitle                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PersonTitle                  
            Return New T___PersonTitle(Me.RawTable, T___PersonTitle.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PersonTitle,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PersonTitle,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PersonTitle                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PersonTitle(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PersonTitle(drst.CopyToDataTable(),                  
                    T___PersonTitle.TABLE_NAME)                  
                Return New T___PersonTitle()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PersonTitle                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PersonTitle(dr), pParams)                  
                Select dr                  
