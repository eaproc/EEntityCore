...
Public Class T___CountryExtended
        Inherits  T___Country
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Country) As T___CountryExtended                  
            If pVal Is Nothing Then Return New T___CountryExtended                  
            Return New T___CountryExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
