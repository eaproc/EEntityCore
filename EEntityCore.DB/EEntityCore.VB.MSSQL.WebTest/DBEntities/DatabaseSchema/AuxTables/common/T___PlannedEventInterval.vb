...
Public Class T___PlannedEventInterval
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defPlannedEventID = New DataColumnDefinition(TableColumnNames.PlannedEventID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  defDayOfWeekID = New DataColumnDefinition(TableColumnNames.DayOfWeekID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "common.PlannedEventInterval"
       Public Const PlannedEventInterval__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [PlannedEventID], [DayOfWeekID], [StartTime], [EndTime], [CreatedAt] FROM PlannedEventInterval"
       Public Const PlannedEventInterval__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [PlannedEventID], [DayOfWeekID], [StartTime], [EndTime], [CreatedAt] FROM PlannedEventInterval"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PlannedEventInterval                  
            If Me.hasRows() Then Return New T___PlannedEventInterval(Me.AllRows(0))                  
            Return New T___PlannedEventInterval()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PlannedEventInterval                  
            Return New T___PlannedEventInterval(Me.RawTable, T___PlannedEventInterval.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PlannedEventInterval,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PlannedEventInterval,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PlannedEventInterval                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PlannedEventInterval(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PlannedEventInterval(drst.CopyToDataTable(),                  
                    T___PlannedEventInterval.TABLE_NAME)                  
                Return New T___PlannedEventInterval()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PlannedEventInterval                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PlannedEventInterval(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return PlannedEventInterval__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pPlannedEventID As Int32,
ByVal pDayOfWeekID As Int32) As Int32
...
Try
 ...
 Dim paramEndTime As DataColumnParameter = New DataColumnParameter(defEndTime, defEndTime.DefaultValue)
...
Public Shared Function addWithID(ByVal pPlannedEventID As Int32,
ByVal pDayOfWeekID As Int32,
ByVal pStartTime As DateTime,
ByVal pEndTime As DateTime,
...
Try
 ...
 Dim paramEndTime As DataColumnParameter = New DataColumnParameter(defEndTime, pEndTime)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pPlannedEventID As Int32,
ByVal pDayOfWeekID As Int32,
ByVal pStartTime As DateTime,
ByVal pEndTime As DateTime,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pPlannedEventID As Int32,
ByVal pDayOfWeekID As Int32,
ByVal pStartTime As DateTime,
ByVal pEndTime As DateTime,
...
Optional ByVal pPlannedEventID As Object=Nothing,
Optional ByVal pDayOfWeekID As Object=Nothing,
Optional ByVal pStartTime As Object=Nothing,
Optional ByVal pEndTime As Object=Nothing,
