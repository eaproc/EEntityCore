...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "import.ImportStatus"
       Public Const ImportStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ImportStatus"
       Public Const ImportStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ImportStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ImportStatus                  
            If Me.hasRows() Then Return New T___ImportStatus(Me.AllRows(0))                  
            Return New T___ImportStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ImportStatus                  
            Return New T___ImportStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ImportStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ImportStatus                  
            Return New T___ImportStatus(Me.RawTable, T___ImportStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ImportStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ImportStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ImportStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ImportStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ImportStatus(drst.CopyToDataTable(),                  
                    T___ImportStatus.TABLE_NAME)                  
                Return New T___ImportStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ImportStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ImportStatus(dr), pParams)                  
                Select dr                  
