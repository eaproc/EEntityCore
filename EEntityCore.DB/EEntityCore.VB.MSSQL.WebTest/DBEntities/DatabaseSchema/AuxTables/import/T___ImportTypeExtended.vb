...
Public Class T___ImportTypeExtended
        Inherits  T___ImportType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ImportType) As T___ImportTypeExtended                  
            If pVal Is Nothing Then Return New T___ImportTypeExtended                  
            Return New T___ImportTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
