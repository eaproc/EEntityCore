...
Public Class T___ImportStatusExtended
        Inherits  T___ImportStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ImportStatus) As T___ImportStatusExtended                  
            If pVal Is Nothing Then Return New T___ImportStatusExtended                  
            Return New T___ImportStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
