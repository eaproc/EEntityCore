...
Public Class T___CommonPersonExtended
        Inherits  T___CommonPerson
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CommonPerson) As T___CommonPersonExtended                  
            If pVal Is Nothing Then Return New T___CommonPersonExtended                  
            Return New T___CommonPersonExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
