...
Public Class T___DataMonitorExtended
        Inherits  T___DataMonitor
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___DataMonitor) As T___DataMonitorExtended                  
            If pVal Is Nothing Then Return New T___DataMonitorExtended                  
            Return New T___DataMonitorExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
