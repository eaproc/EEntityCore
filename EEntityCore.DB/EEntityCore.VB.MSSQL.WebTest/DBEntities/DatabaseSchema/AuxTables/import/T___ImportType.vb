...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "import.ImportType"
       Public Const ImportType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ImportType"
       Public Const ImportType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ImportType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ImportType                  
            If Me.hasRows() Then Return New T___ImportType(Me.AllRows(0))                  
            Return New T___ImportType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ImportType                  
            Return New T___ImportType(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ImportType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ImportType                  
            Return New T___ImportType(Me.RawTable, T___ImportType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ImportType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ImportType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ImportType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ImportType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ImportType(drst.CopyToDataTable(),                  
                    T___ImportType.TABLE_NAME)                  
                Return New T___ImportType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ImportType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ImportType(dr), pParams)                  
                Select dr                  
