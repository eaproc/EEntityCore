...
Public Class T___AccountingExpenditureDisbursedExtended
        Inherits  T___AccountingExpenditureDisbursed
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___AccountingExpenditureDisbursed) As T___AccountingExpenditureDisbursedExtended                  
            If pVal Is Nothing Then Return New T___AccountingExpenditureDisbursedExtended                  
            Return New T___AccountingExpenditureDisbursedExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
