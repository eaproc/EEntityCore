...
Public Class T___DonationInvoiceItem
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defMonthlyDonationID = New DataColumnDefinition(TableColumnNames.MonthlyDonationID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  ...
  defCashOutID = New DataColumnDefinition(TableColumnNames.CashOutID.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  defDonationYear = New DataColumnDefinition(TableColumnNames.DonationYear.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  defDonationMonth = New DataColumnDefinition(TableColumnNames.DonationMonth.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.DonationInvoiceItem"
       Public Const DonationInvoiceItem__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [MonthlyDonationID], [BeneficiaryID], [CashOutID], [DonationYear], [DonationMonth], [Amount], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID] FROM DonationInvoiceItem"
       Public Const DonationInvoiceItem__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [MonthlyDonationID], [BeneficiaryID], [CashOutID], [DonationYear], [DonationMonth], [Amount], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID] FROM DonationInvoiceItem"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___DonationInvoiceItem                  
            If Me.hasRows() Then Return New T___DonationInvoiceItem(Me.AllRows(0))                  
            Return New T___DonationInvoiceItem()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___DonationInvoiceItem                  
            Return New T___DonationInvoiceItem(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___DonationInvoiceItem                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___DonationInvoiceItem                  
            Return New T___DonationInvoiceItem(Me.RawTable, T___DonationInvoiceItem.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___DonationInvoiceItem,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___DonationInvoiceItem,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___DonationInvoiceItem                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___DonationInvoiceItem(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___DonationInvoiceItem(drst.CopyToDataTable(),                  
                    T___DonationInvoiceItem.TABLE_NAME)                  
                Return New T___DonationInvoiceItem()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___DonationInvoiceItem                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___DonationInvoiceItem(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pMonthlyDonationID As Int32,
ByVal pBeneficiaryID As Int32,
ByVal pCashOutID As Int32,
...
Try
 ...
 Dim paramMonthlyDonationID As DataColumnParameter = New DataColumnParameter(defMonthlyDonationID, pMonthlyDonationID)
 Dim paramBeneficiaryID As DataColumnParameter = New DataColumnParameter(defBeneficiaryID, pBeneficiaryID)
 Dim paramCashOutID As DataColumnParameter = New DataColumnParameter(defCashOutID, pCashOutID)
...
Public Shared Function addWithID(ByVal pMonthlyDonationID As Int32,
ByVal pBeneficiaryID As Int32,
ByVal pDonationYear As Int32,
ByVal pDonationMonth As Int32,
...
Optional ByVal pCashOutID As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pMonthlyDonationID As Int32,
ByVal pBeneficiaryID As Int32,
ByVal pDonationYear As Int32,
ByVal pDonationMonth As Int32,
ByVal pAmount As Decimal,
...
Public Shared Function add(ByVal pMonthlyDonationID As Int32,
ByVal pBeneficiaryID As Int32,
ByVal pDonationYear As Int32,
ByVal pDonationMonth As Int32,
ByVal pAmount As Decimal,
...
ByVal pCreatedByID As Int32,
ByVal pUpdatedByID As Int32,
Optional ByVal pCashOutID As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
...
Optional ByVal pMonthlyDonationID As Object=Nothing,
...
Optional ByVal pCashOutID As Object=Nothing) As Boolean
