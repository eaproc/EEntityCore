...
Public Class T___ExpenseRequestExtended
        Inherits  T___ExpenseRequest
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ExpenseRequest) As T___ExpenseRequestExtended                  
            If pVal Is Nothing Then Return New T___ExpenseRequestExtended                  
            Return New T___ExpenseRequestExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
