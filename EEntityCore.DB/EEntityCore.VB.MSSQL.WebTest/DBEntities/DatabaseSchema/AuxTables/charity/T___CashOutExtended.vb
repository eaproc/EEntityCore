...
Public Class T___CashOutExtended
        Inherits  T___CashOut
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CashOut) As T___CashOutExtended                  
            If pVal Is Nothing Then Return New T___CashOutExtended                  
            Return New T___CashOutExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
