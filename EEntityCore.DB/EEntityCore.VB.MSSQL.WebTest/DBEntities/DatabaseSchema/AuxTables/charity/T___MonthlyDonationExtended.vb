...
Public Class T___MonthlyDonationExtended
        Inherits  T___MonthlyDonation
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___MonthlyDonation) As T___MonthlyDonationExtended                  
            If pVal Is Nothing Then Return New T___MonthlyDonationExtended                  
            Return New T___MonthlyDonationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
