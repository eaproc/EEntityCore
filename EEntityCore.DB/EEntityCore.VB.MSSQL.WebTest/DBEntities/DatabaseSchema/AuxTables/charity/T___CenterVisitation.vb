...
Public Class T___CenterVisitation
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defVisitationDay = New DataColumnDefinition(TableColumnNames.VisitationDay.ToString(), GetType(DateTime), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  defCenterID = New DataColumnDefinition(TableColumnNames.CenterID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  ...
  defAttendees = New DataColumnDefinition(TableColumnNames.Attendees.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.CenterVisitation"
       Public Const CenterVisitation__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [VisitationDay], [CenterID], [ResidingPastorID], [StatusID], [Attendees], [PictureStoredPath], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID] FROM CenterVisitation"
       Public Const CenterVisitation__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [VisitationDay], [CenterID], [ResidingPastorID], [StatusID], [Attendees], [PictureStoredPath], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID] FROM CenterVisitation"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defVisitationDay As DataColumnDefinition
       ...
       Public Shared ReadOnly defAttendees As DataColumnDefinition
       ...
       Public ReadOnly Property [VisitationDay] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.VisitationDay.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [Attendees] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.Attendees.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CenterVisitation                  
            If Me.hasRows() Then Return New T___CenterVisitation(Me.AllRows(0))                  
            Return New T___CenterVisitation()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CenterVisitation                  
            Return New T___CenterVisitation(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CenterVisitation                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CenterVisitation                  
            Return New T___CenterVisitation(Me.RawTable, T___CenterVisitation.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CenterVisitation,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CenterVisitation,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CenterVisitation                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CenterVisitation(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CenterVisitation(drst.CopyToDataTable(),                  
                    T___CenterVisitation.TABLE_NAME)                  
                Return New T___CenterVisitation()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CenterVisitation                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CenterVisitation(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return CenterVisitation__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pVisitationDay As DateTime,
ByVal pCenterID As Int32,
...
Try
 ...
 Dim paramVisitationDay As DataColumnParameter = New DataColumnParameter(defVisitationDay, pVisitationDay)
 ...
 Dim paramAttendees As DataColumnParameter = New DataColumnParameter(defAttendees, defAttendees.DefaultValue)
...
Public Shared Function addWithID(ByVal pVisitationDay As DateTime,
ByVal pCenterID As Int32,
ByVal pResidingPastorID As Int32,
ByVal pStatusID As Int32,
ByVal pAttendees As Int32,
...
Try
 ...
 Dim paramResidingPastorID As DataColumnParameter = New DataColumnParameter(defResidingPastorID, pResidingPastorID)
 Dim paramStatusID As DataColumnParameter = New DataColumnParameter(defStatusID, pStatusID)
 Dim paramAttendees As DataColumnParameter = New DataColumnParameter(defAttendees, pAttendees)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pVisitationDay As DateTime,
ByVal pCenterID As Int32,
ByVal pResidingPastorID As Int32,
ByVal pStatusID As Int32,
ByVal pAttendees As Int32,
...
Public Shared Function add(ByVal pVisitationDay As DateTime,
ByVal pCenterID As Int32,
ByVal pResidingPastorID As Int32,
ByVal pStatusID As Int32,
ByVal pAttendees As Int32,
...
Optional ByVal pVisitationDay As Object=Nothing,
...
Optional ByVal pAttendees As Object=Nothing,
