...
Public Class T___CenterExtended
        Inherits  T___Center
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Center) As T___CenterExtended                  
            If pVal Is Nothing Then Return New T___CenterExtended                  
            Return New T___CenterExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
