...
Public Class T___BeneficiaryStatusExtended
        Inherits  T___BeneficiaryStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___BeneficiaryStatus) As T___BeneficiaryStatusExtended                  
            If pVal Is Nothing Then Return New T___BeneficiaryStatusExtended                  
            Return New T___BeneficiaryStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
