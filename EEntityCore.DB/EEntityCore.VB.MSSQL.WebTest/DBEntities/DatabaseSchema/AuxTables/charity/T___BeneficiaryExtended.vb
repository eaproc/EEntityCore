...
Public Class T___BeneficiaryExtended
        Inherits  T___Beneficiary
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Beneficiary) As T___BeneficiaryExtended                  
            If pVal Is Nothing Then Return New T___BeneficiaryExtended                  
            Return New T___BeneficiaryExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
