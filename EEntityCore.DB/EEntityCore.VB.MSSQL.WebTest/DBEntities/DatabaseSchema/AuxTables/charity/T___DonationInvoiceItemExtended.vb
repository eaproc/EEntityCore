...
Public Class T___DonationInvoiceItemExtended
        Inherits  T___DonationInvoiceItem
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___DonationInvoiceItem) As T___DonationInvoiceItemExtended                  
            If pVal Is Nothing Then Return New T___DonationInvoiceItemExtended                  
            Return New T___DonationInvoiceItemExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
