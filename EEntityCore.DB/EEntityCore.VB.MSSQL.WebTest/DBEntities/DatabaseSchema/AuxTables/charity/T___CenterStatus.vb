...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.CenterStatus"
       Public Const CenterStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM CenterStatus"
       Public Const CenterStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM CenterStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CenterStatus                  
            If Me.hasRows() Then Return New T___CenterStatus(Me.AllRows(0))                  
            Return New T___CenterStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CenterStatus                  
            Return New T___CenterStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CenterStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CenterStatus                  
            Return New T___CenterStatus(Me.RawTable, T___CenterStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CenterStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CenterStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CenterStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CenterStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CenterStatus(drst.CopyToDataTable(),                  
                    T___CenterStatus.TABLE_NAME)                  
                Return New T___CenterStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CenterStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CenterStatus(dr), pParams)                  
                Select dr                  
