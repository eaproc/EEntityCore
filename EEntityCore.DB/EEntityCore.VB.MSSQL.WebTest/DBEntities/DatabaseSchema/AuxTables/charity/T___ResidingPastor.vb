...
Public Class T___ResidingPastor
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defActivatedOn = New DataColumnDefinition(TableColumnNames.ActivatedOn.ToString(), GetType(DateTime), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defDeactivatedOn = New DataColumnDefinition(TableColumnNames.DeactivatedOn.ToString(), GetType(DateTime), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defIdPictureStoredPath = New DataColumnDefinition(TableColumnNames.IdPictureStoredPath.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.ResidingPastor"
       Public Const ResidingPastor__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [CenterID], [BankID], [AccountNumber], [PersonID], [ActivatedOn], [DeactivatedOn], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID], [IdPictureStoredPath] FROM ResidingPastor"
       Public Const ResidingPastor__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [CenterID], [BankID], [AccountNumber], [PersonID], [ActivatedOn], [DeactivatedOn], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID], [IdPictureStoredPath] FROM ResidingPastor"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defActivatedOn As DataColumnDefinition
       Public Shared ReadOnly defDeactivatedOn As DataColumnDefinition
       ...
       Public Shared ReadOnly defIdPictureStoredPath As DataColumnDefinition
       ...
       Public ReadOnly Property [ActivatedOn] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.ActivatedOn.ToString()))
           End Get
       End Property


       Public ReadOnly Property [DeactivatedOn] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.DeactivatedOn.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [IdPictureStoredPath] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.IdPictureStoredPath.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ResidingPastor                  
            If Me.hasRows() Then Return New T___ResidingPastor(Me.AllRows(0))                  
            Return New T___ResidingPastor()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ResidingPastor                  
            Return New T___ResidingPastor(Me.RawTable, T___ResidingPastor.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ResidingPastor,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ResidingPastor,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ResidingPastor                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ResidingPastor(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ResidingPastor(drst.CopyToDataTable(),                  
                    T___ResidingPastor.TABLE_NAME)                  
                Return New T___ResidingPastor()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ResidingPastor                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ResidingPastor(dr), pParams)                  
                Select dr                  
...
Try
 ...
 Dim paramActivatedOn As DataColumnParameter = New DataColumnParameter(defActivatedOn, defActivatedOn.DefaultValue)
 Dim paramDeactivatedOn As DataColumnParameter = New DataColumnParameter(defDeactivatedOn, defDeactivatedOn.DefaultValue)
...
ByVal pPersonID As Int32,
ByVal pActivatedOn As DateTime,
ByVal pCreatedAt As DateTime,
ByVal pUpdatedAt As DateTime,
ByVal pCreatedByID As Int32,
ByVal pUpdatedByID As Int32,
Optional ByVal pDeactivatedOn As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pIdPictureStoredPath As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Try
 ...
 Dim paramPersonID As DataColumnParameter = New DataColumnParameter(defPersonID, pPersonID)
 Dim paramActivatedOn As DataColumnParameter = New DataColumnParameter(defActivatedOn, pActivatedOn)
 Dim paramDeactivatedOn As DataColumnParameter = New DataColumnParameter(defDeactivatedOn, pDeactivatedOn)
...
ByVal pUpdatedByID As Int32,
Optional ByVal pDeactivatedOn As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pIdPictureStoredPath As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
...
Optional ByVal pActivatedOn As Object=Nothing,
...
Optional ByVal pDeactivatedOn As Object=Nothing,
Optional ByVal pIdPictureStoredPath As Object=Nothing) As Boolean
