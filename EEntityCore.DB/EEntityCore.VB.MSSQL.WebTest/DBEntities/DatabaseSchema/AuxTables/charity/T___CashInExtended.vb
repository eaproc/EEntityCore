...
Public Class T___CashInExtended
        Inherits  T___CashIn
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CashIn) As T___CashInExtended                  
            If pVal Is Nothing Then Return New T___CashInExtended                  
            Return New T___CashInExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
