...
Public Class T___ResidingPastorExtended
        Inherits  T___ResidingPastor
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ResidingPastor) As T___ResidingPastorExtended                  
            If pVal Is Nothing Then Return New T___ResidingPastorExtended                  
            Return New T___ResidingPastorExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
