...
Public Class T___CashInTypeExtended
        Inherits  T___CashInType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CashInType) As T___CashInTypeExtended                  
            If pVal Is Nothing Then Return New T___CashInTypeExtended                  
            Return New T___CashInTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
