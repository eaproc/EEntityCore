...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.CashInType"
       Public Const CashInType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM CashInType"
       Public Const CashInType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM CashInType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CashInType                  
            If Me.hasRows() Then Return New T___CashInType(Me.AllRows(0))                  
            Return New T___CashInType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CashInType                  
            Return New T___CashInType(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CashInType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CashInType                  
            Return New T___CashInType(Me.RawTable, T___CashInType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CashInType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CashInType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CashInType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CashInType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CashInType(drst.CopyToDataTable(),                  
                    T___CashInType.TABLE_NAME)                  
                Return New T___CashInType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CashInType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CashInType(dr), pParams)                  
                Select dr                  
