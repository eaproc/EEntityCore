...
Public Class T___CenterVisitationExtended
        Inherits  T___CenterVisitation
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CenterVisitation) As T___CenterVisitationExtended                  
            If pVal Is Nothing Then Return New T___CenterVisitationExtended                  
            Return New T___CenterVisitationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
