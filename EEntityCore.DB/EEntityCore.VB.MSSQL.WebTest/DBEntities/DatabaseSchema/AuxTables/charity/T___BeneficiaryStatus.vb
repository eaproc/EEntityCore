...
Public Class T___BeneficiaryStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.BeneficiaryStatus"
       Public Const BeneficiaryStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM BeneficiaryStatus"
       Public Const BeneficiaryStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM BeneficiaryStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___BeneficiaryStatus                  
            If Me.hasRows() Then Return New T___BeneficiaryStatus(Me.AllRows(0))                  
            Return New T___BeneficiaryStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___BeneficiaryStatus                  
            Return New T___BeneficiaryStatus(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___BeneficiaryStatus                  
            Return New T___BeneficiaryStatus(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___BeneficiaryStatus                  
            Return New T___BeneficiaryStatus(Me.RawTable, T___BeneficiaryStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___BeneficiaryStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___BeneficiaryStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___BeneficiaryStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___BeneficiaryStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___BeneficiaryStatus(drst.CopyToDataTable(),                  
                    T___BeneficiaryStatus.TABLE_NAME)                  
                Return New T___BeneficiaryStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___BeneficiaryStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___BeneficiaryStatus(dr), pParams)                  
                Select dr                  
