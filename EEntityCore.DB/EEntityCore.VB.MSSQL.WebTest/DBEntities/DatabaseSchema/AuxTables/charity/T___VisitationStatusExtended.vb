...
Public Class T___VisitationStatusExtended
        Inherits  T___VisitationStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___VisitationStatus) As T___VisitationStatusExtended                  
            If pVal Is Nothing Then Return New T___VisitationStatusExtended                  
            Return New T___VisitationStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
