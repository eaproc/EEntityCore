...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defReceiverID = New DataColumnDefinition(TableColumnNames.ReceiverID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  ...
  defRequestComments = New DataColumnDefinition(TableColumnNames.RequestComments.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defResponseComments = New DataColumnDefinition(TableColumnNames.ResponseComments.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.CashOut"
       Public Const CashOut__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [CashRequestStatusID], [CategoryID], [Amount], [ReceiverID], [Description], [RequestComments], [ResponseComments], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID] FROM CashOut"
       Public Const CashOut__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [CashRequestStatusID], [CategoryID], [Amount], [ReceiverID], [Description], [RequestComments], [ResponseComments], [CreatedAt], [UpdatedAt], [CreatedByID], [UpdatedByID] FROM CashOut"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defReceiverID As DataColumnDefinition
       Public Shared ReadOnly defDescription As DataColumnDefinition
       Public Shared ReadOnly defRequestComments As DataColumnDefinition
       Public Shared ReadOnly defResponseComments As DataColumnDefinition
       ...
       Public ReadOnly Property [ReceiverID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.ReceiverID.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [RequestComments] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.RequestComments.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [ResponseComments] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.ResponseComments.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CashOut                  
            If Me.hasRows() Then Return New T___CashOut(Me.AllRows(0))                  
            Return New T___CashOut()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CashOut                  
            Return New T___CashOut(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CashOut                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CashOut                  
            Return New T___CashOut(Me.RawTable, T___CashOut.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CashOut,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CashOut,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CashOut                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CashOut(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CashOut(drst.CopyToDataTable(),                  
                    T___CashOut.TABLE_NAME)                  
                Return New T___CashOut()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CashOut                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CashOut(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return CashOut__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pCashRequestStatusID As Int32,
ByVal pCategoryID As Int32,
ByVal pReceiverID As Int32,
...
Try
 ...
 Dim paramReceiverID As DataColumnParameter = New DataColumnParameter(defReceiverID, pReceiverID)
 ...
 Dim paramRequestComments As DataColumnParameter = New DataColumnParameter(defRequestComments, defRequestComments.DefaultValue)
 Dim paramResponseComments As DataColumnParameter = New DataColumnParameter(defResponseComments, defResponseComments.DefaultValue)
...
Public Shared Function addWithID(ByVal pCashRequestStatusID As Int32,
ByVal pCategoryID As Int32,
...
Optional ByVal pRequestComments As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pResponseComments As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Try
 ...
 Dim paramRequestComments As DataColumnParameter = New DataColumnParameter(defRequestComments, pRequestComments)
 Dim paramResponseComments As DataColumnParameter = New DataColumnParameter(defResponseComments, pResponseComments)
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pCashRequestStatusID As Int32,
ByVal pCategoryID As Int32,
ByVal pAmount As Decimal,
ByVal pReceiverID As Int32,
ByVal pDescription As String,
...
Public Shared Function add(ByVal pCashRequestStatusID As Int32,
ByVal pCategoryID As Int32,
ByVal pAmount As Decimal,
ByVal pReceiverID As Int32,
ByVal pDescription As String,
...
ByVal pUpdatedByID As Int32,
Optional ByVal pRequestComments As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pResponseComments As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
...
Optional ByVal pReceiverID As Object=Nothing,
...
Optional ByVal pRequestComments As Object=Nothing,
Optional ByVal pResponseComments As Object=Nothing) As Boolean
