...
Public Class T___AttendeeDetailExtended
        Inherits  T___AttendeeDetail
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___AttendeeDetail) As T___AttendeeDetailExtended                  
            If pVal Is Nothing Then Return New T___AttendeeDetailExtended                  
            Return New T___AttendeeDetailExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
