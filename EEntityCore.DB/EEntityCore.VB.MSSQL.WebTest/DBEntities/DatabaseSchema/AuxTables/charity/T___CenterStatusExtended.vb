...
Public Class T___CenterStatusExtended
        Inherits  T___CenterStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CenterStatus) As T___CenterStatusExtended                  
            If pVal Is Nothing Then Return New T___CenterStatusExtended                  
            Return New T___CenterStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
