...
Public Class T___BeneficiaryRelationExtended
        Inherits  T___BeneficiaryRelation
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___BeneficiaryRelation) As T___BeneficiaryRelationExtended                  
            If pVal Is Nothing Then Return New T___BeneficiaryRelationExtended                  
            Return New T___BeneficiaryRelationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
