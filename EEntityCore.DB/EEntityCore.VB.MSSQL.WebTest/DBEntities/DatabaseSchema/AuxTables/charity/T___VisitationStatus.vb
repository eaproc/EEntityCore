...
Public Class T___VisitationStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "charity.VisitationStatus"
       Public Const VisitationStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM VisitationStatus"
       Public Const VisitationStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM VisitationStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___VisitationStatus                  
            If Me.hasRows() Then Return New T___VisitationStatus(Me.AllRows(0))                  
            Return New T___VisitationStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___VisitationStatus                  
            Return New T___VisitationStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___VisitationStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___VisitationStatus                  
            Return New T___VisitationStatus(Me.RawTable, T___VisitationStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___VisitationStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___VisitationStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___VisitationStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___VisitationStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___VisitationStatus(drst.CopyToDataTable(),                  
                    T___VisitationStatus.TABLE_NAME)                  
                Return New T___VisitationStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___VisitationStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___VisitationStatus(dr), pParams)                  
                Select dr                  
...
Public Shared Function addWithID(ByVal pDefinition As String) As Int32
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pDefinition As String) As Int32
...
Public Shared Function add(ByVal pDefinition As String) As Boolean
...
Optional ByVal pDefinition As Object=Nothing) As Boolean
