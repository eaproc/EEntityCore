...
Public Class T___PaymentChannelExtended
        Inherits  T___PaymentChannel
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentChannel) As T___PaymentChannelExtended                  
            If pVal Is Nothing Then Return New T___PaymentChannelExtended                  
            Return New T___PaymentChannelExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
