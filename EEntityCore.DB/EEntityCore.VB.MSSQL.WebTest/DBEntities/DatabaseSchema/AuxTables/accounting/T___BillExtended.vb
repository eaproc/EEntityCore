...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Bill) As T___BillExtended                  
            If pVal Is Nothing Then Return New T___BillExtended                  
            Return New T___BillExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
