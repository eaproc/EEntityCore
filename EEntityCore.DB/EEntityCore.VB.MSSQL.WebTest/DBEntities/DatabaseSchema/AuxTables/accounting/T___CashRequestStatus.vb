...
Public Class T___CashRequestStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.CashRequestStatus"
       Public Const CashRequestStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM CashRequestStatus"
       Public Const CashRequestStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM CashRequestStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___CashRequestStatus                  
            If Me.hasRows() Then Return New T___CashRequestStatus(Me.AllRows(0))                  
            Return New T___CashRequestStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___CashRequestStatus                  
            Return New T___CashRequestStatus(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___CashRequestStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___CashRequestStatus                  
            Return New T___CashRequestStatus(Me.RawTable, T___CashRequestStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___CashRequestStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___CashRequestStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___CashRequestStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___CashRequestStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___CashRequestStatus(drst.CopyToDataTable(),                  
                    T___CashRequestStatus.TABLE_NAME)                  
                Return New T___CashRequestStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___CashRequestStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___CashRequestStatus(dr), pParams)                  
                Select dr                  
