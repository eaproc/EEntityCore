...
Public Class T___InvoiceExtended
        Inherits  T___Invoice
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Invoice) As T___InvoiceExtended                  
            If pVal Is Nothing Then Return New T___InvoiceExtended                  
            Return New T___InvoiceExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
