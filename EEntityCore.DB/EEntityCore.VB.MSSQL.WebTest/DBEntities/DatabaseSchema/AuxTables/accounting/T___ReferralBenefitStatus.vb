...
Public Class T___ReferralBenefitStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.ReferralBenefitStatus"
       Public Const ReferralBenefitStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ReferralBenefitStatus"
       Public Const ReferralBenefitStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ReferralBenefitStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ReferralBenefitStatus                  
            If Me.hasRows() Then Return New T___ReferralBenefitStatus(Me.AllRows(0))                  
            Return New T___ReferralBenefitStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ReferralBenefitStatus                  
            Return New T___ReferralBenefitStatus(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ReferralBenefitStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ReferralBenefitStatus                  
            Return New T___ReferralBenefitStatus(Me.RawTable, T___ReferralBenefitStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ReferralBenefitStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ReferralBenefitStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ReferralBenefitStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ReferralBenefitStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ReferralBenefitStatus(drst.CopyToDataTable(),                  
                    T___ReferralBenefitStatus.TABLE_NAME)                  
                Return New T___ReferralBenefitStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ReferralBenefitStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ReferralBenefitStatus(dr), pParams)                  
                Select dr                  
