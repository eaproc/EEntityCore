...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defIsFixed = New DataColumnDefinition(TableColumnNames.IsFixed.ToString(), GetType(Boolean), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.Bill"
       Public Const Bill__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [Description], [CreatedAt], [IsFixed] FROM Bill"
       Public Const Bill__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [Description], [CreatedAt], [IsFixed] FROM Bill"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defIsFixed As DataColumnDefinition
       ...
       Public ReadOnly Property [IsFixed] As Boolean
           Get
               ...
               Return EBoolean.valueOf(Me.TargettedRow(TableColumnNames.IsFixed.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Bill                  
            If Me.hasRows() Then Return New T___Bill(Me.AllRows(0))                  
            Return New T___Bill()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___Bill                  
            Return New T___Bill(Me.RawTable, T___Bill.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Bill,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Bill,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Bill                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Bill(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Bill(drst.CopyToDataTable(),                  
                    T___Bill.TABLE_NAME)                  
                Return New T___Bill()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Bill                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Bill(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return Bill__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Optional ByVal pIsFixed As Object=Nothing,
