...
Public Class T___ReferralTypeExtended
        Inherits  T___ReferralType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ReferralType) As T___ReferralTypeExtended                  
            If pVal Is Nothing Then Return New T___ReferralTypeExtended                  
            Return New T___ReferralTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
