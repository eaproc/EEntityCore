...
Public Class T___WithdrawalStatus
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.WithdrawalStatus"
       Public Const WithdrawalStatus__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM WithdrawalStatus"
       Public Const WithdrawalStatus__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM WithdrawalStatus"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___WithdrawalStatus                  
            If Me.hasRows() Then Return New T___WithdrawalStatus(Me.AllRows(0))                  
            Return New T___WithdrawalStatus()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___WithdrawalStatus                  
            Return New T___WithdrawalStatus(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___WithdrawalStatus                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___WithdrawalStatus                  
            Return New T___WithdrawalStatus(Me.RawTable, T___WithdrawalStatus.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___WithdrawalStatus,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___WithdrawalStatus,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___WithdrawalStatus                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___WithdrawalStatus(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___WithdrawalStatus(drst.CopyToDataTable(),                  
                    T___WithdrawalStatus.TABLE_NAME)                  
                Return New T___WithdrawalStatus()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___WithdrawalStatus                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___WithdrawalStatus(dr), pParams)                  
                Select dr                  
