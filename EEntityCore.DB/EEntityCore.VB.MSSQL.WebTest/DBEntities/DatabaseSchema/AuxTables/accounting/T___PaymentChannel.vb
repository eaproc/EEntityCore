...
Public Class T___PaymentChannel
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.PaymentChannel"
       Public Const PaymentChannel__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PaymentChannel"
       Public Const PaymentChannel__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PaymentChannel"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PaymentChannel                  
            If Me.hasRows() Then Return New T___PaymentChannel(Me.AllRows(0))                  
            Return New T___PaymentChannel()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PaymentChannel                  
            Return New T___PaymentChannel(Me.RawTable, T___PaymentChannel.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PaymentChannel,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PaymentChannel,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PaymentChannel                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PaymentChannel(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PaymentChannel(drst.CopyToDataTable(),                  
                    T___PaymentChannel.TABLE_NAME)                  
                Return New T___PaymentChannel()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PaymentChannel                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PaymentChannel(dr), pParams)                  
                Select dr                  
