...
Public Class T___WithdrawalStatusExtended
        Inherits  T___WithdrawalStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___WithdrawalStatus) As T___WithdrawalStatusExtended                  
            If pVal Is Nothing Then Return New T___WithdrawalStatusExtended                  
            Return New T___WithdrawalStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
