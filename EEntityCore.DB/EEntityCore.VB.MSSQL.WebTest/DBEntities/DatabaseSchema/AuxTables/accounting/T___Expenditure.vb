...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defCashRequestID = New DataColumnDefinition(TableColumnNames.CashRequestID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  ...
  defSpentAmount = New DataColumnDefinition(TableColumnNames.SpentAmount.ToString(), GetType(Decimal), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defChargesComments = New DataColumnDefinition(TableColumnNames.ChargesComments.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.Expenditure"
       Public Const Expenditure__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [TermID], [IpAddress], [CreatedAt], [CreatedByID], [CashRequestID], [Total], [DataMonitorID], [Charges], [SpentAmount], [ChargesComments] FROM Expenditure"
       Public Const Expenditure__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [TermID], [IpAddress], [CreatedAt], [CreatedByID], [CashRequestID], [Total], [DataMonitorID], [Charges], [SpentAmount], [ChargesComments] FROM Expenditure"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defSpentAmount As DataColumnDefinition
       Public Shared ReadOnly defChargesComments As DataColumnDefinition
       ...
       Public ReadOnly Property [SpentAmount] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.SpentAmount.ToString())) )
           End Get
       End Property


       Public ReadOnly Property [ChargesComments] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.ChargesComments.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Expenditure                  
            If Me.hasRows() Then Return New T___Expenditure(Me.AllRows(0))                  
            Return New T___Expenditure()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Expenditure                  
            Return New T___Expenditure(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Expenditure                  
            Return New T___Expenditure(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___Expenditure                  
            Return New T___Expenditure(Me.RawTable, T___Expenditure.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Expenditure,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Expenditure,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Expenditure                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Expenditure(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Expenditure(drst.CopyToDataTable(),                  
                    T___Expenditure.TABLE_NAME)                  
                Return New T___Expenditure()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Expenditure                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Expenditure(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return Expenditure__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Try
 ...
 Dim paramSpentAmount As DataColumnParameter = New DataColumnParameter(defSpentAmount, defSpentAmount.DefaultValue)
 Dim paramChargesComments As DataColumnParameter = New DataColumnParameter(defChargesComments, defChargesComments.DefaultValue)
...
ByVal pSpentAmount As Decimal,
Optional ByVal pDataMonitorID As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pChargesComments As Object = DataColumnNullParamValue.NULL_VALUE) As Int32
...
Try
 ...
 Dim paramSpentAmount As DataColumnParameter = New DataColumnParameter(defSpentAmount, pSpentAmount)
 Dim paramChargesComments As DataColumnParameter = New DataColumnParameter(defChargesComments, pChargesComments)
...
ByVal pSpentAmount As Decimal,
Optional ByVal pDataMonitorID As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pChargesComments As Object = DataColumnNullParamValue.NULL_VALUE) As Boolean
...
Optional ByVal pSpentAmount As Object=Nothing,
Optional ByVal pDataMonitorID As Object=Nothing,
Optional ByVal pChargesComments As Object=Nothing) As Boolean
