...
Public Class T___ReferralPayment
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defReferredClientID = New DataColumnDefinition(TableColumnNames.ReferredClientID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.ReferralPayment"
       Public Const ReferralPayment__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [ReferredClientID], [Amount], [TermID], [Comments], [CreatedByID], [CreatedAt] FROM ReferralPayment"
       Public Const ReferralPayment__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [ReferredClientID], [Amount], [TermID], [Comments], [CreatedByID], [CreatedAt] FROM ReferralPayment"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defReferredClientID As DataColumnDefinition
       ...
       Public ReadOnly Property [ReferredClientID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.ReferredClientID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ReferralPayment                  
            If Me.hasRows() Then Return New T___ReferralPayment(Me.AllRows(0))                  
            Return New T___ReferralPayment()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ReferralPayment                  
            Return New T___ReferralPayment(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ReferralPayment                  
            Return New T___ReferralPayment(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___ReferralPayment                  
            Return New T___ReferralPayment(Me.RawTable, T___ReferralPayment.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ReferralPayment,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ReferralPayment,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ReferralPayment                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ReferralPayment(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ReferralPayment(drst.CopyToDataTable(),                  
                    T___ReferralPayment.TABLE_NAME)                  
                Return New T___ReferralPayment()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ReferralPayment                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ReferralPayment(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pReferredClientID As Int32,
...
Try
 ...
 Dim paramReferredClientID As DataColumnParameter = New DataColumnParameter(defReferredClientID, pReferredClientID)
...
Public Shared Function addWithID(ByVal pReferredClientID As Int32,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pReferredClientID As Int32,
ByVal pAmount As Decimal,
ByVal pTermID As Int32,
ByVal pCreatedByID As Int32,
ByVal pCreatedAt As DateTime,
...
Public Shared Function add(ByVal pReferredClientID As Int32,
ByVal pAmount As Decimal,
ByVal pTermID As Int32,
ByVal pCreatedByID As Int32,
ByVal pCreatedAt As DateTime,
...
Optional ByVal pReferredClientID As Object=Nothing,
