...
Public Class T___ReferralPaymentExtended
        Inherits  T___ReferralPayment
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ReferralPayment) As T___ReferralPaymentExtended                  
            If pVal Is Nothing Then Return New T___ReferralPaymentExtended                  
            Return New T___ReferralPaymentExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
