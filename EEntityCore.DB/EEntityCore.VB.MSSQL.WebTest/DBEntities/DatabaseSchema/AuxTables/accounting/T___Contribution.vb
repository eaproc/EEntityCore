...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.Contribution"
       Public Const Contribution__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [Amount], [CreatedAt], [TermID], [CreatedByID] FROM Contribution"
       Public Const Contribution__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [Amount], [CreatedAt], [TermID], [CreatedByID] FROM Contribution"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Contribution                  
            If Me.hasRows() Then Return New T___Contribution(Me.AllRows(0))                  
            Return New T___Contribution()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Contribution                  
            Return New T___Contribution(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Contribution                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___Contribution                  
            Return New T___Contribution(Me.RawTable, T___Contribution.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Contribution,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Contribution,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Contribution                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Contribution(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Contribution(drst.CopyToDataTable(),                  
                    T___Contribution.TABLE_NAME)                  
                Return New T___Contribution()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Contribution                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Contribution(dr), pParams)                  
                Select dr                  
...
Return DBConnectInterface.GetDBConn().dbExec(
     String.Format("INSERT INTO {0}([Description],[Amount],[CreatedAt],[TermID],[CreatedByID]) VALUES({1},{2},{3},{4},{5}) ", TABLE_NAME,paramDescription.getSQLQuotedValueForAdd(),
paramAmount.getSQLQuotedValueForAdd(),
paramCreatedAt.getSQLQuotedValueForAdd(),
paramTermID.getSQLQuotedValueForAdd(),
paramCreatedByID.getSQLQuotedValueForAdd()  ), True)
...
DBConnectInterface.GetDBConn().dbExec(
     String.Format("UPDATE {0} SET [Description]={2},[Amount]={3},[CreatedAt]={4},[TermID]={5},[CreatedByID]={6} WHERE ID={1} ", TABLE_NAME, paramID.getSQLQuotedValueForUpdate(),paramDescription.getSQLQuotedValueForUpdate(),
