...
Public Class T___ReferralBenefitStatusExtended
        Inherits  T___ReferralBenefitStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ReferralBenefitStatus) As T___ReferralBenefitStatusExtended                  
            If pVal Is Nothing Then Return New T___ReferralBenefitStatusExtended                  
            Return New T___ReferralBenefitStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
