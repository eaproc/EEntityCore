...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defTermID = New DataColumnDefinition(TableColumnNames.TermID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
  ...
  defBill = New DataColumnDefinition(TableColumnNames.Bill.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.TermBill"
       Public Const TermBill__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [ClientID], [TermID], [CreatedByID], [CreatedAt], [OriginalBillID], [Amount], [Bill], [Description] FROM TermBill"
       Public Const TermBill__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [ClientID], [TermID], [CreatedByID], [CreatedAt], [OriginalBillID], [Amount], [Bill], [Description] FROM TermBill"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defBill As DataColumnDefinition
       ...
       Public ReadOnly Property [Bill] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.Bill.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___TermBill                  
            If Me.hasRows() Then Return New T___TermBill(Me.AllRows(0))                  
            Return New T___TermBill()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___TermBill                  
            Return New T___TermBill(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___TermBill                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___TermBill                  
            Return New T___TermBill(Me.RawTable, T___TermBill.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___TermBill,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___TermBill,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___TermBill                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___TermBill(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___TermBill(drst.CopyToDataTable(),                  
                    T___TermBill.TABLE_NAME)                  
                Return New T___TermBill()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___TermBill                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___TermBill(dr), pParams)                  
                Select dr                  
...
ByVal pBill As String) As Int32
...
Try
 ...
 Dim paramBill As DataColumnParameter = New DataColumnParameter(defBill, pBill)
...
Optional ByVal pBill As Object=Nothing,
