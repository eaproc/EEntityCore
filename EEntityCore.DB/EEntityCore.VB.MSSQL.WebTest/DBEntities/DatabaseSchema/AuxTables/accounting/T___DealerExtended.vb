...
Public Class T___DealerExtended
        Inherits  T___Dealer
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Dealer) As T___DealerExtended                  
            If pVal Is Nothing Then Return New T___DealerExtended                  
            Return New T___DealerExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
