...
Public Class T___ReferredClientExtended
        Inherits  T___ReferredClient
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ReferredClient) As T___ReferredClientExtended                  
            If pVal Is Nothing Then Return New T___ReferredClientExtended                  
            Return New T___ReferredClientExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
