...
Public Class T___ContributionExtended
        Inherits  T___Contribution
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Contribution) As T___ContributionExtended                  
            If pVal Is Nothing Then Return New T___ContributionExtended                  
            Return New T___ContributionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
