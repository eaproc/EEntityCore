...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defDefaultPercentage = New DataColumnDefinition(TableColumnNames.DefaultPercentage.ToString(), GetType(Decimal), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.ReferralType"
       Public Const ReferralType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [Description], [IsActive], [CreatedAt], [DefaultPercentage] FROM ReferralType"
       Public Const ReferralType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [Description], [IsActive], [CreatedAt], [DefaultPercentage] FROM ReferralType"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defDefaultPercentage As DataColumnDefinition
       ...
       Public ReadOnly Property [DefaultPercentage] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.DefaultPercentage.ToString())) )
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ReferralType                  
            If Me.hasRows() Then Return New T___ReferralType(Me.AllRows(0))                  
            Return New T___ReferralType()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ReferralType                  
            Return New T___ReferralType(Me.RawTable, T___ReferralType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ReferralType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ReferralType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ReferralType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ReferralType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ReferralType(drst.CopyToDataTable(),                  
                    T___ReferralType.TABLE_NAME)                  
                Return New T___ReferralType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ReferralType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ReferralType(dr), pParams)                  
                Select dr                  
...
ByVal pDefaultPercentage As Decimal,
...
Optional ByVal pDefaultPercentage As Object=Nothing,
