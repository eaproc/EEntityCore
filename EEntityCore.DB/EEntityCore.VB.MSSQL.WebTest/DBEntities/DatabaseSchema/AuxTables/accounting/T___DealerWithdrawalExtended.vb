...
Public Class T___DealerWithdrawalExtended
        Inherits  T___DealerWithdrawal
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___DealerWithdrawal) As T___DealerWithdrawalExtended                  
            If pVal Is Nothing Then Return New T___DealerWithdrawalExtended                  
            Return New T___DealerWithdrawalExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
