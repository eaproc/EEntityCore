...
Public Class T___PaymentExtended
        Inherits  T___Payment
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Payment) As T___PaymentExtended                  
            If pVal Is Nothing Then Return New T___PaymentExtended                  
            Return New T___PaymentExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
