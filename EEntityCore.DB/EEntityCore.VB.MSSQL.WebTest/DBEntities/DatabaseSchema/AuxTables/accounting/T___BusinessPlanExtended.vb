...
Public Class T___BusinessPlanExtended
        Inherits  T___BusinessPlan
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___BusinessPlan) As T___BusinessPlanExtended                  
            If pVal Is Nothing Then Return New T___BusinessPlanExtended                  
            Return New T___BusinessPlanExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
