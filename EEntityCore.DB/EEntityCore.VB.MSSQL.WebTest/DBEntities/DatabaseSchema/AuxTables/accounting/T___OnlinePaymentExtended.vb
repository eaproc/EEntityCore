...
Public Class T___OnlinePaymentExtended
        Inherits  T___OnlinePayment
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___OnlinePayment) As T___OnlinePaymentExtended                  
            If pVal Is Nothing Then Return New T___OnlinePaymentExtended                  
            Return New T___OnlinePaymentExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
