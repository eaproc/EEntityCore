...
Public Class T___ExpenditureCategory
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defDefinition = New DataColumnDefinition(TableColumnNames.Definition.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.ExpenditureCategory"
       Public Const ExpenditureCategory__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CanBeDeleted], [CreatedAt] FROM ExpenditureCategory"
       Public Const ExpenditureCategory__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CanBeDeleted], [CreatedAt] FROM ExpenditureCategory"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defDefinition As DataColumnDefinition
       ...
       Public ReadOnly Property [Definition] As String
           Get
               ...
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.Definition.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ExpenditureCategory                  
            If Me.hasRows() Then Return New T___ExpenditureCategory(Me.AllRows(0))                  
            Return New T___ExpenditureCategory()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ExpenditureCategory                  
            Return New T___ExpenditureCategory(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ExpenditureCategory                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ExpenditureCategory                  
            Return New T___ExpenditureCategory(Me.RawTable, T___ExpenditureCategory.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ExpenditureCategory,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ExpenditureCategory,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ExpenditureCategory                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ExpenditureCategory(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ExpenditureCategory(drst.CopyToDataTable(),                  
                    T___ExpenditureCategory.TABLE_NAME)                  
                Return New T___ExpenditureCategory()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ExpenditureCategory                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ExpenditureCategory(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pDefinition As String) As Int32
...
Public Shared Function addWithID(ByVal pDefinition As String,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pDefinition As String,
ByVal pCanBeDeleted As Boolean,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pDefinition As String,
ByVal pCanBeDeleted As Boolean,
...
Optional ByVal pDefinition As Object=Nothing,
