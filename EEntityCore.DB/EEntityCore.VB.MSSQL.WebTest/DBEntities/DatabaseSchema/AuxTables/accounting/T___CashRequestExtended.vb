...
Public Class T___CashRequestExtended
        Inherits  T___CashRequest
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CashRequest) As T___CashRequestExtended                  
            If pVal Is Nothing Then Return New T___CashRequestExtended                  
            Return New T___CashRequestExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
