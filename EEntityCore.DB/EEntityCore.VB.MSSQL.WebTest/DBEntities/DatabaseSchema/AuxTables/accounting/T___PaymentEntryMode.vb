...
Public Class T___PaymentEntryMode
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.PaymentEntryMode"
       Public Const PaymentEntryMode__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PaymentEntryMode"
       Public Const PaymentEntryMode__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Description], [CreatedAt] FROM PaymentEntryMode"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PaymentEntryMode                  
            If Me.hasRows() Then Return New T___PaymentEntryMode(Me.AllRows(0))                  
            Return New T___PaymentEntryMode()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PaymentEntryMode                  
            Return New T___PaymentEntryMode(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PaymentEntryMode                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PaymentEntryMode                  
            Return New T___PaymentEntryMode(Me.RawTable, T___PaymentEntryMode.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PaymentEntryMode,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PaymentEntryMode,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PaymentEntryMode                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PaymentEntryMode(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PaymentEntryMode(drst.CopyToDataTable(),                  
                    T___PaymentEntryMode.TABLE_NAME)                  
                Return New T___PaymentEntryMode()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PaymentEntryMode                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PaymentEntryMode(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return PaymentEntryMode__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
