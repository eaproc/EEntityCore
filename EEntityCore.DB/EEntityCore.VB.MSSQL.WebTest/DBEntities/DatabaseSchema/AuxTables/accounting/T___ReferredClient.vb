...
Public Class T___ReferredClient
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defReferralTypeID = New DataColumnDefinition(TableColumnNames.ReferralTypeID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
  defReferralBenefitStatusID = New DataColumnDefinition(TableColumnNames.ReferralBenefitStatusID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.FOREIGN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.ReferredClient"
       Public Const ReferredClient__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [DealerID], [ClientID], [TermID], [ReferralTypeID], [ReferralBenefitStatusID], [CreatedAt], [UpdatedAt] FROM ReferredClient"
       Public Const ReferredClient__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [DealerID], [ClientID], [TermID], [ReferralTypeID], [ReferralBenefitStatusID], [CreatedAt], [UpdatedAt] FROM ReferredClient"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defReferralTypeID As DataColumnDefinition
       Public Shared ReadOnly defReferralBenefitStatusID As DataColumnDefinition
       ...
       Public ReadOnly Property [ReferralTypeID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.ReferralTypeID.ToString()))
           End Get
       End Property


       Public ReadOnly Property [ReferralBenefitStatusID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.ReferralBenefitStatusID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ReferredClient                  
            If Me.hasRows() Then Return New T___ReferredClient(Me.AllRows(0))                  
            Return New T___ReferredClient()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ReferredClient                  
            Return New T___ReferredClient(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ReferredClient                  
            Return New T___ReferredClient(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___ReferredClient                  
            Return New T___ReferredClient(Me.RawTable, T___ReferredClient.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ReferredClient,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ReferredClient,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ReferredClient                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ReferredClient(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ReferredClient(drst.CopyToDataTable(),                  
                    T___ReferredClient.TABLE_NAME)                  
                Return New T___ReferredClient()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ReferredClient                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ReferredClient(dr), pParams)                  
                Select dr                  
...
ByVal pReferralTypeID As Int32,
ByVal pReferralBenefitStatusID As Int32) As Int32
...
Try
 ...
 Dim paramReferralTypeID As DataColumnParameter = New DataColumnParameter(defReferralTypeID, pReferralTypeID)
 Dim paramReferralBenefitStatusID As DataColumnParameter = New DataColumnParameter(defReferralBenefitStatusID, pReferralBenefitStatusID)
...
ByVal pTermID As Int32,
ByVal pReferralTypeID As Int32,
ByVal pReferralBenefitStatusID As Int32,
...
Optional ByVal pReferralTypeID As Object=Nothing,
Optional ByVal pReferralBenefitStatusID As Object=Nothing,
