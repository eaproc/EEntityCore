...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.Payout"
       Public Const Payout__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [ClientID], [Amount], [Charges], [Comments], [Total], [CreatedAt], [CreatedByID] FROM Payout"
       Public Const Payout__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [ClientID], [Amount], [Charges], [Comments], [Total], [CreatedAt], [CreatedByID] FROM Payout"
