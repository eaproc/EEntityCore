...
Public Class T___ExpenditureCategoryExtended
        Inherits  T___ExpenditureCategory
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ExpenditureCategory) As T___ExpenditureCategoryExtended                  
            If pVal Is Nothing Then Return New T___ExpenditureCategoryExtended                  
            Return New T___ExpenditureCategoryExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
