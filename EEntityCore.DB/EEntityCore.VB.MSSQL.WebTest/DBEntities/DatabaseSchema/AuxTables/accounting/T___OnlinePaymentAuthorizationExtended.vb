...
Public Class T___OnlinePaymentAuthorizationExtended
        Inherits  T___OnlinePaymentAuthorization
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___OnlinePaymentAuthorization) As T___OnlinePaymentAuthorizationExtended                  
            If pVal Is Nothing Then Return New T___OnlinePaymentAuthorizationExtended                  
            Return New T___OnlinePaymentAuthorizationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
