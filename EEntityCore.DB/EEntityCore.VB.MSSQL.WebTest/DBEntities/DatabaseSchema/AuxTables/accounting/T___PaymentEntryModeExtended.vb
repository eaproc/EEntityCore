...
Public Class T___PaymentEntryModeExtended
        Inherits  T___PaymentEntryMode
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PaymentEntryMode) As T___PaymentEntryModeExtended                  
            If pVal Is Nothing Then Return New T___PaymentEntryModeExtended                  
            Return New T___PaymentEntryModeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
