...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defDealerCode = New DataColumnDefinition(TableColumnNames.DealerCode.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.Dealer"
       Public Const Dealer__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [PersonID], [BankID], [AccountNumber], [IsActive], [DealerCode], [CompanyName], [WebsiteUrl], [OfficeAddress], [CountryID], [CreatedAt], [UpdatedAt] FROM Dealer"
       Public Const Dealer__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [PersonID], [BankID], [AccountNumber], [IsActive], [DealerCode], [CompanyName], [WebsiteUrl], [OfficeAddress], [CountryID], [CreatedAt], [UpdatedAt] FROM Dealer"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Dealer                  
            If Me.hasRows() Then Return New T___Dealer(Me.AllRows(0))                  
            Return New T___Dealer()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Dealer                  
            Return New T___Dealer(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Dealer                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___Dealer                  
            Return New T___Dealer(Me.RawTable, T___Dealer.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Dealer,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Dealer,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Dealer                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Dealer(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Dealer(drst.CopyToDataTable(),                  
                    T___Dealer.TABLE_NAME)                  
                Return New T___Dealer()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Dealer                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Dealer(dr), pParams)                  
                Select dr                  
...
Try
 ...
 Dim paramDealerCode As DataColumnParameter = New DataColumnParameter(defDealerCode, pDealerCode)
 ...
 Dim paramCompanyName As DataColumnParameter = New DataColumnParameter(defCompanyName, defCompanyName.DefaultValue)
 Dim paramWebsiteUrl As DataColumnParameter = New DataColumnParameter(defWebsiteUrl, defWebsiteUrl.DefaultValue)
 Dim paramOfficeAddress As DataColumnParameter = New DataColumnParameter(defOfficeAddress, defOfficeAddress.DefaultValue)
...
Optional ByVal pAccountNumber As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pCompanyName As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pWebsiteUrl As Object = DataColumnNullParamValue.NULL_VALUE,
Optional ByVal pOfficeAddress As Object = DataColumnNullParamValue.NULL_VALUE,
...
Try
 ...
 Dim paramOfficeAddress As DataColumnParameter = New DataColumnParameter(defOfficeAddress, pOfficeAddress)
 Dim paramCountryID As DataColumnParameter = New DataColumnParameter(defCountryID, pCountryID)
...
Optional ByVal pDealerCode As Object=Nothing,
...
Optional ByVal pOfficeAddress As Object=Nothing,
