...
Public Class T___ExpenditureExtended
        Inherits  T___Expenditure
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Expenditure) As T___ExpenditureExtended                  
            If pVal Is Nothing Then Return New T___ExpenditureExtended                  
            Return New T___ExpenditureExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
