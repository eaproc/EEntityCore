...
Public Class T___CashRequestStatusExtended
        Inherits  T___CashRequestStatus
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___CashRequestStatus) As T___CashRequestStatusExtended                  
            If pVal Is Nothing Then Return New T___CashRequestStatusExtended                  
            Return New T___CashRequestStatusExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
