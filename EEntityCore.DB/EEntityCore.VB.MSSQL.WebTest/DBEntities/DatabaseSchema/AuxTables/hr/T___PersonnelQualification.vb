...
Public Class T___PersonnelQualification
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defQualificationID = New DataColumnDefinition(TableColumnNames.QualificationID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "hr.PersonnelQualification"
       Public Const PersonnelQualification__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [QualificationID], [PersonnelID], [CreatedAt] FROM PersonnelQualification"
       Public Const PersonnelQualification__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [QualificationID], [PersonnelID], [CreatedAt] FROM PersonnelQualification"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defQualificationID As DataColumnDefinition
       Public Shared ReadOnly defPersonnelID As DataColumnDefinition
       Public Shared ReadOnly defCreatedAt As DataColumnDefinition

       Public ReadOnly Property [QualificationID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.QualificationID.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___PersonnelQualification                  
            If Me.hasRows() Then Return New T___PersonnelQualification(Me.AllRows(0))                  
            Return New T___PersonnelQualification()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___PersonnelQualification                  
            Return New T___PersonnelQualification(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___PersonnelQualification                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___PersonnelQualification                  
            Return New T___PersonnelQualification(Me.RawTable, T___PersonnelQualification.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___PersonnelQualification,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___PersonnelQualification,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___PersonnelQualification                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___PersonnelQualification(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___PersonnelQualification(drst.CopyToDataTable(),                  
                    T___PersonnelQualification.TABLE_NAME)                  
                Return New T___PersonnelQualification()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___PersonnelQualification                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___PersonnelQualification(dr), pParams)                  
                Select dr                  
        ...
        Public Overridable Function getFillSQL() As String Implements IDBTableDefinitionPlugIn.getFillSQL                  
            Return PersonnelQualification__NO__BINARY___SQL_FILL_QUERY                  
        End Function                  
...
Public Shared Function addNewDefault(ByVal pQualificationID As Int32,
ByVal pPersonnelID As Int32) As Int32

Try

 Dim paramID As DataColumnParameter = New DataColumnParameter(defID, DatabaseInit.DBConnectInterface.getDBConn().GETNewID(TABLE_NAME))
 Dim paramQualificationID As DataColumnParameter = New DataColumnParameter(defQualificationID, pQualificationID)
...
Public Shared Function addWithID(ByVal pQualificationID As Int32,
...
Public Shared Function addWithParseID(Byval pParseID As Int32,ByVal pQualificationID As Int32,
ByVal pPersonnelID As Int32,
ByVal pCreatedAt As DateTime) As Int32
...
Public Shared Function add(ByVal pQualificationID As Int32,
ByVal pPersonnelID As Int32,
...
Optional ByVal pQualificationID As Object=Nothing,
