...
Public Class T___ResignationReasonExtended
        Inherits  T___ResignationReason
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ResignationReason) As T___ResignationReasonExtended                  
            If pVal Is Nothing Then Return New T___ResignationReasonExtended                  
            Return New T___ResignationReasonExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
