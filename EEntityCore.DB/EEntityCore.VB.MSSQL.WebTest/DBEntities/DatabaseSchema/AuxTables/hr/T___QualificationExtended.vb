...
Public Class T___QualificationExtended
        Inherits  T___Qualification
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Qualification) As T___QualificationExtended                  
            If pVal Is Nothing Then Return New T___QualificationExtended                  
            Return New T___QualificationExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
