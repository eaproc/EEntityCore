...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defRank = New DataColumnDefinition(TableColumnNames.Rank.ToString(), GetType(Byte), False, Nothing,DataColumnDefinition.ConstraintTypes.UNIQUE) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "hr.Position"
       Public Const Position__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt], [Rank] FROM Position"
       Public Const Position__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt], [Rank] FROM Position"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defRank As DataColumnDefinition
       ...
       Public ReadOnly Property [Rank] As Byte
           Get
               ...
               Return EShort.valueOf(Me.TargettedRow(TableColumnNames.Rank.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Position                  
            If Me.hasRows() Then Return New T___Position(Me.AllRows(0))                  
            Return New T___Position()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Position                  
            Return New T___Position(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Position                  
            Return New T___Position(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As T___Position                  
            Return New T___Position(Me.RawTable, T___Position.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Position,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Position,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Position                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Position(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Position(drst.CopyToDataTable(),                  
                    T___Position.TABLE_NAME)                  
                Return New T___Position()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Position                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Position(dr), pParams)                  
                Select dr                  
...
Public Shared Function addNewDefault(ByVal pDefinition As String,
ByVal pRank As Byte) As Int32
...
ByVal pCreatedAt As DateTime,
ByVal pRank As Byte) As Boolean
...
Return DBConnectInterface.getDBConn().dbExec(
     String.Format("INSERT INTO {0}([Definition],[CreatedAt],[Rank]) VALUES({1},{2},{3}) ", TABLE_NAME,paramDefinition.getSQLQuotedValueForAdd(),
paramCreatedAt.getSQLQuotedValueForAdd(),
paramRank.getSQLQuotedValueForAdd()  ), True)
...
Optional ByVal pRank As Object=Nothing) As Boolean
...
DBConnectInterface.getDBConn().dbExec(
     String.Format("UPDATE {0} SET [Definition]={2},[CreatedAt]={3},[Rank]={4} WHERE ID={1} ", TABLE_NAME, paramID.getSQLQuotedValueForUpdate(),paramDefinition.getSQLQuotedValueForUpdate(),
