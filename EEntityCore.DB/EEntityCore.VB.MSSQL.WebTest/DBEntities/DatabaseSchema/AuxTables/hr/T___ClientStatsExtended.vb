...
Public Class T___ClientStatsExtended
        Inherits  T___ClientStats
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___ClientStats) As T___ClientStatsExtended                  
            If pVal Is Nothing Then Return New T___ClientStatsExtended                  
            Return New T___ClientStatsExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
