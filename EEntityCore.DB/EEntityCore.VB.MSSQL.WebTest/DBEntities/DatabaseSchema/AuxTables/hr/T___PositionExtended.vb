...
Public Class T___PositionExtended
        Inherits  T___Position
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Position) As T___PositionExtended                  
            If pVal Is Nothing Then Return New T___PositionExtended                  
            Return New T___PositionExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
