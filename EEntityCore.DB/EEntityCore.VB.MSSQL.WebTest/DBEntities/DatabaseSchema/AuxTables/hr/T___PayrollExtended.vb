...
Public Class T___PayrollExtended
        Inherits  T___Payroll
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Payroll) As T___PayrollExtended                  
            If pVal Is Nothing Then Return New T___PayrollExtended                  
            Return New T___PayrollExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
