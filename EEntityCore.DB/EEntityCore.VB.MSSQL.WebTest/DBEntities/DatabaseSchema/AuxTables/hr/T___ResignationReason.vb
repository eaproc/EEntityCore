...
Public Class T___ResignationReason
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "hr.ResignationReason"
       Public Const ResignationReason__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ResignationReason"
       Public Const ResignationReason__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM ResignationReason"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___ResignationReason                  
            If Me.hasRows() Then Return New T___ResignationReason(Me.AllRows(0))                  
            Return New T___ResignationReason()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___ResignationReason                  
            Return New T___ResignationReason(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___ResignationReason                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___ResignationReason                  
            Return New T___ResignationReason(Me.RawTable, T___ResignationReason.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___ResignationReason,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___ResignationReason,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___ResignationReason                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___ResignationReason(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___ResignationReason(drst.CopyToDataTable(),                  
                    T___ResignationReason.TABLE_NAME)                  
                Return New T___ResignationReason()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___ResignationReason                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___ResignationReason(dr), pParams)                  
                Select dr                  
