...
Public Class T___Qualification
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "hr.Qualification"
       Public Const Qualification__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM Qualification"
       Public Const Qualification__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM Qualification"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___Qualification                  
            If Me.hasRows() Then Return New T___Qualification(Me.AllRows(0))                  
            Return New T___Qualification()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___Qualification                  
            Return New T___Qualification(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___Qualification                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___Qualification                  
            Return New T___Qualification(Me.RawTable, T___Qualification.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___Qualification,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___Qualification,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___Qualification                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___Qualification(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___Qualification(drst.CopyToDataTable(),                  
                    T___Qualification.TABLE_NAME)                  
                Return New T___Qualification()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___Qualification                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___Qualification(dr), pParams)                  
                Select dr                  
