...
Public Class T___ClientExtended
        Inherits  T___Client
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___Client) As T___ClientExtended                  
            If pVal Is Nothing Then Return New T___ClientExtended                  
            Return New T___ClientExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
