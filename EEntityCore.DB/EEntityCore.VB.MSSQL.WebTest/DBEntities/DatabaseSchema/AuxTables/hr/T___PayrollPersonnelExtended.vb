...
Public Class T___PayrollPersonnelExtended
        Inherits  T___PayrollPersonnel
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___PayrollPersonnel) As T___PayrollPersonnelExtended                  
            If pVal Is Nothing Then Return New T___PayrollPersonnelExtended                  
            Return New T___PayrollPersonnelExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
