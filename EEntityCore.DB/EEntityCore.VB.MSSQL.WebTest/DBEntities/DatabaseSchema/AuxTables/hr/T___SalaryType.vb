...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "hr.SalaryType"
       Public Const SalaryType__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM SalaryType"
       Public Const SalaryType__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition], [CreatedAt] FROM SalaryType"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As T___SalaryType                  
            If Me.hasRows() Then Return New T___SalaryType(Me.AllRows(0))                  
            Return New T___SalaryType()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As T___SalaryType                  
            Return New T___SalaryType(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As T___SalaryType                  
        ...
        Public Function getRowWhereID(pID As Int32) As T___SalaryType                  
            Return New T___SalaryType(Me.RawTable, T___SalaryType.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As T___SalaryType,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As T___SalaryType,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As T___SalaryType                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New T___SalaryType(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New T___SalaryType(drst.CopyToDataTable(),                  
                    T___SalaryType.TABLE_NAME)                  
                Return New T___SalaryType()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As T___SalaryType                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New T___SalaryType(dr), pParams)                  
                Select dr                  
