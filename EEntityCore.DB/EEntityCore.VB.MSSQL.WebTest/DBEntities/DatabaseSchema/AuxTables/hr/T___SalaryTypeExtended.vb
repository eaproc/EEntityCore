...
Public Class T___SalaryTypeExtended
        Inherits  T___SalaryType
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As T___SalaryType) As T___SalaryTypeExtended                  
            If pVal Is Nothing Then Return New T___SalaryTypeExtended                  
            Return New T___SalaryTypeExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
