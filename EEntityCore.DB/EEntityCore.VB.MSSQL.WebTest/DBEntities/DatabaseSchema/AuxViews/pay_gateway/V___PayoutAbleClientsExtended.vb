...
Public Class V___PayoutAbleClientsExtended
        Inherits  V___PayoutAbleClients
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___PayoutAbleClients) As V___PayoutAbleClientsExtended                  
            If pVal Is Nothing Then Return New V___PayoutAbleClientsExtended                  
            Return New V___PayoutAbleClientsExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
