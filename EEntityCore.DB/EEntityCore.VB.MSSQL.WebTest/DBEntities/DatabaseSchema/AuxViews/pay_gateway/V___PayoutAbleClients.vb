...
Namespace EEntityCore.VB.MSSQL.WebTest.DBEntities.DatabaseSchema.AuxViews.pay_gateway

Public Class V___PayoutAbleClients
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defOwnerID = New DataColumnDefinition(TableColumnNames.OwnerID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defTotalPayable = New DataColumnDefinition(TableColumnNames.TotalPayable.ToString(), GetType(Decimal), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "pay_gateway.PayoutAbleClients"
       Public Const PayoutAbleClients__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [CompanyName], [CreatedAt], [OwnerID], [SLAFileName], [ScadwareURL], [Email], [Mobile], [WebsiteURL], [LogoFileName], [UpdatedAt], [IsActive], [NameAbbreviation], [Address], [BankID], [AccountName], [AccountNumber], [TotalPayable] FROM PayoutAbleClients"
       Public Const PayoutAbleClients__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [CompanyName], [CreatedAt], [OwnerID], [SLAFileName], [ScadwareURL], [Email], [Mobile], [WebsiteURL], [LogoFileName], [UpdatedAt], [IsActive], [NameAbbreviation], [Address], [BankID], [AccountName], [AccountNumber], [TotalPayable] FROM PayoutAbleClients"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defTotalPayable As DataColumnDefinition
       ...
       Public ReadOnly Property [TotalPayable] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.TotalPayable.ToString())) )
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___PayoutAbleClients                  
            If Me.hasRows() Then Return New V___PayoutAbleClients(Me.AllRows(0))                  
            Return New V___PayoutAbleClients()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___PayoutAbleClients                  
            Return New V___PayoutAbleClients(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___PayoutAbleClients                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___PayoutAbleClients                  
            Return New V___PayoutAbleClients(Me.RawTable, V___PayoutAbleClients.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___PayoutAbleClients,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___PayoutAbleClients,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___PayoutAbleClients                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___PayoutAbleClients(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___PayoutAbleClients(drst.CopyToDataTable(),                  
                    V___PayoutAbleClients.TABLE_NAME)                  
                Return New V___PayoutAbleClients()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___PayoutAbleClients                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___PayoutAbleClients(dr), pParams)                  
                Select dr                  
