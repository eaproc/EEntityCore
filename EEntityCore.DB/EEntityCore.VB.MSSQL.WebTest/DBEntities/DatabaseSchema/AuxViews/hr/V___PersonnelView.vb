...
Public Class V___PersonnelView
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defPositionID = New DataColumnDefinition(TableColumnNames.PositionID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defSalaryTypeID = New DataColumnDefinition(TableColumnNames.SalaryTypeID.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defUpdatedByID = New DataColumnDefinition(TableColumnNames.UpdatedByID.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "hr.PersonnelView"
       Public Const PersonnelView__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [PersonnelNumber], [PersonID], [IsActive], [EmploymentDate], [IsSuperUser], [PositionID], [SalaryTypeID], [SalaryAmount], [CreatedByID], [UpdatedByID], [CreatedAt], [UpdatedAt], [Duties], [IsWebVisible], [FullName], [FirstName], [LastName], [PictureFileName], [BankName], [BankID], [AccountNumber] FROM PersonnelView"
       Public Const PersonnelView__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [PersonnelNumber], [PersonID], [IsActive], [EmploymentDate], [IsSuperUser], [PositionID], [SalaryTypeID], [SalaryAmount], [CreatedByID], [UpdatedByID], [CreatedAt], [UpdatedAt], [Duties], [IsWebVisible], [FullName], [FirstName], [LastName], [PictureFileName], [BankName], [BankID], [AccountNumber] FROM PersonnelView"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___PersonnelView                  
            If Me.hasRows() Then Return New V___PersonnelView(Me.AllRows(0))                  
            Return New V___PersonnelView()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___PersonnelView                  
            Return New V___PersonnelView(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___PersonnelView                  
            Return New V___PersonnelView(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___PersonnelView                  
            Return New V___PersonnelView(Me.RawTable, V___PersonnelView.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___PersonnelView,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___PersonnelView,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___PersonnelView                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___PersonnelView(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___PersonnelView(drst.CopyToDataTable(),                  
                    V___PersonnelView.TABLE_NAME)                  
                Return New V___PersonnelView()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___PersonnelView                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___PersonnelView(dr), pParams)                  
                Select dr                  
