...
Public Class V___PayrollPersonnelViewExtended
        Inherits  V___PayrollPersonnelView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___PayrollPersonnelView) As V___PayrollPersonnelViewExtended                  
            If pVal Is Nothing Then Return New V___PayrollPersonnelViewExtended                  
            Return New V___PayrollPersonnelViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
