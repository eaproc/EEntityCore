...
Public Class V___PersonnelViewExtended
        Inherits  V___PersonnelView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___PersonnelView) As V___PersonnelViewExtended                  
            If pVal Is Nothing Then Return New V___PersonnelViewExtended                  
            Return New V___PersonnelViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
