...
Public Class V___TermViewExtended
        Inherits  V___TermView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___TermView) As V___TermViewExtended                  
            If pVal Is Nothing Then Return New V___TermViewExtended                  
            Return New V___TermViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
