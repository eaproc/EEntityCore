...
Public Class V___TurnOverPerClientExtended
        Inherits  V___TurnOverPerClient
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___TurnOverPerClient) As V___TurnOverPerClientExtended                  
            If pVal Is Nothing Then Return New V___TurnOverPerClientExtended                  
            Return New V___TurnOverPerClientExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
