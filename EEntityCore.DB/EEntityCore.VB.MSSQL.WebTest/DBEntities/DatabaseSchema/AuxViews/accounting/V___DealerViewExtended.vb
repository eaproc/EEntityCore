...
Public Class V___DealerViewExtended
        Inherits  V___DealerView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___DealerView) As V___DealerViewExtended                  
            If pVal Is Nothing Then Return New V___DealerViewExtended                  
            Return New V___DealerViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
