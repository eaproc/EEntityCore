...
Public Class V___ActiveTermInvoiceGuideExtended
        Inherits  V___ActiveTermInvoiceGuide
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___ActiveTermInvoiceGuide) As V___ActiveTermInvoiceGuideExtended                  
            If pVal Is Nothing Then Return New V___ActiveTermInvoiceGuideExtended                  
            Return New V___ActiveTermInvoiceGuideExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
