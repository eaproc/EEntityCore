...
Public Class V___TermInvoiceGuideExtended
        Inherits  V___TermInvoiceGuide
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___TermInvoiceGuide) As V___TermInvoiceGuideExtended                  
            If pVal Is Nothing Then Return New V___TermInvoiceGuideExtended                  
            Return New V___TermInvoiceGuideExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
