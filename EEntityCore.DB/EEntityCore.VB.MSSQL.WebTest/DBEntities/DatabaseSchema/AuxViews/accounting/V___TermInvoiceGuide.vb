...
Public Class V___TermInvoiceGuide
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defOriginalBillID = New DataColumnDefinition(TableColumnNames.OriginalBillID.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defBillDefinition = New DataColumnDefinition(TableColumnNames.BillDefinition.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defBilledRatePerStudent = New DataColumnDefinition(TableColumnNames.BilledRatePerStudent.ToString(), GetType(Decimal), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defBilledAmount = New DataColumnDefinition(TableColumnNames.BilledAmount.ToString(), GetType(Decimal), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___TermInvoiceGuide                  
            If Me.hasRows() Then Return New V___TermInvoiceGuide(Me.AllRows(0))                  
            Return New V___TermInvoiceGuide()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___TermInvoiceGuide                  
            Return New V___TermInvoiceGuide(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___TermInvoiceGuide                  
            Return New V___TermInvoiceGuide(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___TermInvoiceGuide                  
            Return New V___TermInvoiceGuide(Me.RawTable, V___TermInvoiceGuide.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___TermInvoiceGuide,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___TermInvoiceGuide,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___TermInvoiceGuide                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___TermInvoiceGuide(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___TermInvoiceGuide(drst.CopyToDataTable(),                  
                    V___TermInvoiceGuide.TABLE_NAME)                  
                Return New V___TermInvoiceGuide()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___TermInvoiceGuide                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___TermInvoiceGuide(dr), pParams)                  
                Select dr                  
