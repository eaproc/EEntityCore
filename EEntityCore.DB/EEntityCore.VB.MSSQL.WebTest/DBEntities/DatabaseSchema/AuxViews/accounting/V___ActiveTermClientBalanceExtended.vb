...
Public Class V___ActiveTermClientBalanceExtended
        Inherits  V___ActiveTermClientBalance
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___ActiveTermClientBalance) As V___ActiveTermClientBalanceExtended                  
            If pVal Is Nothing Then Return New V___ActiveTermClientBalanceExtended                  
            Return New V___ActiveTermClientBalanceExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
