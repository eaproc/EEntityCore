...
Public Class V___DealersBalanceExtended
        Inherits  V___DealersBalance
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___DealersBalance) As V___DealersBalanceExtended                  
            If pVal Is Nothing Then Return New V___DealersBalanceExtended                  
            Return New V___DealersBalanceExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
