...
Public Class V___CashRequestLastResponseExtended
        Inherits  V___CashRequestLastResponse
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___CashRequestLastResponse) As V___CashRequestLastResponseExtended                  
            If pVal Is Nothing Then Return New V___CashRequestLastResponseExtended                  
            Return New V___CashRequestLastResponseExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
