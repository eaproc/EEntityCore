...
Public Class V___TurnOverPerClient
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.TurnOverPerClient"
       Public Const TurnOverPerClient__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ClientID], [Name], [BillTotal], [Arrears], [PaymentMade], [Discount], [BalanceDue], [Surplus] FROM TurnOverPerClient"
       Public Const TurnOverPerClient__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ClientID], [Name], [BillTotal], [Arrears], [PaymentMade], [Discount], [BalanceDue], [Surplus] FROM TurnOverPerClient"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___TurnOverPerClient                  
            If Me.hasRows() Then Return New V___TurnOverPerClient(Me.AllRows(0))                  
            Return New V___TurnOverPerClient()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___TurnOverPerClient                  
            Return New V___TurnOverPerClient(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___TurnOverPerClient                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___TurnOverPerClient                  
            Return New V___TurnOverPerClient(Me.RawTable, V___TurnOverPerClient.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___TurnOverPerClient,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___TurnOverPerClient,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___TurnOverPerClient                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___TurnOverPerClient(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___TurnOverPerClient(drst.CopyToDataTable(),                  
                    V___TurnOverPerClient.TABLE_NAME)                  
                Return New V___TurnOverPerClient()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___TurnOverPerClient                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___TurnOverPerClient(dr), pParams)                  
                Select dr                  
