...
Public Class V___DealersBalance
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  defDealerID = New DataColumnDefinition(TableColumnNames.DealerID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defEarnedAmount = New DataColumnDefinition(TableColumnNames.EarnedAmount.ToString(), GetType(Decimal), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defPendingAmount = New DataColumnDefinition(TableColumnNames.PendingAmount.ToString(), GetType(Decimal), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defWithdrawnAmount = New DataColumnDefinition(TableColumnNames.WithdrawnAmount.ToString(), GetType(Decimal), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "accounting.DealersBalance"
       Public Const DealersBalance__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [DealerID], [EarnedAmount], [PendingAmount], [WithdrawnAmount], [Balance] FROM DealersBalance"
       Public Const DealersBalance__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [DealerID], [EarnedAmount], [PendingAmount], [WithdrawnAmount], [Balance] FROM DealersBalance"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defEarnedAmount As DataColumnDefinition
       Public Shared ReadOnly defPendingAmount As DataColumnDefinition
       Public Shared ReadOnly defWithdrawnAmount As DataColumnDefinition
       ...
       Public ReadOnly Property [EarnedAmount] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.EarnedAmount.ToString())) )
           End Get
       End Property


       Public ReadOnly Property [PendingAmount] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.PendingAmount.ToString())) )
           End Get
       End Property


       Public ReadOnly Property [WithdrawnAmount] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.WithdrawnAmount.ToString())) )
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___DealersBalance                  
            If Me.hasRows() Then Return New V___DealersBalance(Me.AllRows(0))                  
            Return New V___DealersBalance()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___DealersBalance                  
            Return New V___DealersBalance(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___DealersBalance                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___DealersBalance                  
            Return New V___DealersBalance(Me.RawTable, V___DealersBalance.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___DealersBalance,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___DealersBalance,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___DealersBalance                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___DealersBalance(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___DealersBalance(drst.CopyToDataTable(),                  
                    V___DealersBalance.TABLE_NAME)                  
                Return New V___DealersBalance()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___DealersBalance                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___DealersBalance(dr), pParams)                  
                Select dr                  
