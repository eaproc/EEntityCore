...
Public Class V___SMSUsageLogBalanceExtended
        Inherits  V___SMSUsageLogBalance
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___SMSUsageLogBalance) As V___SMSUsageLogBalanceExtended                  
            If pVal Is Nothing Then Return New V___SMSUsageLogBalanceExtended                  
            Return New V___SMSUsageLogBalanceExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
