...
Namespace EEntityCore.VB.MSSQL.WebTest.DBEntities.DatabaseSchema.AuxViews.system

Public Class V___SMSUsageLogBalance
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  defQuantityStocked = New DataColumnDefinition(TableColumnNames.QuantityStocked.ToString(), GetType(Decimal), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defQuantityUsed = New DataColumnDefinition(TableColumnNames.QuantityUsed.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "system.SMSUsageLogBalance"
       Public Const SMSUsageLogBalance__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [QuantityStocked], [QuantityUsed] FROM SMSUsageLogBalance"
       Public Const SMSUsageLogBalance__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [QuantityStocked], [QuantityUsed] FROM SMSUsageLogBalance"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defQuantityStocked As DataColumnDefinition
       Public Shared ReadOnly defQuantityUsed As DataColumnDefinition

       Public ReadOnly Property [QuantityStocked] As Decimal
           Get
               If Not Me.isValidRow then Return 0                          
               Return CDec( EDouble.valueOf(Me.TargettedRow(TableColumnNames.QuantityStocked.ToString())) )
           End Get
       End Property


       Public ReadOnly Property [QuantityUsed] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.QuantityUsed.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___SMSUsageLogBalance                  
            If Me.hasRows() Then Return New V___SMSUsageLogBalance(Me.AllRows(0))                  
            Return New V___SMSUsageLogBalance()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___SMSUsageLogBalance                  
            Return New V___SMSUsageLogBalance(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___SMSUsageLogBalance                  
            Return New V___SMSUsageLogBalance(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___SMSUsageLogBalance                  
            Return New V___SMSUsageLogBalance(Me.RawTable, V___SMSUsageLogBalance.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___SMSUsageLogBalance,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___SMSUsageLogBalance,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___SMSUsageLogBalance                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___SMSUsageLogBalance(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___SMSUsageLogBalance(drst.CopyToDataTable(),                  
                    V___SMSUsageLogBalance.TABLE_NAME)                  
                Return New V___SMSUsageLogBalance()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___SMSUsageLogBalance                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___SMSUsageLogBalance(dr), pParams)                  
                Select dr                  
