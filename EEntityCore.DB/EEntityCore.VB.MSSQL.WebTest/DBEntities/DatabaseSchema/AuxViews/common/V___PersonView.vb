...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defPersonTitle = New DataColumnDefinition(TableColumnNames.PersonTitle.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defMaritalStatus = New DataColumnDefinition(TableColumnNames.MaritalStatus.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___PersonView                  
            If Me.hasRows() Then Return New V___PersonView(Me.AllRows(0))                  
            Return New V___PersonView()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___PersonView                  
            Return New V___PersonView(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___PersonView                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___PersonView                  
            Return New V___PersonView(Me.RawTable, V___PersonView.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___PersonView,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___PersonView,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___PersonView                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___PersonView(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___PersonView(drst.CopyToDataTable(),                  
                    V___PersonView.TABLE_NAME)                  
                Return New V___PersonView()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___PersonView                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___PersonView(dr), pParams)                  
                Select dr                  
