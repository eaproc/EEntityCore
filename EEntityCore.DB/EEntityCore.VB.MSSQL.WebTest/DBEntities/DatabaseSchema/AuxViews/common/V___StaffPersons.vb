...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___StaffPersons                  
            If Me.hasRows() Then Return New V___StaffPersons(Me.AllRows(0))                  
            Return New V___StaffPersons()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___StaffPersons                  
            Return New V___StaffPersons(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___StaffPersons                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___StaffPersons                  
            Return New V___StaffPersons(Me.RawTable, V___StaffPersons.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___StaffPersons,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___StaffPersons,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___StaffPersons                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___StaffPersons(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___StaffPersons(drst.CopyToDataTable(),                  
                    V___StaffPersons.TABLE_NAME)                  
                Return New V___StaffPersons()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___StaffPersons                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___StaffPersons(dr), pParams)                  
                Select dr                  
