...
Public Class V___ExpandedPersonsExtended
        Inherits  V___ExpandedPersons
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___ExpandedPersons) As V___ExpandedPersonsExtended                  
            If pVal Is Nothing Then Return New V___ExpandedPersonsExtended                  
            Return New V___ExpandedPersonsExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
