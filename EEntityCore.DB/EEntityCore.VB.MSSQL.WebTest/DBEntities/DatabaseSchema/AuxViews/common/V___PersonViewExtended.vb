...
Public Class V___PersonViewExtended
        Inherits  V___PersonView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___PersonView) As V___PersonViewExtended                  
            If pVal Is Nothing Then Return New V___PersonViewExtended                  
            Return New V___PersonViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
