...
Public Class V___StaffPersonsExtended
        Inherits  V___StaffPersons
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___StaffPersons) As V___StaffPersonsExtended                  
            If pVal Is Nothing Then Return New V___StaffPersonsExtended                  
            Return New V___StaffPersonsExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
