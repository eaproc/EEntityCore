...
Public Class V___PlannedEventIntervalViewExtended
        Inherits  V___PlannedEventIntervalView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___PlannedEventIntervalView) As V___PlannedEventIntervalViewExtended                  
            If pVal Is Nothing Then Return New V___PlannedEventIntervalViewExtended                  
            Return New V___PlannedEventIntervalViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
