...
Public Class V___PersonLoginPlus1Extended
        Inherits  V___PersonLoginPlus1
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___PersonLoginPlus1) As V___PersonLoginPlus1Extended                  
            If pVal Is Nothing Then Return New V___PersonLoginPlus1Extended                  
            Return New V___PersonLoginPlus1Extended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
