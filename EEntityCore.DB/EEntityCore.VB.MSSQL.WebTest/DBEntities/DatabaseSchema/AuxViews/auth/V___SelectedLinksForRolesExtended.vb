...
Public Class V___SelectedLinksForRolesExtended
        Inherits  V___SelectedLinksForRoles
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___SelectedLinksForRoles) As V___SelectedLinksForRolesExtended                  
            If pVal Is Nothing Then Return New V___SelectedLinksForRolesExtended                  
            Return New V___SelectedLinksForRolesExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
