...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defVerifiedMobileNumber = New DataColumnDefinition(TableColumnNames.VerifiedMobileNumber.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defVerifiedEmail = New DataColumnDefinition(TableColumnNames.VerifiedEmail.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.LoggedInUser"
       Public Const LoggedInUser__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Username], [PersonID], [RememberToken], [FirstName], [LastName], [VerifiedMobileNumber], [VerifiedEmail], [PictureFileName], [FullName] FROM LoggedInUser"
       Public Const LoggedInUser__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Username], [PersonID], [RememberToken], [FirstName], [LastName], [VerifiedMobileNumber], [VerifiedEmail], [PictureFileName], [FullName] FROM LoggedInUser"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defVerifiedMobileNumber As DataColumnDefinition
       Public Shared ReadOnly defVerifiedEmail As DataColumnDefinition
       ...
       Public ReadOnly Property [VerifiedMobileNumber] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.VerifiedMobileNumber.ToString()))
           End Get
       End Property


       Public ReadOnly Property [VerifiedEmail] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.VerifiedEmail.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___LoggedInUser                  
            If Me.hasRows() Then Return New V___LoggedInUser(Me.AllRows(0))                  
            Return New V___LoggedInUser()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___LoggedInUser                  
            Return New V___LoggedInUser(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___LoggedInUser                  
            Return New V___LoggedInUser(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___LoggedInUser                  
            Return New V___LoggedInUser(Me.RawTable, V___LoggedInUser.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___LoggedInUser,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___LoggedInUser,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___LoggedInUser                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___LoggedInUser(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___LoggedInUser(drst.CopyToDataTable(),                  
                    V___LoggedInUser.TABLE_NAME)                  
                Return New V___LoggedInUser()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___LoggedInUser                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___LoggedInUser(dr), pParams)                  
                Select dr                  
