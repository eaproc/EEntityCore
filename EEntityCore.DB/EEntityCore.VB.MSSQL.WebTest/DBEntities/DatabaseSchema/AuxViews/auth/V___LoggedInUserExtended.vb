...
Public Class V___LoggedInUserExtended
        Inherits  V___LoggedInUser
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___LoggedInUser) As V___LoggedInUserExtended                  
            If pVal Is Nothing Then Return New V___LoggedInUserExtended                  
            Return New V___LoggedInUserExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
