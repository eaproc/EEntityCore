...
Namespace EEntityCore.VB.MSSQL.WebTest.DBEntities.DatabaseSchema.AuxViews.auth

Public Class V___PersonLoginPlus1
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  defUsername = New DataColumnDefinition(TableColumnNames.Username.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defLastLoginTime = New DataColumnDefinition(TableColumnNames.LastLoginTime.ToString(), GetType(DateTime), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defSessionTimeoutMins = New DataColumnDefinition(TableColumnNames.SessionTimeoutMins.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defTimeSpentSecs = New DataColumnDefinition(TableColumnNames.TimeSpentSecs.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defSecondsLeft = New DataColumnDefinition(TableColumnNames.SecondsLeft.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defStatus = New DataColumnDefinition(TableColumnNames.Status.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defSessionID = New DataColumnDefinition(TableColumnNames.SessionID.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defActiveSessions = New DataColumnDefinition(TableColumnNames.ActiveSessions.ToString(), GetType(String), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defLoggedOutTime = New DataColumnDefinition(TableColumnNames.LoggedOutTime.ToString(), GetType(DateTime), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defSessionIDCreatedTime = New DataColumnDefinition(TableColumnNames.SessionIDCreatedTime.ToString(), GetType(DateTime), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defUserID = New DataColumnDefinition(TableColumnNames.UserID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.PersonLoginPlus1"
       Public Const PersonLoginPlus1__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [Username], [IdentificationNo], [FirstName], [LastName], [LastLoginTime], [SessionTimeoutMins], [LastActive], [TimeSpentSecs], [SecondsLeft], [Status], [SessionID], [IPAddress], [IsActive], [ActiveSessions], [LoggedOutTime], [SessionIDCreatedTime], [PersonID], [UserID] FROM PersonLoginPlus1"
       Public Const PersonLoginPlus1__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [Username], [IdentificationNo], [FirstName], [LastName], [LastLoginTime], [SessionTimeoutMins], [LastActive], [TimeSpentSecs], [SecondsLeft], [Status], [SessionID], [IPAddress], [IsActive], [ActiveSessions], [LoggedOutTime], [SessionIDCreatedTime], [PersonID], [UserID] FROM PersonLoginPlus1"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defLastLoginTime As DataColumnDefinition
       ...
       Public Shared ReadOnly defTimeSpentSecs As DataColumnDefinition
       Public Shared ReadOnly defSecondsLeft As DataColumnDefinition
       Public Shared ReadOnly defStatus As DataColumnDefinition
       ...
       Public Shared ReadOnly defActiveSessions As DataColumnDefinition
       Public Shared ReadOnly defLoggedOutTime As DataColumnDefinition
       Public Shared ReadOnly defSessionIDCreatedTime As DataColumnDefinition
       ...
       Public ReadOnly Property [LastLoginTime] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.LastLoginTime.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [TimeSpentSecs] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.TimeSpentSecs.ToString()))
           End Get
       End Property


       Public ReadOnly Property [SecondsLeft] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.SecondsLeft.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [Status] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.Status.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [ActiveSessions] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.ActiveSessions.ToString()))
           End Get
       End Property


       Public ReadOnly Property [LoggedOutTime] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.LoggedOutTime.ToString()))
           End Get
       End Property


       Public ReadOnly Property [SessionIDCreatedTime] As NullableDateTime
           Get
               If Not Me.isValidRow then Return New NullableDateTime(CDate(Nothing))                          
               Return  New NullableDateTime(Me.TargettedRow(TableColumnNames.SessionIDCreatedTime.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___PersonLoginPlus1                  
            If Me.hasRows() Then Return New V___PersonLoginPlus1(Me.AllRows(0))                  
            Return New V___PersonLoginPlus1()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___PersonLoginPlus1                  
            Return New V___PersonLoginPlus1(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___PersonLoginPlus1                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___PersonLoginPlus1                  
            Return New V___PersonLoginPlus1(Me.RawTable, V___PersonLoginPlus1.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___PersonLoginPlus1,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___PersonLoginPlus1,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___PersonLoginPlus1                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___PersonLoginPlus1(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___PersonLoginPlus1(drst.CopyToDataTable(),                  
                    V___PersonLoginPlus1.TABLE_NAME)                  
                Return New V___PersonLoginPlus1()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___PersonLoginPlus1                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___PersonLoginPlus1(dr), pParams)                  
                Select dr                  
