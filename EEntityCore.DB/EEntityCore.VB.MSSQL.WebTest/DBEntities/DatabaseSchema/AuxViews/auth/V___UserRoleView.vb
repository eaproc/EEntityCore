...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defRoleRank = New DataColumnDefinition(TableColumnNames.RoleRank.ToString(), GetType(Byte), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.UserRoleView"
       Public Const UserRoleView__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [RoleID], [UserID], [Role], [RoleRank] FROM UserRoleView"
       Public Const UserRoleView__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [RoleID], [UserID], [Role], [RoleRank] FROM UserRoleView"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defRoleRank As DataColumnDefinition
       ...
       Public ReadOnly Property [RoleRank] As Byte
           Get
               If Not Me.isValidRow then Return 0                          
               Return EShort.valueOf(Me.TargettedRow(TableColumnNames.RoleRank.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___UserRoleView                  
            If Me.hasRows() Then Return New V___UserRoleView(Me.AllRows(0))                  
            Return New V___UserRoleView()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___UserRoleView                  
            Return New V___UserRoleView(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___UserRoleView                  
            Return New V___UserRoleView(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___UserRoleView                  
            Return New V___UserRoleView(Me.RawTable, V___UserRoleView.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___UserRoleView,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___UserRoleView,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___UserRoleView                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___UserRoleView(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___UserRoleView(drst.CopyToDataTable(),                  
                    V___UserRoleView.TABLE_NAME)                  
                Return New V___UserRoleView()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___UserRoleView                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___UserRoleView(dr), pParams)                  
                Select dr                  
