...
Public Class V___UserPermittedLinkExtended
        Inherits  V___UserPermittedLink
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___UserPermittedLink) As V___UserPermittedLinkExtended                  
            If pVal Is Nothing Then Return New V___UserPermittedLinkExtended                  
            Return New V___UserPermittedLinkExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
