...
Public Class V___ActiveModules
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defDefinition = New DataColumnDefinition(TableColumnNames.Definition.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.ActiveModules"
       Public Const ActiveModules__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM ActiveModules"
       Public Const ActiveModules__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Definition] FROM ActiveModules"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___ActiveModules                  
            If Me.hasRows() Then Return New V___ActiveModules(Me.AllRows(0))                  
            Return New V___ActiveModules()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___ActiveModules                  
            Return New V___ActiveModules(Me.RawTable, V___ActiveModules.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___ActiveModules,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___ActiveModules,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___ActiveModules                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___ActiveModules(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___ActiveModules(drst.CopyToDataTable(),                  
                    V___ActiveModules.TABLE_NAME)                  
                Return New V___ActiveModules()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___ActiveModules                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___ActiveModules(dr), pParams)                  
                Select dr                  
