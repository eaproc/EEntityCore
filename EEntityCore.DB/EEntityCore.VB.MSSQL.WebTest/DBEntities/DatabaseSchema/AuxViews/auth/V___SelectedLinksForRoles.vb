...
Public Class V___SelectedLinksForRoles
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defAppModuleID = New DataColumnDefinition(TableColumnNames.AppModuleID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  ...
  defLinkParentID = New DataColumnDefinition(TableColumnNames.LinkParentID.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defOwnedByRoleID = New DataColumnDefinition(TableColumnNames.OwnedByRoleID.ToString(), GetType(Int32), True, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.SelectedLinksForRoles"
       Public Const SelectedLinksForRoles__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [AppModuleID], [Name], [Link], [LinkPermissionID], [LinkParentID], [OwnedByRoleID], [Description], [CreatedAt], [UpdatedAt], [RoleID] FROM SelectedLinksForRoles"
       Public Const SelectedLinksForRoles__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [AppModuleID], [Name], [Link], [LinkPermissionID], [LinkParentID], [OwnedByRoleID], [Description], [CreatedAt], [UpdatedAt], [RoleID] FROM SelectedLinksForRoles"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___SelectedLinksForRoles                  
            If Me.hasRows() Then Return New V___SelectedLinksForRoles(Me.AllRows(0))                  
            Return New V___SelectedLinksForRoles()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___SelectedLinksForRoles                  
            Return New V___SelectedLinksForRoles(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___SelectedLinksForRoles                  
            Return New V___SelectedLinksForRoles(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___SelectedLinksForRoles                  
            Return New V___SelectedLinksForRoles(Me.RawTable, V___SelectedLinksForRoles.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___SelectedLinksForRoles,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___SelectedLinksForRoles,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___SelectedLinksForRoles                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___SelectedLinksForRoles(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___SelectedLinksForRoles(drst.CopyToDataTable(),                  
                    V___SelectedLinksForRoles.TABLE_NAME)                  
                Return New V___SelectedLinksForRoles()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___SelectedLinksForRoles                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___SelectedLinksForRoles(dr), pParams)                  
                Select dr                  
