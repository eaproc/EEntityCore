...
Public Class V___ActiveModulesExtended
        Inherits  V___ActiveModules
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___ActiveModules) As V___ActiveModulesExtended                  
            If pVal Is Nothing Then Return New V___ActiveModulesExtended                  
            Return New V___ActiveModulesExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
