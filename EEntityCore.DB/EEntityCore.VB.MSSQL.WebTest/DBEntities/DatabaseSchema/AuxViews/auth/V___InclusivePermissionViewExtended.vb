...
Public Class V___InclusivePermissionViewExtended
        Inherits  V___InclusivePermissionView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___InclusivePermissionView) As V___InclusivePermissionViewExtended                  
            If pVal Is Nothing Then Return New V___InclusivePermissionViewExtended                  
            Return New V___InclusivePermissionViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
...
#Region "EDITABLE REGION"                  
        ...
        REM  -------- DO NOT DELETE THIS LINE NEXT TO EDIT REGION. IT ENDS MARKER #IMPORTANT LINE                  
#End Region                  
