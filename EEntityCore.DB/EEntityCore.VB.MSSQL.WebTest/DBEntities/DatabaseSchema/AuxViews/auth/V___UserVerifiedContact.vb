...
Public Class V___UserVerifiedContact
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.UserVerifiedContact"
       Public Const UserVerifiedContact__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Username], [PersonID], [FirstName], [LastName], [MobileNumber], [Email] FROM UserVerifiedContact"
       Public Const UserVerifiedContact__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Username], [PersonID], [FirstName], [LastName], [MobileNumber], [Email] FROM UserVerifiedContact"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___UserVerifiedContact                  
            If Me.hasRows() Then Return New V___UserVerifiedContact(Me.AllRows(0))                  
            Return New V___UserVerifiedContact()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___UserVerifiedContact                  
            Return New V___UserVerifiedContact(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___UserVerifiedContact                  
            Return New V___UserVerifiedContact(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___UserVerifiedContact                  
            Return New V___UserVerifiedContact(Me.RawTable, V___UserVerifiedContact.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___UserVerifiedContact,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___UserVerifiedContact,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___UserVerifiedContact                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___UserVerifiedContact(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___UserVerifiedContact(drst.CopyToDataTable(),                  
                    V___UserVerifiedContact.TABLE_NAME)                  
                Return New V___UserVerifiedContact()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___UserVerifiedContact                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___UserVerifiedContact(dr), pParams)                  
                Select dr                  
