...
Public Class V___UserLoginPlus1Extended
        Inherits  V___UserLoginPlus1
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___UserLoginPlus1) As V___UserLoginPlus1Extended                  
            If pVal Is Nothing Then Return New V___UserLoginPlus1Extended                  
            Return New V___UserLoginPlus1Extended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
