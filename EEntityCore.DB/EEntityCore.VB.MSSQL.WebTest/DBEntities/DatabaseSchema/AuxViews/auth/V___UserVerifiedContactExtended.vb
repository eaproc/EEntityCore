...
Public Class V___UserVerifiedContactExtended
        Inherits  V___UserVerifiedContact
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___UserVerifiedContact) As V___UserVerifiedContactExtended                  
            If pVal Is Nothing Then Return New V___UserVerifiedContactExtended                  
            Return New V___UserVerifiedContactExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
