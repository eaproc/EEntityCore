...
Public Class V___InclusivePermissionView
...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  ColumnDefns.Add(defInclusivePermissionDefinition.ColumnName, defInclusivePermissionDefinition) 
            ...
            ReferencedTableNames.Add("auth.LinkPermission")                  
            ReferencedTableNames.Add("auth.LinkPermissionMember")                  
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.InclusivePermissionView"
       Public Const InclusivePermissionView__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [Permission], [InclusivePermissionID], [InclusivePermissionDefinition] FROM InclusivePermissionView"
       Public Const InclusivePermissionView__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [Permission], [InclusivePermissionID], [InclusivePermissionDefinition] FROM InclusivePermissionView"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___InclusivePermissionView                  
            If Me.hasRows() Then Return New V___InclusivePermissionView(Me.AllRows(0))                  
            Return New V___InclusivePermissionView()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___InclusivePermissionView                  
            Return New V___InclusivePermissionView(DBConnectInterface.getDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___InclusivePermissionView                  
            Return New V___InclusivePermissionView(DBConnectInterface.getDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___InclusivePermissionView                  
            Return New V___InclusivePermissionView(Me.RawTable, V___InclusivePermissionView.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___InclusivePermissionView,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___InclusivePermissionView,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___InclusivePermissionView                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___InclusivePermissionView(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___InclusivePermissionView(drst.CopyToDataTable(),                  
                    V___InclusivePermissionView.TABLE_NAME)                  
                Return New V___InclusivePermissionView()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___InclusivePermissionView                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___InclusivePermissionView(dr), pParams)                  
                Select dr                  
