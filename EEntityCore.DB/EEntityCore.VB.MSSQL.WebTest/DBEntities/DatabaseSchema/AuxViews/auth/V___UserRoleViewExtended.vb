...
Public Class V___UserRoleViewExtended
        Inherits  V___UserRoleView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___UserRoleView) As V___UserRoleViewExtended                  
            If pVal Is Nothing Then Return New V___UserRoleViewExtended                  
            Return New V___UserRoleViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
