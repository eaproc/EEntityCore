...
Public Class V___RoleLinkViewExtended
        Inherits  V___RoleLinkView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___RoleLinkView) As V___RoleLinkViewExtended                  
            If pVal Is Nothing Then Return New V___RoleLinkViewExtended                  
            Return New V___RoleLinkViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
