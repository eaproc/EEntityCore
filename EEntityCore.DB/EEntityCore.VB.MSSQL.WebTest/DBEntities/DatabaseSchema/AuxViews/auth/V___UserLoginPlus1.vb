...
Public Class V___UserLoginPlus1
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.UserLoginPlus1"
       Public Const UserLoginPlus1__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [Username], [LastLoginTime], [LoggedOutTime], [IPAddress], [SessionID], [SessionIDCreatedTime], [SessionTimeoutMins], [LastActive], [ExpiryDate], [SecondsLeft], [ActiveSessions], [UserID], [PersonID], [IsActive] FROM UserLoginPlus1"
       Public Const UserLoginPlus1__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [Username], [LastLoginTime], [LoggedOutTime], [IPAddress], [SessionID], [SessionIDCreatedTime], [SessionTimeoutMins], [LastActive], [ExpiryDate], [SecondsLeft], [ActiveSessions], [UserID], [PersonID], [IsActive] FROM UserLoginPlus1"
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___UserLoginPlus1                  
            If Me.hasRows() Then Return New V___UserLoginPlus1(Me.AllRows(0))                  
            Return New V___UserLoginPlus1()                  
        End Function                  
        ...
        Public Function getRowWhereID(pID As Int32) As V___UserLoginPlus1                  
            Return New V___UserLoginPlus1(Me.RawTable, V___UserLoginPlus1.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___UserLoginPlus1,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___UserLoginPlus1,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___UserLoginPlus1                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___UserLoginPlus1(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___UserLoginPlus1(drst.CopyToDataTable(),                  
                    V___UserLoginPlus1.TABLE_NAME)                  
                Return New V___UserLoginPlus1()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___UserLoginPlus1                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___UserLoginPlus1(dr), pParams)                  
                Select dr                  
