...
ColumnDefns = New Dictionary(Of String, DataColumnDefinition)()
  ...
  defRoleID = New DataColumnDefinition(TableColumnNames.RoleID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defBaseLinkID = New DataColumnDefinition(TableColumnNames.BaseLinkID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defBaseLinkPermissionID = New DataColumnDefinition(TableColumnNames.BaseLinkPermissionID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defBaseLink = New DataColumnDefinition(TableColumnNames.BaseLink.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defPermission = New DataColumnDefinition(TableColumnNames.Permission.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defInclusivePermissionID = New DataColumnDefinition(TableColumnNames.InclusivePermissionID.ToString(), GetType(Int32), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
  defInclusivePermissionDefinition = New DataColumnDefinition(TableColumnNames.InclusivePermissionDefinition.ToString(), GetType(String), False, Nothing,DataColumnDefinition.ConstraintTypes.UNKNOWN) 
...
#Region "Consts and Enums"
       ...
       Public Const TABLE_NAME As String = "auth.RoleLinkView"
       Public Const RoleLinkView__NO__BINARY___SQL_FILL_QUERY As String = "SELECT [ID], [RoleID], [BaseLinkID], [BaseLinkPermissionID], [BaseLink], [Permission], [InclusivePermissionID], [InclusivePermissionDefinition] FROM RoleLinkView"
       Public Const RoleLinkView__ALL_COLUMNS___SQL_FILL_QUERY As String = "SELECT [ID], [RoleID], [BaseLinkID], [BaseLinkPermissionID], [BaseLink], [Permission], [InclusivePermissionID], [InclusivePermissionDefinition] FROM RoleLinkView"
...
#Region "Properties" 
       ...
       Public Shared ReadOnly defBaseLinkPermissionID As DataColumnDefinition
       Public Shared ReadOnly defBaseLink As DataColumnDefinition
       Public Shared ReadOnly defPermission As DataColumnDefinition
       Public Shared ReadOnly defInclusivePermissionID As DataColumnDefinition
       Public Shared ReadOnly defInclusivePermissionDefinition As DataColumnDefinition
       ...
       Public ReadOnly Property [BaseLinkPermissionID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.BaseLinkPermissionID.ToString()))
           End Get
       End Property


       Public ReadOnly Property [BaseLink] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.BaseLink.ToString()))
           End Get
       End Property
       ...
       Public ReadOnly Property [Permission] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.Permission.ToString()))
           End Get
       End Property


       Public ReadOnly Property [InclusivePermissionID] As Int32
           Get
               If Not Me.isValidRow then Return 0                          
               Return EInt.valueOf(Me.TargettedRow(TableColumnNames.InclusivePermissionID.ToString()))
           End Get
       End Property


       Public ReadOnly Property [InclusivePermissionDefinition] As String
           Get
               If Not Me.isValidRow then Return String.Empty                          
               Return EStrings.valueOf(Me.TargettedRow(TableColumnNames.InclusivePermissionDefinition.ToString()))
           End Get
       End Property
...
#Region "Methods"                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getFirstRow() As V___RoleLinkView                  
            If Me.hasRows() Then Return New V___RoleLinkView(Me.AllRows(0))                  
            Return New V___RoleLinkView()                  
        End Function                  
                  
                  
        Public Shared Function getFullTable() As V___RoleLinkView                  
            Return New V___RoleLinkView(DBConnectInterface.GetDBConn(), TABLE_NAME)                  
        End Function                  
                  
        Public Shared Function getRowWhereIDUsingSQL(ByVal pID As Int32) As V___RoleLinkView                  
            Return New V___RoleLinkView(DBConnectInterface.GetDBConn(),                  
                                               TABLE_NAME,                  
                                               String.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, pID)                  
                                               ).getFirstRow()                  
        End Function                  
                  
        Public Function getRowWhereID(pID As Int32) As V___RoleLinkView                  
            Return New V___RoleLinkView(Me.RawTable, V___RoleLinkView.TABLE_NAME, pID)                  
        End Function                  
                  
                  
        Private Function IsAllRowEqual(ByVal pRow As V___RoleLinkView,                  
        ...
        Private Function IsAnyRowEqual(ByVal pRow As V___RoleLinkView,                  
                                            ParamArray pParams() As DataColumnParameter                  
                                            ) As Boolean                  
            Try                  
                If Not Me.hasRows() Then Return False                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsEquals(ParamArray pParams() As DataColumnParameter) As V___RoleLinkView                  
            ...
            Try                  
                ...
                Where Me.IsAllRowEqual(New V___RoleLinkView(dr), pParams)                  
                Select dr                  
                  
                  
                If drst IsNot Nothing AndAlso drst.Count() > 0 Then Return New V___RoleLinkView(drst.CopyToDataTable(),                  
                    V___RoleLinkView.TABLE_NAME)                  
                Return New V___RoleLinkView()                  
            Catch ex As Exception                  
                Logger.Print(ex)                  
        ...
        ''' <returns></returns>                                     
        ''' <remarks></remarks>                                     
        Public Function getAllRowsAny(ParamArray pParams() As DataColumnParameter) As V___RoleLinkView                  
            If pParams Is Nothing OrElse pParams.Count = 0 OrElse Not Me.hasRows() Then Return Me                  
            Try                  
                  
                Dim drst As IEnumerable(Of DataRow) = From dr As DataRow In Me.AllRows                  
                Where Me.IsAnyRowEqual(New V___RoleLinkView(dr), pParams)                  
                Select dr                  
