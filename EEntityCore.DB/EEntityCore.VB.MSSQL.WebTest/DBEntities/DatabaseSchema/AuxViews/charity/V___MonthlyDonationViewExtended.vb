...
Public Class V___MonthlyDonationViewExtended
        Inherits  V___MonthlyDonationView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___MonthlyDonationView) As V___MonthlyDonationViewExtended                  
            If pVal Is Nothing Then Return New V___MonthlyDonationViewExtended                  
            Return New V___MonthlyDonationViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
