...
Public Class V___CenterViewExtended
        Inherits  V___CenterView
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___CenterView) As V___CenterViewExtended                  
            If pVal Is Nothing Then Return New V___CenterViewExtended                  
            Return New V___CenterViewExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
