...
Public Class V___DonationInvoiceBeneficiaryExtended
        Inherits  V___DonationInvoiceBeneficiary
...
#Region "Methods" 
        ...
        Public Shared Function Convert(pVal As V___DonationInvoiceBeneficiary) As V___DonationInvoiceBeneficiaryExtended                  
            If pVal Is Nothing Then Return New V___DonationInvoiceBeneficiaryExtended                  
            Return New V___DonationInvoiceBeneficiaryExtended(pVal.RawTable, pVal.TableName, pVal.ID)                  
        End Function                  
