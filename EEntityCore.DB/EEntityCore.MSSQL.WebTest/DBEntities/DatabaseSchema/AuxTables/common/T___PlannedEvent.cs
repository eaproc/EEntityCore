...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___PlannedEvent GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___PlannedEvent(conn.Fetch(PlannedEvent__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___PlannedEvent GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___PlannedEvent( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
