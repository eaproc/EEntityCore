...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___IdentificationViability(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___IdentificationViability(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string IdentificationViability__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Definition], [CreatedAt] FROM common.IdentificationViability";
       public const string IdentificationViability__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Definition], [CreatedAt] FROM common.IdentificationViability";
 ...
 #region Methods                                                      
        ...
        public static T___IdentificationViability GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___IdentificationViability(conn.Fetch(IdentificationViability__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___IdentificationViability GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___IdentificationViability( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___IdentificationViability GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___IdentificationViability v):this(v.ID)                  
            {                  
