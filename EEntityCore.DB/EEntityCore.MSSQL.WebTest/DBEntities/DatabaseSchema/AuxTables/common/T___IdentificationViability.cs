...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___IdentificationViability GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
        ...
        public T___IdentificationViability GetRowWhereID(int pID) => new(this.RawTable, pID);                                                      
