...
{                  
 ...
 #region Methods                                    
        ...
        public static T___IdentificationViability GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___IdentificationViability GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___IdentificationViability(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
