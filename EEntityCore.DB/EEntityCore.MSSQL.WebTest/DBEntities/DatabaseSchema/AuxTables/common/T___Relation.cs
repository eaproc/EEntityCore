...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___Relation(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___Relation(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___Relation GetRowWhereID(int pID)                  
        {                  
            return new T___Relation(this.RawTable, pID);                  
        }                  
