...
{                  
 ...
 #region Methods                                    
        ...
        public static T___RelationshipType GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___RelationshipType GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___RelationshipType(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
