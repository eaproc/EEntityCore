...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___RelationshipType(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___RelationshipType(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___RelationshipType GetRowWhereID(int pID)                  
        {                  
            return new T___RelationshipType(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___RelationshipType(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
