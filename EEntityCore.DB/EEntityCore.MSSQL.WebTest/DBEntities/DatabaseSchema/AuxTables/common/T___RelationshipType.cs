...
{                  
    ...
    public class T___RelationshipType : SimpleTablePlugIn, IDataColumnDefinitionsHolder, IDBTableDefinitionPlugIn                  
    {                  
 ...
 #region Constructors                  
       ...
       public T___RelationshipType() : base()                  
        {                  
        }                  
   ...
   #region Full Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___RelationshipType(All__DBs DBConn) : base(DBConn)                                    
        {                                    
        }                                    
        ...
        /// <remarks></remarks>                                    
        public T___RelationshipType(All__DBs DBConn, long pTargettedRowID) : base(DBConn,  pTargettedRowID: pTargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <remarks></remarks>                                    
        public T___RelationshipType(All__DBs pDBConn, string pSQL) : base(pDBConn,  pSQL)                                    
        {                                    
        }                                    
        ...
        /// <param name="pSQL">Load table with your own SQL</param>                                                      
        /// <remarks></remarks>                                    
        public T___RelationshipType(All__DBs pDBConn,  string pSQL, long pTargettedRowID) : base(pDBConn, pSQL, pTargettedRowID)                                    
        {                                    
        }                                    
   ...
   #region Partial Access                                    
        ...
        /// <param name="pTargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___RelationshipType(DataRowCollection pTableRows, long pTargettedRowID) : base(pTableRows, pTargettedRowID)                                    
        {                                    
        }                  
        ...
        /// <remarks></remarks>                                    
        public T___RelationshipType(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___RelationshipType(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string RelationshipType__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Definition], [CreatedAt] FROM common.RelationshipType";
       public const string RelationshipType__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Definition], [CreatedAt] FROM common.RelationshipType";
 ...
 #region Methods                                                      
        ...
        public static T___RelationshipType GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___RelationshipType(conn.Fetch(RelationshipType__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___RelationshipType GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___RelationshipType( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___RelationshipType GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
                                                      
        public Dictionary<string, DataColumnDefinition> GetDefinitions() => ColumnDefns;                                             
                                            
                                    
                  
        public virtual string GetFillSQL() => RelationshipType__NO__BINARY___SQL_FILL_QUERY;
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___RelationshipType v):this(v.ID)                  
            {                  
