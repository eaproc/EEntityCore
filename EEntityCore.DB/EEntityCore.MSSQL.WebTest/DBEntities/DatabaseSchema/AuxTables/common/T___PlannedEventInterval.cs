...
{                  
    ...
    public class T___PlannedEventInterval : Sample__Table, IDataColumnDefinitionsHolder, IDBTableDefinitionPlugIn                  
    {                  
...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___PlannedEventInterval(this.AllRows.First());                  
            return null;                  
        }                  
                  
        public static T___PlannedEventInterval GetFullTable()                  
        {                  
        ...
        {                  
            return new T___PlannedEventInterval(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___PlannedEventInterval GetRowWhereID(int pID)                  
        {                  
            return new T___PlannedEventInterval(this.RawTable, pID);                  
        }                  
                  
        private bool IsAllRowEqual(T___PlannedEventInterval pRow, params DataColumnParameter[] pParams)                  
        {                  
            try                  
            {                  
                if (!this.HasRows())                  
        ...
        private bool IsAnyRowEqual(T___PlannedEventInterval pRow, params DataColumnParameter[] pParams)                  
        {                  
            try                  
            {                  
                if (!this.HasRows())                  
        ...
        /// <returns></returns>                                                       
        /// <remarks></remarks>                  
        public T___PlannedEventInterval GetAllRowsEquals(params DataColumnParameter[] pParams)                  
        {                  
            ...
            {                  
                IEnumerable<DataRow> drst = from dr in this.AllRows                  
                                            where IsAllRowEqual(new T___PlannedEventInterval(dr), pParams)                  
                                            select dr;                  
                if (drst is object && drst.Count() > 0)                  
                    return new T___PlannedEventInterval(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
        ...
        /// <returns></returns>                                                       
        /// <remarks></remarks>                  
        public T___PlannedEventInterval getAllRowsAny(params DataColumnParameter[] pParams)                  
        {                  
            if (pParams is null || pParams.Count() == 0 || !this.HasRows())                  
                return this;                  
            try                  
            {                  
                IEnumerable<DataRow> drst = from dr in this.AllRows                  
                                            where IsAnyRowEqual(new T___PlannedEventInterval(dr), pParams)                  
                                            select dr;                  
                if (drst is object && drst.Count() > 0)                  
                    return new T___PlannedEventInterval(drst);                  
                return null;                  
