...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___PlannedEventInterval GetFullTable(DBTransaction transaction = null) =>                   
            TransactionRunner.InvokeRun( (conn) =>                  
                new T___PlannedEventInterval(conn.Fetch(PlannedEventInterval__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable(), DO__NOT____TARGET__ANY_ROWID),                  
                transaction                  
                );                                                      
        ...
        {                  
            return TransactionRunner.InvokeRun(                  
                (conn) =>                   
                new T___PlannedEventInterval( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID ),                  
                transaction                  
                );                  
        }                                                                        
