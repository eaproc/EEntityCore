...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___Person(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___Person(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___Person GetRowWhereID(int pID)                  
        {                  
            return new T___Person(this.RawTable, pID);                  
        }                  
