...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___PersonPhone(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___PersonPhone(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___PersonPhone GetRowWhereID(int pID)                  
        {                  
            return new T___PersonPhone(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___PersonPhone(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
