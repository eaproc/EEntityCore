...
{                  
 ...
 #region Constructors                  
       ...
       static T___PersonPhone()                  
        {                  
          ...
          defPhoneTypeID = new DataColumnDefinition(TableColumnNames.PhoneTypeID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.UNIQUE);
          defPhoneNumber = new DataColumnDefinition(TableColumnNames.PhoneNumber.ToString(), typeof(string),false, DataColumnDefinition.ConstraintTypes.UNKNOWN);
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___PersonPhone(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___PersonPhone(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string PersonPhone__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [PersonID], [PhoneTypeID], [PhoneNumber], [CreatedAt] FROM common.PersonPhone";
       public const string PersonPhone__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [PersonID], [PhoneTypeID], [PhoneNumber], [CreatedAt] FROM common.PersonPhone";
 ...
 #region Properties 
       ...
       public int PhoneTypeID { get => (int)TargettedRow.GetDBValueConverted<int>(TableColumnNames.PhoneTypeID.ToString());  set => TargettedRow[TableColumnNames.PhoneTypeID.ToString()] = value; }


       public string PhoneNumber { get => (string)TargettedRow.GetDBValueConverted<string>(TableColumnNames.PhoneNumber.ToString());  set => TargettedRow[TableColumnNames.PhoneNumber.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public static T___PersonPhone GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___PersonPhone(conn.Fetch(PersonPhone__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___PersonPhone GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___PersonPhone( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___PersonPhone GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            private DataColumnParameter ParamPhoneTypeID;
            private DataColumnParameter ParamPhoneNumber;
            ...
            public UpdateQueryBuilder( T___PersonPhone v):this(v.ID)                  
            {                  

                ParamPersonID = new(defPersonID, v.PersonID);                  
                ParamPhoneTypeID = new(defPhoneTypeID, v.PhoneTypeID);                  
                ParamPhoneNumber = new(defPhoneNumber, v.PhoneNumber);                  
            ...
            public UpdateQueryBuilder SetPhoneTypeID(int v)                  
            {                  
                ParamPhoneTypeID = new(defPhoneTypeID, v);                  
                return this;                  
            }                  
                  
            public UpdateQueryBuilder SetPhoneNumber(string v)                  
            {                  
                ParamPhoneNumber = new(defPhoneNumber, v);                  
                return this;                  
            }                  
