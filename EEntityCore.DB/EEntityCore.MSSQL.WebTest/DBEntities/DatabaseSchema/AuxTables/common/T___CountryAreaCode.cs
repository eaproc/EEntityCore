...
{                  
 ...
 #region Constructors                  
       ...
       static T___CountryAreaCode()                  
        {                  
          ...
          defCountryID = new DataColumnDefinition(TableColumnNames.CountryID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.UNIQUE);
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___CountryAreaCode(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___CountryAreaCode(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string CountryAreaCode__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [CountryID], [Definition], [CreatedAt] FROM common.CountryAreaCode";
       public const string CountryAreaCode__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [CountryID], [Definition], [CreatedAt] FROM common.CountryAreaCode";
 ...
 #region Methods                                                      
        ...
        public static T___CountryAreaCode GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___CountryAreaCode(conn.Fetch(CountryAreaCode__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___CountryAreaCode GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___CountryAreaCode( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___CountryAreaCode GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___CountryAreaCode v):this(v.ID)                  
            {                  
