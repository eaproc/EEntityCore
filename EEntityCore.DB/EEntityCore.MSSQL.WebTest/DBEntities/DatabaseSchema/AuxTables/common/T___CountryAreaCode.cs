...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___CountryAreaCode(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___CountryAreaCode(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___CountryAreaCode GetRowWhereID(int pID)                  
        {                  
            return new T___CountryAreaCode(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___CountryAreaCode(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
