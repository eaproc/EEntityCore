...
{                  
 ...
 #region Constructors                  
       ...
       static T___PersonDocument()                  
        {                  
          ...
          defPersonDocumentTypeID = new DataColumnDefinition(TableColumnNames.PersonDocumentTypeID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.FOREIGN);
          defDocumentFileName = new DataColumnDefinition(TableColumnNames.DocumentFileName.ToString(), typeof(string),false, DataColumnDefinition.ConstraintTypes.UNIQUE);
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___PersonDocument(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string PersonDocument__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [PersonID], [PersonDocumentTypeID], [DocumentFileName], [CreatedAt] FROM common.PersonDocument";
       public const string PersonDocument__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [PersonID], [PersonDocumentTypeID], [DocumentFileName], [CreatedAt] FROM common.PersonDocument";
 ...
 #region Properties 
       ...
       public int PersonDocumentTypeID { get => (int)TargettedRow.GetDBValueConverted<int>(TableColumnNames.PersonDocumentTypeID.ToString());  set => TargettedRow[TableColumnNames.PersonDocumentTypeID.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public static T___PersonDocument GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___PersonDocument(conn.Fetch(PersonDocument__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___PersonDocument GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___PersonDocument( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___PersonDocument GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            private DataColumnParameter ParamPersonDocumentTypeID;
            ...
            public UpdateQueryBuilder( T___PersonDocument v):this(v.ID)                  
            {                  

                ParamPersonID = new(defPersonID, v.PersonID);                  
                ParamPersonDocumentTypeID = new(defPersonDocumentTypeID, v.PersonDocumentTypeID);                  
            ...
            public UpdateQueryBuilder SetPersonDocumentTypeID(int v)                  
            {                  
                ParamPersonDocumentTypeID = new(defPersonDocumentTypeID, v);                  
                return this;                  
            }                  
...
,            DateTime CreatedAt
            ...
            {                   
                    ...
                    string.Format(" INSERT INTO {0}([PersonID],[PersonDocumentTypeID],[DocumentFileName],[CreatedAt]) VALUES({1},{2},{3},{4})  ", TABLE_NAME,
                        ...
                        paramPersonDocumentTypeID.GetSQLValue(),
...
,            DateTime CreatedAt
            ...
            return r.Run( (conn) =>                   
                      conn.ExecuteTransactionQuery(                  
                    string.Format(" SET IDENTITY_INSERT {0} ON INSERT INTO {0}([ID],[PersonID],[PersonDocumentTypeID],[DocumentFileName],[CreatedAt]) VALUES({1},{2},{3},{4},{5})  SET IDENTITY_INSERT {0} OFF ", TABLE_NAME,
                        paramID.GetSQLValue(),
                        paramPersonID.GetSQLValue(),
                        paramPersonDocumentTypeID.GetSQLValue(),
                        paramDocumentFileName.GetSQLValue(),
