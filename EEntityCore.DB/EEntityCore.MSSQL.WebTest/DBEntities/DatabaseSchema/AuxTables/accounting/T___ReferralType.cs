...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___ReferralType(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___ReferralType(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___ReferralType GetRowWhereID(int pID)                  
        {                  
            return new T___ReferralType(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___ReferralType(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
