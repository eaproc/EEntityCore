...
{                  
 ...
 #region Constructors                  
       ...
       static T___ReferralType()                  
        {                  
          ...
          defDefaultPercentage = new DataColumnDefinition(TableColumnNames.DefaultPercentage.ToString(), typeof(decimal),false, DataColumnDefinition.ConstraintTypes.UNKNOWN);
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___ReferralType(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___ReferralType(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string ReferralType__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Definition], [Description], [IsActive], [CreatedAt], [DefaultPercentage] FROM accounting.ReferralType";
       public const string ReferralType__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Definition], [Description], [IsActive], [CreatedAt], [DefaultPercentage] FROM accounting.ReferralType";
 ...
 #region Properties 
       ...
       public decimal DefaultPercentage { get => (decimal)TargettedRow.GetDBValueConverted<decimal>(TableColumnNames.DefaultPercentage.ToString());  set => TargettedRow[TableColumnNames.DefaultPercentage.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public static T___ReferralType GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___ReferralType(conn.Fetch(ReferralType__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___ReferralType GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___ReferralType( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___ReferralType GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            private DataColumnParameter ParamDefaultPercentage;
            ...
            public UpdateQueryBuilder( T___ReferralType v):this(v.ID)                  
            {                  
                ...
                ParamDefaultPercentage = new(defDefaultPercentage, v.DefaultPercentage);                  
            }                  
            ...
            public UpdateQueryBuilder SetDefaultPercentage(decimal v)                  
            {                  
                ParamDefaultPercentage = new(defDefaultPercentage, v);                  
                return this;                  
            }                  
...
,            string Description = null
                ...
                DataColumnParameter paramDefaultPercentage = new (defDefaultPercentage, DefaultPercentage);
