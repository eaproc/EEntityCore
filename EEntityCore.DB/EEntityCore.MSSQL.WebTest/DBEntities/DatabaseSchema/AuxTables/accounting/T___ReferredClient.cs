...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___ReferredClient(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___ReferredClient(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___ReferredClient GetRowWhereID(int pID)                  
        {                  
            return new T___ReferredClient(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___ReferredClient(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
