...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___Expenditure(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___Expenditure(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___Expenditure GetRowWhereID(int pID)                  
        {                  
            return new T___Expenditure(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___Expenditure(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
