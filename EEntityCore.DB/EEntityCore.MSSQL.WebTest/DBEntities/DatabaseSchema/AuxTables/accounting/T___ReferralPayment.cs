...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___ReferralPayment(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___ReferralPayment(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___ReferralPayment GetRowWhereID(int pID)                  
        {                  
            return new T___ReferralPayment(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___ReferralPayment(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
