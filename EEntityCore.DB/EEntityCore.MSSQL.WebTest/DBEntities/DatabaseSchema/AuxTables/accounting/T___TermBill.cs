...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___TermBill GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___TermBill(conn.Fetch(TermBill__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___TermBill GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___TermBill( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
