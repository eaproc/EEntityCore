...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___PaymentEntryMode(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___PaymentEntryMode(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string PaymentEntryMode__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Description], [CreatedAt] FROM accounting.PaymentEntryMode";
       public const string PaymentEntryMode__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Description], [CreatedAt] FROM accounting.PaymentEntryMode";
 ...
 #region Methods                                                      
        ...
        public static T___PaymentEntryMode GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___PaymentEntryMode(conn.Fetch(PaymentEntryMode__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___PaymentEntryMode GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___PaymentEntryMode( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___PaymentEntryMode GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___PaymentEntryMode v):this(v.ID)                  
            {                  
