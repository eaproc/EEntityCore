...
{                  
 ...
 #region Methods                                    
        ...
        public static T___PaymentEntryMode GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___PaymentEntryMode GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___PaymentEntryMode(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
