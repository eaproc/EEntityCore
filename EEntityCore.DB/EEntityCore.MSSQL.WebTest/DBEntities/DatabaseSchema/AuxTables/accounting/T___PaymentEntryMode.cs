...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___PaymentEntryMode GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
        ...
        public T___PaymentEntryMode GetRowWhereID(int pID) => new(this.RawTable, pID);                                                      
