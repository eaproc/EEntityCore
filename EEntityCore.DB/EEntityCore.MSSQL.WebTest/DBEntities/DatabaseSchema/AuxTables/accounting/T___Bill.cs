...
{                  
 ...
 #region Constructors                  
       ...
       static T___Bill()                  
        {                  
          ...
          defIsFixed = new DataColumnDefinition(TableColumnNames.IsFixed.ToString(), typeof(bool),false, DataColumnDefinition.ConstraintTypes.UNKNOWN);
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___Bill(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___Bill(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string Bill__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Definition], [Description], [CreatedAt], [IsFixed] FROM accounting.Bill";
       public const string Bill__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Definition], [Description], [CreatedAt], [IsFixed] FROM accounting.Bill";
 ...
 #region Properties 
       ...
       public bool IsFixed { get => (bool)TargettedRow.GetDBValueConverted<bool>(TableColumnNames.IsFixed.ToString());  set => TargettedRow[TableColumnNames.IsFixed.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public T___Bill GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            private DataColumnParameter ParamIsFixed;
            ...
            public UpdateQueryBuilder SetIsFixed(bool v)                  
            {                  
                ParamIsFixed = new(defIsFixed, v);                  
                return this;                  
            }                  
