...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___DealerWithdrawal GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___DealerWithdrawal(conn.Fetch(DealerWithdrawal__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___DealerWithdrawal GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___DealerWithdrawal( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
