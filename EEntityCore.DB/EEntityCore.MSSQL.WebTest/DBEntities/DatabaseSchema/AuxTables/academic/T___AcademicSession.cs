...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___AcademicSession(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___AcademicSession(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string AcademicSession__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Name], [Description], [StartDate], [EndDate], [CreatedAt], [UpdatedAt] FROM academic.AcademicSession";
       public const string AcademicSession__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Name], [Description], [StartDate], [EndDate], [CreatedAt], [UpdatedAt] FROM academic.AcademicSession";
 ...
 #region Methods                                                      
        ...
        public static T___AcademicSession GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___AcademicSession(conn.Fetch(AcademicSession__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___AcademicSession GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___AcademicSession( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___AcademicSession GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___AcademicSession v):this(v.ID)                  
            {                  
...
,            DateTime? UpdatedAt = null
            ...
            {                   
                    ...
                    string.Format(" INSERT INTO {0}([Name],[Description],[StartDate],[EndDate],[CreatedAt],[UpdatedAt]) VALUES({1},{2},{3},{4},{5},{6})  ", TABLE_NAME,
