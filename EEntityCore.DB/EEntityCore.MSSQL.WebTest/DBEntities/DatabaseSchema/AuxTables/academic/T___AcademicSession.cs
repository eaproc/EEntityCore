...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___AcademicSession(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___AcademicSession(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___AcademicSession GetRowWhereID(int pID)                  
        {                  
            return new T___AcademicSession(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___AcademicSession(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
