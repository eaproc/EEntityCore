...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___Cronjob(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___Cronjob(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___Cronjob GetRowWhereID(int pID)                  
        {                  
            return new T___Cronjob(this.RawTable, pID);                  
        }                  
