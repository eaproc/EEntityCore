 ...
 #region Constructors                  
       ...
       static T___Cronjob()                  
        {                  
          ...
          defIntervalID = new DataColumnDefinition(new DatabaseInit(),TableColumnNames.IntervalID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.FOREIGN);
