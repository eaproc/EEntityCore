...
{                  
 ...
 #region Properties 
       ...
       public int IntervalID { get => (int)TargettedRow[TableColumnNames.IntervalID.ToString()];  set => TargettedRow[TableColumnNames.IntervalID.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public static T___Cronjob GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
