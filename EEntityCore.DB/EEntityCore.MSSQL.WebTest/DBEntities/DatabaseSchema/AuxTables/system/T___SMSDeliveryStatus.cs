...
{                  
 ...
 #region Methods                                    
        ...
        public static T___SMSDeliveryStatus GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___SMSDeliveryStatus GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___SMSDeliveryStatus(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
