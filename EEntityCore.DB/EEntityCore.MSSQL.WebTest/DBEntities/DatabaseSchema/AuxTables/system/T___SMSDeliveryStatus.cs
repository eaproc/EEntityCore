...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___SMSDeliveryStatus(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
 ...
 #region Methods                                                      
        ...
        public static T___SMSDeliveryStatus GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___SMSDeliveryStatus(conn.Fetch(SMSDeliveryStatus__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___SMSDeliveryStatus GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___SMSDeliveryStatus( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___SMSDeliveryStatus GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___SMSDeliveryStatus v):this(v.ID)                  
            {                  
