...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___SMSDeliveryStatus(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___SMSDeliveryStatus(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___SMSDeliveryStatus GetRowWhereID(int pID)                  
        {                  
            return new T___SMSDeliveryStatus(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___SMSDeliveryStatus(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
