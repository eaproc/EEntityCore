...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___ArtisanLogTable(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___ArtisanLogTable(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___ArtisanLogTable GetRowWhereID(int pID)                  
        {                  
            return new T___ArtisanLogTable(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___ArtisanLogTable(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
        ...
        public static int AddWithID(Object pComments = null){
...
paramComments.GetSQLQuotedValueForAdd()  ), true);
        ...
        public static int  AddWithParseID(Int32 pParseID ,Object pComments = null){
...
/// <returns>Boolean</returns> /// <remarks></remarks> 
        public static bool Add(Object pComments= null){
