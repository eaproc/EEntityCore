...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___ArtisanLogTable(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___ArtisanLogTable(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Methods                                                      
        ...
        public static T___ArtisanLogTable GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___ArtisanLogTable(conn.Fetch(ArtisanLogTable__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___ArtisanLogTable GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___ArtisanLogTable( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___ArtisanLogTable GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___ArtisanLogTable v):this(v.ID)                  
            {                  
