 ...
 #region Methods                                                      
        ...
        public static T___SMSUnitStock GetFullTable(DBTransaction transaction = null) =>                   
            TransactionRunner.InvokeRun( (conn) =>                  
                new T___SMSUnitStock(conn.Fetch(SMSUnitStock__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable(), DO__NOT____TARGET__ANY_ROWID),                  
                transaction                  
                );                                                      
                                                      
        public static T___SMSUnitStock GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
