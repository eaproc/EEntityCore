...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___SMSUnitStock(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___SMSUnitStock(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___SMSUnitStock GetRowWhereID(int pID)                  
        {                  
            return new T___SMSUnitStock(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___SMSUnitStock(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
