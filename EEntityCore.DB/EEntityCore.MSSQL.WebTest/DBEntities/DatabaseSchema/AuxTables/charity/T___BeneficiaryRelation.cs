...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___BeneficiaryRelation(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___BeneficiaryRelation(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___BeneficiaryRelation GetRowWhereID(int pID)                  
        {                  
            return new T___BeneficiaryRelation(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___BeneficiaryRelation(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
