...
{                  
 ...
 #region Methods                                    
        ...
        public static T___BeneficiaryStatus GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___BeneficiaryStatus GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___BeneficiaryStatus(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
