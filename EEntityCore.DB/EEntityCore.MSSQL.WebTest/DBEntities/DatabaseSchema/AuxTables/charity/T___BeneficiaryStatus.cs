...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___BeneficiaryStatus(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
 ...
 #region Methods                                                      
        ...
        public static T___BeneficiaryStatus GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___BeneficiaryStatus(conn.Fetch(BeneficiaryStatus__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___BeneficiaryStatus GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___BeneficiaryStatus( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___BeneficiaryStatus GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___BeneficiaryStatus v):this(v.ID)                  
            {                  
