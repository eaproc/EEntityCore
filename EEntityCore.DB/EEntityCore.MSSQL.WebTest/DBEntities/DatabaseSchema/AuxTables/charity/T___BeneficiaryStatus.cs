...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___BeneficiaryStatus(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___BeneficiaryStatus(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___BeneficiaryStatus GetRowWhereID(int pID)                  
        {                  
            return new T___BeneficiaryStatus(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___BeneficiaryStatus(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
