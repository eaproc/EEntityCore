...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___AttendeeDetail GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___AttendeeDetail(conn.Fetch(AttendeeDetail__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___AttendeeDetail GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___AttendeeDetail( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
