...
{                  
 ...
 #region Constructors                  
       ...
       static T___CashIn()                  
        {                  
          ...
          defCashInTypeID = new DataColumnDefinition(new DatabaseInit(),TableColumnNames.CashInTypeID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.FOREIGN);
 ...
 #region Methods                                    
        ...
        public static T___CashIn GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___CashIn GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___CashIn(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
