...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___CashIn(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___CashIn(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Properties 
       ...
       public int CashInTypeID { get => (int)TargettedRow.GetDBValueConverted<int>(TableColumnNames.CashInTypeID.ToString());  set => TargettedRow[TableColumnNames.CashInTypeID.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public static T___CashIn GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___CashIn(conn.Fetch(CashIn__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___CashIn GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___CashIn( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___CashIn GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            private DataColumnParameter ParamCashInTypeID;
            ...
            public UpdateQueryBuilder( T___CashIn v):this(v.ID)                  
            {                  

                ParamCashInTypeID = new(defCashInTypeID, v.CashInTypeID);                  
            ...
            public UpdateQueryBuilder SetCashInTypeID(int v)                  
            {                  
                ParamCashInTypeID = new(defCashInTypeID, v);                  
                return this;                  
            }                  
