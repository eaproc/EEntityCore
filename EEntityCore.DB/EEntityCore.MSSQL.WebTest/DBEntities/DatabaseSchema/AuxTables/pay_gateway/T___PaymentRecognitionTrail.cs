...
{                  
 ...
 #region Properties 
       ...
       public string Trail { get => (string)TargettedRow[TableColumnNames.Trail.ToString()]; }


       public DateTime CreatedAt { get => (DateTime)TargettedRow[TableColumnNames.CreatedAt.ToString()]; }


       public int AlertTransactionID { get => (int)TargettedRow[TableColumnNames.AlertTransactionID.ToString()]; }
 ...
 #region Methods                                                      
        ...
        public static T___PaymentRecognitionTrail GetFullTable(DBTransaction transaction = null) =>                   
            TransactionRunner.InvokeRun( (conn) =>                  
                new T___PaymentRecognitionTrail(conn.Fetch(PaymentRecognitionTrail__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable(), DO__NOT____TARGET__ANY_ROWID),                  
                transaction                  
                );                                                      
                                                      
        public static T___PaymentRecognitionTrail GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
            return TransactionRunner.InvokeRun(                  
                (conn) =>                   
                new T___PaymentRecognitionTrail( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID ),                  
                transaction                  
                );                  
        }                                                                        
