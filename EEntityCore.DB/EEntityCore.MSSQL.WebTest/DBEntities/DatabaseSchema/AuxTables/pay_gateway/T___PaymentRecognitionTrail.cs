...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___PaymentRecognitionTrail(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___PaymentRecognitionTrail(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___PaymentRecognitionTrail GetRowWhereID(int pID)                  
        {                  
            return new T___PaymentRecognitionTrail(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___PaymentRecognitionTrail(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
