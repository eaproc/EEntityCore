...
#region Constructors                  
       ...
       public T___TransactionStatus() : base()                  
        ...
        /// <remarks></remarks>                                    
        public T___TransactionStatus(DataTable FullTable, int TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___TransactionStatus(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___TransactionStatus(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___TransactionStatus GetRowWhereID(int pID)                  
        {                  
            return new T___TransactionStatus(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___TransactionStatus(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
