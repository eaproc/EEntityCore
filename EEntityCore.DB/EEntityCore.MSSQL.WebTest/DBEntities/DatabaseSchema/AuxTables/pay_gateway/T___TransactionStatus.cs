...
{                  
 ...
 #region Methods                                    
        ...
        public static T___TransactionStatus GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___TransactionStatus GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___TransactionStatus(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
                                                      
        public T___TransactionStatus GetRowWhereID(int pID) => new(this.RawTable, pID);                                    
