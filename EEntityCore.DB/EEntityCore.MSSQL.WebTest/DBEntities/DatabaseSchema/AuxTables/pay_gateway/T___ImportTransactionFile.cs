...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___ImportTransactionFile(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___ImportTransactionFile(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___ImportTransactionFile GetRowWhereID(int pID)                  
        {                  
            return new T___ImportTransactionFile(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___ImportTransactionFile(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
