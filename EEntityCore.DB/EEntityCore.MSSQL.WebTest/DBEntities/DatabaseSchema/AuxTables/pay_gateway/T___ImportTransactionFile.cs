 ...
 #region Constructors                  
       ...
       static T___ImportTransactionFile()                  
        {                  
          ...
          defFilePath = new DataColumnDefinition(new DatabaseInit(),TableColumnNames.FilePath.ToString(), typeof(string),false, DataColumnDefinition.ConstraintTypes.UNKNOWN);
