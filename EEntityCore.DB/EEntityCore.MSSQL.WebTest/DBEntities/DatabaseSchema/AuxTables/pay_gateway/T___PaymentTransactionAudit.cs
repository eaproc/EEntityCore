 ...
 #region Methods                                                      
        ...
        public static T___PaymentTransactionAudit GetFullTable(DBTransaction transaction = null) =>                   
            TransactionRunner.InvokeRun( (conn) =>                  
                new T___PaymentTransactionAudit(conn.Fetch(PaymentTransactionAudit__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable(), DO__NOT____TARGET__ANY_ROWID),                  
                transaction                  
                );                                                      
                                                      
        public static T___PaymentTransactionAudit GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
