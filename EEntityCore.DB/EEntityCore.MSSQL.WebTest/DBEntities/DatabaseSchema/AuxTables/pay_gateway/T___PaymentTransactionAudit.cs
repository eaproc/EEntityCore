...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___PaymentTransactionAudit GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___PaymentTransactionAudit(conn.Fetch(PaymentTransactionAudit__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___PaymentTransactionAudit GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___PaymentTransactionAudit( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
