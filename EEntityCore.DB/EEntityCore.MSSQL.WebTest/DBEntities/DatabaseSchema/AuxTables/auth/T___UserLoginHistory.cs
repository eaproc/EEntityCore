...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___UserLoginHistory(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___UserLoginHistory(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___UserLoginHistory GetRowWhereID(int pID)                  
        {                  
            return new T___UserLoginHistory(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new T___UserLoginHistory(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
