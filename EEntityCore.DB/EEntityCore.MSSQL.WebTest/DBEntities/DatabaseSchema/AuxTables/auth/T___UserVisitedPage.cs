...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___UserVisitedPage GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___UserVisitedPage(conn.Fetch(UserVisitedPage__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___UserVisitedPage GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___UserVisitedPage( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
