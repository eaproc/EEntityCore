...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public T___UserRole(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public T___UserRole(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string UserRole__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [UserID], [RoleID], [CreatedAt] FROM auth.UserRole";
       public const string UserRole__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [UserID], [RoleID], [CreatedAt] FROM auth.UserRole";
 ...
 #region Methods                                                      
        ...
        public static T___UserRole GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___UserRole(conn.Fetch(UserRole__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___UserRole GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___UserRole( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public T___UserRole GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
        ...
        {                  
            ...
            public UpdateQueryBuilder( T___UserRole v):this(v.ID)                  
            {                  
...
,            DateTime CreatedAt
            ...
            {                   
                    ...
                    string.Format(" INSERT INTO {0}([UserID],[RoleID],[CreatedAt]) VALUES({1},{2},{3})  ", TABLE_NAME,
...
,            DateTime CreatedAt
            ...
            return r.Run( (conn) =>                   
                      conn.ExecuteTransactionQuery(                  
                    string.Format(" SET IDENTITY_INSERT {0} ON INSERT INTO {0}([ID],[UserID],[RoleID],[CreatedAt]) VALUES({1},{2},{3},{4})  SET IDENTITY_INSERT {0} OFF ", TABLE_NAME,
                        paramID.GetSQLValue(),
                        paramUserID.GetSQLValue(),
                        paramRoleID.GetSQLValue(),
                        paramCreatedAt.GetSQLValue()                        )
