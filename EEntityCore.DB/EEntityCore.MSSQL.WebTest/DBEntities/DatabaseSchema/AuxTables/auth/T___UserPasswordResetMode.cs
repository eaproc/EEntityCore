...
{                  
 ...
 #region Constructors                  
       ...
       static T___UserPasswordResetMode()                  
        {                  
          ...
          defPasswordResetTypeID = new DataColumnDefinition(TableColumnNames.PasswordResetTypeID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.UNIQUE);
          defUserID = new DataColumnDefinition(TableColumnNames.UserID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.UNIQUE);
          defModeCarrier = new DataColumnDefinition(TableColumnNames.ModeCarrier.ToString(), typeof(string),false, DataColumnDefinition.ConstraintTypes.UNIQUE);
 ...
 #region Consts and Enums                       
       ...
       public const string UserPasswordResetMode__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [PasswordResetTypeID], [UserID], [ModeCarrier], [CreatedAt] FROM auth.UserPasswordResetMode";
       public const string UserPasswordResetMode__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [PasswordResetTypeID], [UserID], [ModeCarrier], [CreatedAt] FROM auth.UserPasswordResetMode";
 ...
 #region Methods                                                      
        ...
        public static T___UserPasswordResetMode GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___UserPasswordResetMode(conn.Fetch(UserPasswordResetMode__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___UserPasswordResetMode GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___UserPasswordResetMode( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
        ...
        {                  
            ...
            private DataColumnParameter ParamModeCarrier;
            ...
            public UpdateQueryBuilder SetModeCarrier(string v)                  
            {                  
                ParamModeCarrier = new(defModeCarrier, v);                  
                return this;                  
            }                  
