...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___UserNotification GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___UserNotification(conn.Fetch(UserNotification__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___UserNotification GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___UserNotification( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
