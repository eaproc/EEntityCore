...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new T___AppModule(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new T___AppModule(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public T___AppModule GetRowWhereID(int pID)                  
        {                  
            return new T___AppModule(this.RawTable, pID);                  
        }                  
