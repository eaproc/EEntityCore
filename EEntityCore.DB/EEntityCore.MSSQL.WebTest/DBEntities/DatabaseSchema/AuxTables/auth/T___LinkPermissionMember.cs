...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___LinkPermissionMember GetFullTable(DBTransaction transaction = null) =>                   
        ...
        {                  
            return TransactionRunner.InvokeRun(                  
                (conn) =>                   
                new T___LinkPermissionMember( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID ),                  
                transaction                  
                );                  
        }                                                                        
