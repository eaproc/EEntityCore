...
{                  
 ...
 #region Methods                                    
        ...
        public static T___PayrollPersonnel GetFullTable() => new(DBConnectInterface.GetDBConn());                                    
                                    
        public static T___PayrollPersonnel GetRowWhereIDUsingSQL(int pID)                                                      
        {                                                      
            return new T___PayrollPersonnel(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", pID, TABLE_NAME)).GetFirstRow();                                                      
        }                                                      
