...
{                  
 ...
 #region Methods                                                      
        ...
        public static T___PayrollPersonnel GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new T___PayrollPersonnel(conn.Fetch(PayrollPersonnel__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static T___PayrollPersonnel GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new T___PayrollPersonnel( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
