...
{                  
 ...
 #region Properties 
       ...
       public int QualificationID { get => (int)TargettedRow[TableColumnNames.QualificationID.ToString()];  set => TargettedRow[TableColumnNames.QualificationID.ToString()] = value; }
 ...
 #region Methods                                                      
        ...
        public static T___PersonnelQualification GetRowWhereIDUsingSQL(int pID, DBTransaction transaction = null)                                                                        
        {                  
