...
{                  
 ...
 #region Methods                                                      
        ...
        public static V___DealerView GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new V___DealerView(conn.Fetch(DealerView__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static V___DealerView GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new V___DealerView( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
