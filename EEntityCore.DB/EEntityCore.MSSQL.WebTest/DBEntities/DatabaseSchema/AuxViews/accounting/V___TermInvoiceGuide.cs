...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new V___TermInvoiceGuide(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new V___TermInvoiceGuide(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public V___TermInvoiceGuide GetRowWhereID(int pID)                  
        {                  
            return new V___TermInvoiceGuide(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new V___TermInvoiceGuide(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
