...
{                  
    ...
    public class V___DealersBalance : Sample__Table, IDataColumnDefinitionsHolder, IDBViewDefinitionPlugIn                  
    {                  
...
#region Constructors                  
       ...
       static V___DealersBalance()                  
        {                  
          ...
          defDealerID = new DataColumnDefinition(TableColumnNames.DealerID.ToString(), typeof(Int32),false, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
          defEarnedAmount = new DataColumnDefinition(TableColumnNames.EarnedAmount.ToString(), typeof(Decimal),true, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
          defPendingAmount = new DataColumnDefinition(TableColumnNames.PendingAmount.ToString(), typeof(Decimal),true, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
          defWithdrawnAmount = new DataColumnDefinition(TableColumnNames.WithdrawnAmount.ToString(), typeof(Decimal),true, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
        ...
        public V___DealersBalance() : base(TABLE_NAME)                  
        {                  
        }                  
        ...
        /// <remarks></remarks>                  
        public V___DealersBalance(All__DBs DBConn, string TableName) : base(DBConn, TableName)                  
        {                  
        }                  
        ...
        /// <remarks></remarks>                  
        public V___DealersBalance(All__DBs DBConn, string pTableName, long pTargettedRowID) : base(DBConn, pTableName, pTargettedRowID: pTargettedRowID)                  
        {                  
        }                  
        ...
        /// <remarks></remarks>                  
        public V___DealersBalance(All__DBs pDBConn, string pTableName, string pSQL) : base(pDBConn, pTableName, pSQL)                  
        {                  
        }                  
        ...
        /// <param name="pSQL">Load table with your own SQL</param>                                    
        /// <remarks></remarks>                  
        public V___DealersBalance(All__DBs pDBConn, string pTableName, string pSQL, long pTargettedRowID) : base(pDBConn, pTableName, pSQL, pTargettedRowID)                  
        {                  
        }                  
        ...
        /// <param name="pTargettedRowID"></param>                                    
        /// <remarks></remarks>                  
        public V___DealersBalance(DataRowCollection pTableRows, long pTargettedRowID, string pTableName, All__DBs pDBConn) : base(pTableRows, pTargettedRowID, pTableName, pDBConn)                  
        {                  
        }                  
        ...
        /// <param name="pTargettedRowID"></param>                                    
        /// <remarks></remarks>                  
        public V___DealersBalance(IEnumerable<DataRow> pTableRows, long pTargettedRowID, string pTableName, All__DBs pDBConn) : base(pTableRows, pTargettedRowID, pTableName, pDBConn)                  
        {                  
        }                  
        ...
        /// <remarks></remarks>                  
        public V___DealersBalance(DataTable FullTable, int TargettedRowID, string TableName, All__DBs DBConn) : base(FullTable, TargettedRowID, TableName, DBConn)                  
        {                  
        }                  
        ...
        /// <param name="pTableRows"></param>                                    
        /// <remarks>Assuming this Row has a Column Called ID and It will be assigned</remarks>                  
        public V___DealersBalance(IEnumerable<DataRow> pTableRows, long pTargettedRowID, string pTableName) : base(pTableRows, pTargettedRowID, pTableName)                  
        {                  
        }                  
        ...
        /// </summary>                                    
        /// <remarks></remarks>                  
        public V___DealersBalance(DataTable FullTable, string pTableName) : base(FullTable, pTableName)                  
        {                  
        }                  
        ...
        /// </summary>                                    
        /// <remarks></remarks>                  
        public V___DealersBalance(DataTable FullTable, string pTableName, long pTargettedRowID) : base(FullTable, pTableName, pTargettedRowID)                  
        {                  
        }                  
        ...
        /// </summary>                                    
        /// <remarks></remarks>                  
        public V___DealersBalance(DataRowCollection pDataRows, string pTableName) : base(pDataRows, pTableName)                  
        {                  
        }                  
        ...
        /// <param name="pTableRows"></param>                                    
        /// <remarks>Assuming this Row has a Column Called ID and It will be assigned</remarks>                  
        public V___DealersBalance(IEnumerable<DataRow> pTableRows, string pTableName) : base(pTableRows, pTableName)                  
        {                  
        }                  
        ...
        /// <remarks>Assuming this Row has a Column Called ID and It will be assigned</remarks>                  
        public V___DealersBalance(DataRow pTargettedRow, string pTableName) : base(pTargettedRow, pTableName)                  
        {                  
        }                  
...
#region Methods                  
        ...
        {                  
            if (this.hasRows())                  
                return new V___DealersBalance(this.AllRows.ToArray()[0]);                  
            return null;                  
        }                  
                  
        public static V___DealersBalance getFullTable()                  
        {                  
            return new V___DealersBalance(DatabaseInit.DBConnectInterface.GetDBConn(), TABLE_NAME);                  
        }                  
                  
        public static V___DealersBalance getRowWhereIDUsingSQL(int pID)                  
        {                  
            return new V___DealersBalance(DBConnectInterface.GetDBConn(), TABLE_NAME, string.Format("SELECT * FROM {0} WHERE ID={1}", TABLE_NAME, (object)pID)).getFirstRow();                  
        }                  
                  
        public V___DealersBalance getRowWhereID(int pID)                  
        {                  
            return new V___DealersBalance(this.RawTable, TABLE_NAME, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new V___DealersBalance(drst.CopyToDataTable(), TABLE_NAME);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
