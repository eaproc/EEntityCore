...
{                  
 ...
 #region Methods                                                      
        ...
        public static V___DealersBalance GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new V___DealersBalance(conn.Fetch(DealersBalance__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static V___DealersBalance GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new V___DealersBalance( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
