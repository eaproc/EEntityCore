...
#region Constructors                  
       ...
       static V___RoleLinkView()                  
        {                  
          ...
          defBaseLinkID = new DataColumnDefinition(new DatabaseInit(),TableColumnNames.BaseLinkID.ToString(), typeof(Int32),false, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
          defBaseLinkPermissionID = new DataColumnDefinition(new DatabaseInit(),TableColumnNames.BaseLinkPermissionID.ToString(), typeof(Int32),false, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
          defBaseLink = new DataColumnDefinition(new DatabaseInit(),TableColumnNames.BaseLink.ToString(), typeof(String),false, null,DataColumnDefinition.ConstraintTypes.UNKNOWN);
