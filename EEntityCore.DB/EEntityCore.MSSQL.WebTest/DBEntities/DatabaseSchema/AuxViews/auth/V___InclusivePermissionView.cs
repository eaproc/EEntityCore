...
{                  
 ...
 #region Constructors                  
   ...
   #region Partial Access                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public V___InclusivePermissionView(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Consts and Enums                       
       ...
       public const string InclusivePermissionView__NO__BINARY___SQL_FILL_QUERY = "SELECT [ID], [Permission], [InclusivePermissionID], [InclusivePermissionDefinition] FROM auth.InclusivePermissionView";
       public const string InclusivePermissionView__ALL_COLUMNS___SQL_FILL_QUERY = "SELECT [ID], [Permission], [InclusivePermissionID], [InclusivePermissionDefinition] FROM auth.InclusivePermissionView";
 ...
 #region Methods                                                      
        ...
        public static V___InclusivePermissionView GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new V___InclusivePermissionView(conn.Fetch(InclusivePermissionView__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static V___InclusivePermissionView GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new V___InclusivePermissionView( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
        ...
        public virtual string GetFillSQL() => InclusivePermissionView__NO__BINARY___SQL_FILL_QUERY;
