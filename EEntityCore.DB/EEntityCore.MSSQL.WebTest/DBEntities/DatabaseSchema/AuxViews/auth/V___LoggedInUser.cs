...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new V___LoggedInUser(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new V___LoggedInUser(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public V___LoggedInUser GetRowWhereID(int pID)                  
        {                  
            return new V___LoggedInUser(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new V___LoggedInUser(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
