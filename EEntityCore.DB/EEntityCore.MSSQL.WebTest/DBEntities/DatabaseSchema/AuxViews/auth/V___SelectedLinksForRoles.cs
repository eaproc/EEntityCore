...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new V___SelectedLinksForRoles(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new V___SelectedLinksForRoles(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public V___SelectedLinksForRoles GetRowWhereID(int pID)                  
        {                  
            return new V___SelectedLinksForRoles(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new V___SelectedLinksForRoles(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
