...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new V___ExpandedPersons(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new V___ExpandedPersons(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public V___ExpandedPersons GetRowWhereID(int pID)                  
        {                  
            return new V___ExpandedPersons(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new V___ExpandedPersons(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
