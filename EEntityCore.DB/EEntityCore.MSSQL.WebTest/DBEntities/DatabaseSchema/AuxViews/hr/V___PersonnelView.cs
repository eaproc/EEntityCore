...
{                  
 ...
 #region Constructors                  
       ...
       static V___PersonnelView()                  
        {                  
          ...
          defPositionID = new DataColumnDefinition(TableColumnNames.PositionID.ToString(), typeof(int),false, DataColumnDefinition.ConstraintTypes.UNKNOWN);
          defSalaryTypeID = new DataColumnDefinition(TableColumnNames.SalaryTypeID.ToString(), typeof(int?),true, DataColumnDefinition.ConstraintTypes.UNKNOWN);
          ...
          defUpdatedByID = new DataColumnDefinition(TableColumnNames.UpdatedByID.ToString(), typeof(int?),true, DataColumnDefinition.ConstraintTypes.UNKNOWN);
   ...
   #region Partial Access                                    
        ...
        /// <remarks></remarks>                                    
        public V___PersonnelView(DataTable FullTable, long TargettedRowID) : base(FullTable, TargettedRowID)                                    
        {                                    
        }                                    
        ...
        /// <param name="TargettedRowID"></param>                                                      
        /// <remarks></remarks>                                    
        public V___PersonnelView(DataTable FullTable) : base(FullTable)                                    
        {                                    
        }                                    
 ...
 #region Methods                                                      
        ...
        public static V___PersonnelView GetFullTable(TransactionRunner runner) =>                   
            runner.Run( (conn) =>                  
                new V___PersonnelView(conn.Fetch(PersonnelView__ALL_COLUMNS___SQL_FILL_QUERY).FirstTable())                  
                );                                                      
                                                      
        public static V___PersonnelView GetRowWhereIDUsingSQL(long pID, TransactionRunner runner)                                                                        
        {                  
            return runner.Run( (conn) =>  new V___PersonnelView( conn.Fetch($"SELECT * FROM {TABLE_NAME} WHERE ID={pID}" ).FirstTable(), pID )                  
                );                  
        }                                                                        
                                                                        
        public V___PersonnelView GetRowWhereID(long pID) => new(this.RawTable, pID);                                                      
