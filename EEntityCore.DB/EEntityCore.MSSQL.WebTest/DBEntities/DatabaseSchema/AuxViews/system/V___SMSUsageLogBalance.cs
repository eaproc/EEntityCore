...
#region Methods                  
        ...
        {                  
            if (this.HasRows())                  
                return new V___SMSUsageLogBalance(this.AllRows.First());                  
            return null;                  
        }                  
        ...
        {                  
            return new V___SMSUsageLogBalance(DBConnectInterface.GetDBConn(), string.Format("SELECT * FROM {0} WHERE ID={1}", (object)pID)).GetFirstRow();                  
        }                  
                  
        public V___SMSUsageLogBalance GetRowWhereID(int pID)                  
        {                  
            return new V___SMSUsageLogBalance(this.RawTable, pID);                  
        }                  
        ...
        {                  
            ...
            {                  
                ...
                if (drst is object && drst.Count() > 0)                  
                    return new V___SMSUsageLogBalance(drst);                  
                return null;                  
            }                  
            catch (Exception)                  
            {                  
